...
class Configuration:
    ...
    def get_company_configuration(self, request: operations.GetCompanyConfigurationRequest) -> operations.GetCompanyConfigurationResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetCompanyConfiguration200TextJSON])
                res.get_company_configuration_200_text_json_object = out
            if utils.match_content_type(content_type, "text/plain"):
                res.get_company_configuration_200_text_plain_object = r.content
    ...
    def save_company_configuration(self, request: operations.SaveCompanyConfigurationRequest) -> operations.SaveCompanyConfigurationResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.SaveCompanyConfiguration200TextJSON])
                res.save_company_configuration_200_text_json_object = out
            if utils.match_content_type(content_type, "text/plain"):
                res.save_company_configuration_200_text_plain_object = r.content
