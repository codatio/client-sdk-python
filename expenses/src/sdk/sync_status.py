...
class SyncStatus:
    ...
    def get_last_successful_sync(self, request: operations.GetLastSuccessfulSyncRequest) -> operations.GetLastSuccessfulSyncResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetLastSuccessfulSync200TextJSON])
                res.get_last_successful_sync_200_text_json_object = out
            if utils.match_content_type(content_type, "text/plain"):
                res.get_last_successful_sync_200_text_plain_object = r.content
    ...
    def get_latest_sync(self, request: operations.GetLatestSyncRequest) -> operations.GetLatestSyncResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetLatestSync200TextJSON])
                res.get_latest_sync_200_text_json_object = out
            if utils.match_content_type(content_type, "text/plain"):
                res.get_latest_sync_200_text_plain_object = r.content
    ...
    def get_sync_by_id(self, request: operations.GetSyncByIDRequest) -> operations.GetSyncByIDResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetSyncByID200TextJSON])
                res.get_sync_by_id_200_text_json_object = out
            if utils.match_content_type(content_type, "text/plain"):
                res.get_sync_by_id_200_text_plain_object = r.content
    ...
    def list_syncs(self, request: operations.ListSyncsRequest) -> operations.ListSyncsResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[list[operations.ListSyncs200TextJSON]])
                res.list_syncs_200_text_json_objects = out
            if utils.match_content_type(content_type, "text/plain"):
                res.list_syncs_200_text_plain_array = r.content
