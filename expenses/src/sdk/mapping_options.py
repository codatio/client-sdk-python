    ...
    def get_mapping_options(self, request: operations.GetMappingOptionsRequest) -> operations.GetMappingOptionsResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetMappingOptions200TextJSON])
                res.get_mapping_options_200_text_json_object = out
            if utils.match_content_type(content_type, "text/plain"):
                res.get_mapping_options_200_text_plain_object = r.content
