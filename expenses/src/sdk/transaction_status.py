...
class TransactionStatus:
    ...
    def get_sync_transaction(self, request: operations.GetSyncTransactionRequest) -> operations.GetSyncTransactionResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[list[operations.GetSyncTransaction200TextJSON]])
                res.get_sync_transaction_200_text_json_objects = out
            if utils.match_content_type(content_type, "text/plain"):
                res.get_sync_transaction_200_text_plain_array = r.content
    ...
    def get_sync_transactions(self, request: operations.GetSyncTransactionsRequest) -> operations.GetSyncTransactionsResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "text/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetSyncTransactions200TextJSON])
                res.get_sync_transactions_200_text_json_object = out
            if utils.match_content_type(content_type, "text/plain"):
                res.get_sync_transactions_200_text_plain_object = r.content
