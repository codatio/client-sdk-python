...
class GetSyncTransactions200TextJSONResults:
    integration_type: Optional[GetSyncTransactions200TextJSONResultsIntegrationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('integrationType'), 'exclude': lambda f: f is None }})
    ...
    status: Optional[GetSyncTransactions200TextJSONResultsStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status'), 'exclude': lambda f: f is None }})
...
class GetSyncTransactions200TextJSON:
    ...
    links: Optional[dict[str, GetSyncTransactions200TextJSONHalLink]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('links'), 'exclude': lambda f: f is None }})
    results: Optional[list[GetSyncTransactions200TextJSONResults]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results'), 'exclude': lambda f: f is None }})
