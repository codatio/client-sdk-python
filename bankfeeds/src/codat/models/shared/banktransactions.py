...
class BankTransactionsSourceModifiedDateTransactionTypeEnum(str, Enum):
...
class BankTransactionsSourceModifiedDate:
    ...
    transaction_type: BankTransactionsSourceModifiedDateTransactionTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transactionType') }})
    r"""Type of transaction for the bank statement line"""  
...
class BankTransactions:
    ...
    * Transaction type, for example, credit, debit, or transfer.
    ...
    transactions: Optional[list[BankTransactionsSourceModifiedDate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transactions'), 'exclude': lambda f: f is None }})  
