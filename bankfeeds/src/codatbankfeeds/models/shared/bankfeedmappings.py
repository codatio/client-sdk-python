...
class BankFeedMappingsBankFeedMapping:
...
@dataclasses.dataclass
class BankFeedMappings:
    r"""Success"""
    results: Optional[list[BankFeedMappingsBankFeedMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
