...
class Transactions:
    ...
    def list_create_operations(self, request: operations.ListCreateOperationsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListCreateOperationsResponse:
        ...
        def next_func() -> Optional[operations.ListCreateOperationsResponse]:
            ...
            return self.list_create_operations(
        ...
        res = operations.ListCreateOperationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
