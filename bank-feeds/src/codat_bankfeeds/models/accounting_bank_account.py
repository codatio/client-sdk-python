...
class AccountingBankAccount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountName", "accountType", "nominalCode", "sortCode", "accountNumber", "iBan", "currency", "balance", "institution", "availableBalance", "overdraftLimit", "status", "id", "metadata", "supplementalData", "modifiedDate", "sourceModifiedDate"]
...
class AccountingBankAccountTypedDict(TypedDict):
    ...
    account_type: NotRequired[Optional[BankAccountCreateResponseBankAccountType]]
