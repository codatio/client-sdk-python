...
if TYPE_CHECKING:
    ...
    from .generateotpresponse import GenerateOtpResponse, GenerateOtpResponseTypedDict
...
_dynamic_imports: dict[str, str] = {
    ...
    "GenerateOtpResponseTypedDict": ".generateotpresponse",
    "HalRef": ".halref",
