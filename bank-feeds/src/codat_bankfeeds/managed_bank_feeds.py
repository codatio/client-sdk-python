...
class ManagedBankFeeds(BaseSDK):
    ...
    def get_latest_sync(
        ...
        *,
        request: Union[
            operations.GetLatestManagedBankFeedSyncRequest,
            operations.GetLatestManagedBankFeedSyncRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[shared.SyncStatusResult]:
        r"""Get latest sync
        ...
        request = cast(operations.GetLatestManagedBankFeedSyncRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.SyncStatusResult, http_res)
    ...
    def get_sync(
        ...
        *,
        request: Union[
            operations.GetManagedBankFeedSyncRequest,
            operations.GetManagedBankFeedSyncRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> shared.SyncStatusResult:
        r"""Get sync
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetManagedBankFeedSyncRequest)
        request = cast(operations.GetManagedBankFeedSyncRequest, request)
    ...
    def run_ad_hoc_sync(
        ...
        *,
        request: Union[
            operations.RunManagedBankFeedAdHocSyncRequest,
            operations.RunManagedBankFeedAdHocSyncRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> shared.StartScheduledSyncResult:
        r"""Run ad-hoc sync
        ...
        request = cast(operations.RunManagedBankFeedAdHocSyncRequest, request)
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(shared.StartScheduledSyncResult, http_res)
        if utils.match_response(
            http_res,
