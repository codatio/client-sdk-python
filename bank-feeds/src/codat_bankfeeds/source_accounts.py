...
class SourceAccounts(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                operations.CreateSourceAccountResponseBody, http_res
            )
    ...
    def create_batch(
        ...
        *,
        ...
        if utils.match_response(http_res, "207", "application/json"):
            return unmarshal_json_response(
                List[operations.CreateBatchSourceAccountResponseBody], http_res
            )
        if utils.match_response(
            http_res, ["400", "401", "402", "403", "404", "429"], "application/json"
        ):
    ...
    def generate_credentials(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.BankAccountCredentials, http_res)
        if utils.match_response(
            http_res, ["401", "402", "403", "404", "429"], "application/json"
        ):
            response_data = unmarshal_json_response(errors.ErrorMessageData, http_res)
    ...
    def generate_otp(
        ...
        *,
        request: Union[
            operations.GenerateOtpRequest, operations.GenerateOtpRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> shared.GenerateOtpResponse:
        r"""Generate one-time password
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GenerateOtpRequest)
        request = cast(operations.GenerateOtpRequest, request)

        req = self._build_request(
            method="POST",
            path="/companies/{companyId}/connections/{connectionId}/bankFeeds/otp",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.GenerateOtpResponse, http_res)
        if utils.match_response(
            http_res, ["400", "401", "402", "403", "404", "429"], "application/json"
        ):
            response_data = unmarshal_json_response(errors.ErrorMessageData, http_res)
    ...
    def list(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                operations.ListSourceAccountsResponseBody, http_res
            )
        if utils.match_response(
            http_res, ["401", "402", "403", "404", "429"], "application/json"
        ):
    ...
    def update(
        ...
        * Updates made here apply exclusively to source accounts and will not affect target accounts in the accounting software.
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.source_account if request is not None else None,
                False,
                True,
                "json",
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.SourceAccount, http_res)
        if utils.match_response(
            http_res, ["400", "401", "402", "403", "404", "429"], "application/json"
        ):
            response_data = unmarshal_json_response(errors.ErrorMessageData, http_res)
