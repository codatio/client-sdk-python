...
from ..shared import accountbalances as shared_accountbalances
...
@dataclasses.dataclass
class ListAccountBalances409ApplicationJSON:
...
class ListAccountBalancesResponse:
    ...
    r"""Success"""
    list_account_balances_409_application_json_object: Optional[ListAccountBalances409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
