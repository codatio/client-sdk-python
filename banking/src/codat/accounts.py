...
class Accounts:
    ...
    def list_banking_accounts(self, request: operations.ListBankingAccountsRequest) -> operations.ListBankingAccountsResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.ListBankingAccounts200ApplicationJSON])
                res.list_banking_accounts_200_application_json_object = out
