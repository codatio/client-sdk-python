...
class Sync:
    ...
    def request_sync(self, request: operations.RequestSyncRequest) -> operations.RequestSyncResponse:
    ...
    def request_sync_for_date_range(self, request: operations.RequestSyncForDateRangeRequest) -> operations.RequestSyncForDateRangeResponse:
