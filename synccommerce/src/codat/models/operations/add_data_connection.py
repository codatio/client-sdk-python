...
class AddDataConnection200ApplicationJSONSourceTypeEnum(str, Enum):
...
class AddDataConnection200ApplicationJSONStatusEnum(str, Enum):
...
class AddDataConnection200ApplicationJSON:
    ...
    r"""In Codat's data model, dates and times are represented using the ISO 8601 standard. Date and time fields are formatted as string."""  
    source_type: Optional[AddDataConnection200ApplicationJSONSourceTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType'), 'exclude': lambda f: f is None }})
    r"""The type of platform of the connection."""  
    status: Optional[AddDataConnection200ApplicationJSONStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The current authorization status of the data connection."""  
