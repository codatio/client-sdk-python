...
<!-- UsageSnippet language="python" operationID="get-company-configuration" method="get" path="/companies/{companyId}/sync/expenses/config" -->
```python
...
<!-- UsageSnippet language="python" operationID="set-company-configuration" method="post" path="/companies/{companyId}/sync/expenses/config" example="Malformed query" -->
```python
from codat_sync_for_expenses import CodatSyncExpenses
from codat_sync_for_expenses.models import shared
