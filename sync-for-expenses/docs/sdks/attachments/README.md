...
<!-- UsageSnippet language="python" operationID="upload-expense-attachment" method="post" path="/companies/{companyId}/sync/expenses/syncs/{syncId}/transactions/{transactionId}/attachments" -->
```python
