    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListPushOperationsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListPushOperationsRequest)
        request = cast(operations.ListPushOperationsRequest, request)
