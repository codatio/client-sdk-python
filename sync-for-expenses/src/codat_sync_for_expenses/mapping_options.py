    ...
    def get_mapping_options(
        ...
        *,
        request: Union[
            ...
            operations.GetMappingOptionsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.MappingOptions]:
        r"""Mapping options
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetMappingOptionsRequest)
        request = cast(operations.GetMappingOptionsRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.MappingOptions])
