...
class CompanyInfo(BaseSDK):
    ...
    def get(
        ...
        *,
        request: Union[
            operations.GetCompanyInfoRequest, operations.GetCompanyInfoRequestTypedDict
        ],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCompanyInfoRequest)
        request = cast(operations.GetCompanyInfoRequest, request)
