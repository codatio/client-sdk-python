...
class TransactionStatus(BaseSDK):
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[shared.SchemaTransaction], http_res)
    ...
    def list(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.Transactions, http_res)
        if utils.match_response(
