...
class ManageData(BaseSDK):
    ...
    def list_pull_operations(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.PullOperations, http_res)
        if utils.match_response(
    ...
    def refresh_all_data_types(
        ...
        *,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.RefreshAllDataTypesRequest)
        request = cast(operations.RefreshAllDataTypesRequest, request)
