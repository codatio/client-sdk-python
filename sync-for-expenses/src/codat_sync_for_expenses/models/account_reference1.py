...
class AccountReference1(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="'id' from the Accounts data type.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountReference1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountReference1 from a dict"""
        if obj is None:
            return None
...
class AccountReference1TypedDict(TypedDict):
    """TypedDict variant of AccountReference1, for dict-literal request/response inputs."""
    id: NotRequired[str]
