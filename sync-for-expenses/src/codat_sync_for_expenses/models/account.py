...
class Account(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nominalCode", "name", "description", "fullyQualifiedCategory", "fullyQualifiedName", "currency", "currentBalance", "type", "status", "isBankAccount", "validDatatypeLinks", "supplementalData", "id", "metadata", "modifiedDate", "sourceModifiedDate"]
...
class AccountTypedDict(TypedDict):
    """TypedDict variant of Account, for dict-literal request/response inputs."""
