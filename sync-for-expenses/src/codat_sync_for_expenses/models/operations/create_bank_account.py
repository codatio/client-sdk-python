...
from codat_sync_for_expenses.models.shared import bankaccount as shared_bankaccount
...
class CreateBankAccountRequestTypedDict(TypedDict):
    ...
    bank_account: NotRequired[Nullable[shared_bankaccount.BankAccountTypedDict]]
...
class CreateBankAccountRequest(BaseModel):
    ...
    bank_account: Annotated[
        OptionalNullable[shared_bankaccount.BankAccount],
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["BankAccount", "allowSyncOnPushComplete", "timeoutInMinutes"]
        )
        nullable_fields = set(["BankAccount"])
