...
class UpdateReimbursableExpenseTransactionRequestTypedDict(TypedDict):
    ...
    update_reimbursable_expense_transaction_request: NotRequired[
        shared_updatereimbursableexpensetransactionrequest.UpdateReimbursableExpenseTransactionRequestTypedDict
    ]
...
class UpdateReimbursableExpenseTransactionRequest(BaseModel):
    ...
    update_reimbursable_expense_transaction_request: Annotated[
        Optional[
            shared_updatereimbursableexpensetransactionrequest.UpdateReimbursableExpenseTransactionRequest
        ],
