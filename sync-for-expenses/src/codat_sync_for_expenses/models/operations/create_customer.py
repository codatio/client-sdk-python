...
from codat_sync_for_expenses.models.shared import customer as shared_customer
...
class CreateCustomerRequestTypedDict(TypedDict):
    ...
    customer: NotRequired[Nullable[shared_customer.CustomerTypedDict]]
...
class CreateCustomerRequest(BaseModel):
    ...
    customer: Annotated[
        OptionalNullable[shared_customer.Customer],
    ...
    def serialize_model(self, handler):
        optional_fields = ["Customer", "allowSyncOnPushComplete", "timeoutInMinutes"]
        nullable_fields = ["Customer"]
        null_default_fields = []
