...
from codat_sync_for_expenses.models._compat.companyinformation import CompanyInformationSchemasType
class Weblink(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[CompanyInformationSchemasType] = Field(default=None, description="The type of the weblink.")
    url: Optional[str] = Field(default=None, description="The full URL for the weblink.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['Website', 'Social', 'Unknown']):
            raise ValueError("must be one of enum values ('Website', 'Social', 'Unknown')")
        return value
...
class WeblinkTypedDict(TypedDict):
    """TypedDict variant of Weblink, for dict-literal request/response inputs."""
    type: NotRequired[Optional[CompanyInformationSchemasType]]
