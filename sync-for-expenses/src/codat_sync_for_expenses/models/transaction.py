...
class Transaction(BaseModel):
    ...
    Transaction
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier of the transaction.")
    status: Optional[TransactionDefinitionsStatus] = Field(default=None, description="Status of transaction.")
    error_message: OptionalNullable[str] = Field(default=UNSET, description="Error message for failed transaction.", alias="errorMessage")
    __properties: ClassVar[List[str]] = ["id", "status", "errorMessage"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Unknown', 'PushError', 'Completed', 'Failed', 'Pending']):
            raise ValueError("must be one of enum values ('Unknown', 'PushError', 'Completed', 'Failed', 'Pending')")
        return value
...
class TransactionTypedDict(TypedDict):
    """TypedDict variant of Transaction, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    status: NotRequired[Optional[TransactionDefinitionsStatus]]
