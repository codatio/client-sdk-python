...
class TransferTransactionRequest(BaseModel):
    ...
    date_: str = Field(description="Date of the transfer transaction as recorded in the accounting software.", alias="date")
    from_: TransferTransactionRequestFrom = Field(alias="from")
    to: TransferTransactionRequestTo
    __properties: ClassVar[List[str]] = ["description", "date", "from", "to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferTransactionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferTransactionRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "from": TransferTransactionRequestFrom.from_dict(obj["from"]) if obj.get("from") is not None else None,
            "to": TransferTransactionRequestTo.from_dict(obj["to"]) if obj.get("to") is not None else None
        })
        return _obj
...
class TransferTransactionRequestTypedDict(TypedDict):
    """TypedDict variant of TransferTransactionRequest, for dict-literal request/response inputs."""
    description: NotRequired[Optional[str]]
    date_: NotRequired[str]
    from_: NotRequired[TransferTransactionRequestFromTypedDict]
    to: TransferTransactionRequestToTypedDict
