...
class CompanyUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[str] = Field(default=None, description="Name of company being connected.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompanyUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompanyUpdateRequest from a dict"""
        if obj is None:
            return None
...
class CompanyUpdateRequestTypedDict(TypedDict):
    """TypedDict variant of CompanyUpdateRequest, for dict-literal request/response inputs."""
