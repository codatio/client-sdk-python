...
class ExpenseTransaction(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'currencyRate', 'currency_rate', 'postAsDraft', 'post_as_draft', 'reference'}
        return {
    ...
    type: ExpenseTransactionType = Field(description="The type of transaction.")
    ...
    reference: OptionalNullable[str] = Field(default=UNSET, description="User-friendly reference for the expense transaction.")
    ...
    post_as_draft: OptionalNullable[bool] = Field(default=UNSET, description="This optional property, when set to true, posts the transaction to a drafted state. Note that postAsDraft is only supported in Microsoft Dynamics 365 Business Central.", alias="postAsDraft")
    __properties: ClassVar[List[str]] = ["id", "type", "issueDate", "currency", "currencyRate", "contactRef", "bankAccountRef", "reference", "merchantName", "lines", "notes", "postAsDraft"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpenseTransaction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpenseTransaction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "postAsDraft": obj.get("postAsDraft")
        })
        return _obj
...
class ExpenseTransactionTypedDict(TypedDict):
    """TypedDict variant of ExpenseTransaction, for dict-literal request/response inputs."""
    id: NotRequired[str]
    type: NotRequired[ExpenseTransactionType]
    ...
    post_as_draft: NotRequired[Optional[bool]]
