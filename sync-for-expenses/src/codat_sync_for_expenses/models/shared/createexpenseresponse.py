...
class CreateExpenseResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateExpenseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateExpenseResponse from a dict"""
        if obj is None:
            return None
...
class CreateExpenseResponseTypedDict(TypedDict):
    """TypedDict variant of CreateExpenseResponse, for dict-literal request/response inputs."""
