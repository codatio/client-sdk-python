...
class RecordRef(BaseModel):
    ...
    RecordRef
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Identifier of linked reference from mapping options.")
...
class RecordRefTypedDict(TypedDict):
    """TypedDict variant of RecordRef, for dict-literal request/response inputs."""
