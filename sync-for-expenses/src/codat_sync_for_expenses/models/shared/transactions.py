...
class Transactions(BaseModel):
    ...
    results: Optional[List[SchemaTransaction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [SchemaTransaction.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
...
class TransactionsTypedDict(TypedDict):
    """TypedDict variant of Transactions, for dict-literal request/response inputs."""
    page_number: NotRequired[int]
    page_size: NotRequired[int]
    total_results: NotRequired[int]
    links: NotRequired[LinksTypedDict]
    results: NotRequired[Optional[List[SchemaTransactionTypedDict]]]
