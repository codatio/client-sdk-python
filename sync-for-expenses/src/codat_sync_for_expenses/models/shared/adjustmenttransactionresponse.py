...
class AdjustmentTransactionResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdjustmentTransactionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdjustmentTransactionResponse from a dict"""
        if obj is None:
            return None
...
class AdjustmentTransactionResponseTypedDict(TypedDict):
    """TypedDict variant of AdjustmentTransactionResponse, for dict-literal request/response inputs."""
