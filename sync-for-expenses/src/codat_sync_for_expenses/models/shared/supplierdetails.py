...
class SupplierDetails(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SupplierDetails from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SupplierDetails from a dict"""
        if obj is None:
            return None
...
class SupplierDetailsTypedDict(TypedDict):
    """TypedDict variant of SupplierDetails, for dict-literal request/response inputs."""
