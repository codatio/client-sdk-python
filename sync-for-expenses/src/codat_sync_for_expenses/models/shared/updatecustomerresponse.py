...
class UpdateCustomerResponseAccountingCustomerTypedDict(TypedDict):
    r"""## Overview
...
class UpdateCustomerResponseAccountingCustomer(BaseModel):
    r"""## Overview
...
class UpdateCustomerResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[UpdateCustomerResponseAccountingCustomerTypedDict]]
...
class UpdateCustomerResponse(BaseModel):
    ...
    data: OptionalNullable[UpdateCustomerResponseAccountingCustomer] = UNSET
...
try:
    UpdateCustomerResponseAccountingCustomer.model_rebuild()
except NameError:
    pass
try:
    UpdateCustomerResponse.model_rebuild()
except NameError:
    pass
