...
class ReimbursableExpenseTransaction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "reference", "contactRef", "apAccountRef", "issueDate", "dueDate", "currency", "currencyRate", "notes", "lines"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReimbursableExpenseTransaction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReimbursableExpenseTransaction from a dict"""
        if obj is None:
            return None
...
class ReimbursableExpenseTransactionTypedDict(TypedDict):
    """TypedDict variant of ReimbursableExpenseTransaction, for dict-literal request/response inputs."""
    id: NotRequired[str]
