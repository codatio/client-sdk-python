...
class AdjustmentTransactionRequestTypedDict(TypedDict):
    ...
    lines: List[AdjustmentTransactionLineTypedDict]
    ...
    r"""User-friendly reference for the adjustment transaction."""
...
class AdjustmentTransactionRequest(BaseModel):
    ...
    lines: List[AdjustmentTransactionLine]
    r"""Array of transaction lines."""
    ...
    def serialize_model(self, handler):
        optional_fields = set(["currencyRate", "reference"])
        nullable_fields = set(["currencyRate", "reference"])
...
try:
    AdjustmentTransactionRequest.model_rebuild()
except NameError:
    pass
