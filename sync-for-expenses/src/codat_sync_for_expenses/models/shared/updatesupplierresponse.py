...
class UpdateSupplierResponseAccountingSupplierTypedDict(TypedDict):
    r"""## Overview
...
class UpdateSupplierResponseAccountingSupplier(BaseModel):
    r"""## Overview
...
class UpdateSupplierResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[UpdateSupplierResponseAccountingSupplierTypedDict]]
...
class UpdateSupplierResponse(BaseModel):
    ...
    data: OptionalNullable[UpdateSupplierResponseAccountingSupplier] = UNSET
...
try:
    UpdateSupplierResponseAccountingSupplier.model_rebuild()
except NameError:
    pass
try:
    UpdateSupplierResponse.model_rebuild()
except NameError:
    pass
