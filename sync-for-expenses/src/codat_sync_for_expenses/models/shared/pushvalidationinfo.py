...
class PushValidationInfo(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'information', 'warnings'}
        return {
    ...
    __properties: ClassVar[List[str]] = ["warnings", "information"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PushValidationInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PushValidationInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "warnings": [PushFieldValidation.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None,
            "information": [PushFieldValidation.from_dict(_item) for _item in obj["information"]] if obj.get("information") is not None else None
        })
...
class PushValidationInfoTypedDict(TypedDict):
    """TypedDict variant of PushValidationInfo, for dict-literal request/response inputs."""
    warnings: NotRequired[Optional[List[PushFieldValidationTypedDict]]]
    information: NotRequired[Optional[List[PushFieldValidationTypedDict]]]
