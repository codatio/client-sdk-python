...
class Attachment(BaseModel):
    ...
    Attachment
    """ # noqa: E501
    company_id: Optional[str] = Field(default=None, description="Unique ID of company in Codat", alias="companyId")
    id: Optional[str] = Field(default=None, description="Unique identifier of attachment")
    transaction_id: Optional[str] = Field(default=None, description="Unique identifier of transaction", alias="transactionId")
    __properties: ClassVar[List[str]] = ["companyId", "id", "transactionId"]
