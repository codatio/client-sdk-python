...
class BankAccountDetails(BaseModel):
    ...
    BankAccountDetails
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="The id of the account from which purchases are made")
...
class BankAccountDetailsTypedDict(TypedDict):
    """TypedDict variant of BankAccountDetails, for dict-literal request/response inputs."""
