...
class TransferTransactionResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferTransactionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferTransactionResponse from a dict"""
        if obj is None:
            return None
...
class TransferTransactionResponseTypedDict(TypedDict):
    """TypedDict variant of TransferTransactionResponse, for dict-literal request/response inputs."""
