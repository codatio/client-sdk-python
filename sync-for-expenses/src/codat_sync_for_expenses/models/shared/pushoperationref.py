...
class PushOperationRef(BaseModel):
    ...
    PushOperationRef
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier for a push operation.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PushOperationRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PushOperationRef from a dict"""
        if obj is None:
            return None
...
class PushOperationRefTypedDict(TypedDict):
    """TypedDict variant of PushOperationRef, for dict-literal request/response inputs."""
