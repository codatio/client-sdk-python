...
class ReimbursementContactRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="Identifier of contact.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReimbursementContactRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReimbursementContactRef from a dict"""
        if obj is None:
            return None
...
class ReimbursementContactRefTypedDict(TypedDict):
    """TypedDict variant of ReimbursementContactRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
