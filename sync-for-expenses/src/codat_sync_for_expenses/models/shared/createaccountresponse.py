...
class CreateAccountResponseMetadataTypedDict(TypedDict):
...
class CreateAccountResponseMetadata(BaseModel):
...
class CreateAccountResponseValidDataTypeLinksTypedDict(TypedDict):
...
class CreateAccountResponseValidDataTypeLinks(BaseModel):
    r"""When querying Codat's data model, some data types return `validDatatypeLinks` metadata in the JSON response. This indicates where that object can be used as a reference—a _valid link_—when creating or updating other data.
...
class AccountingAccountTypedDict(TypedDict):
    ...
    * Equity.
    ...
    metadata: NotRequired[CreateAccountResponseMetadataTypedDict]
    ...
    valid_datatype_links: NotRequired[
        Nullable[List[CreateAccountResponseValidDataTypeLinksTypedDict]]
    ]
...
class AccountingAccount(BaseModel):
    ...
    * Equity.
    ...
    metadata: Optional[CreateAccountResponseMetadata] = None
    ...
    valid_datatype_links: Annotated[
        OptionalNullable[List[CreateAccountResponseValidDataTypeLinks]],
