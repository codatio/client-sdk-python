...
class ItemRef(BaseModel):
    ...
    ItemRef
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier for the item associated with the transaction. The `itemRef` object is currently supported only for QuickBooks Desktop. You can specify either `itemRef` or `accountRef`, but not both.")
