...
class SupplementalData(BaseModel):
    ...
    """
    Supplemental data is additional data you can include in our standard data types.   It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SupplementalData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SupplementalData from a dict"""
        if obj is None:
            return None
...
class SupplementalDataTypedDict(TypedDict):
    """TypedDict variant of SupplementalData, for dict-literal request/response inputs."""
    content: NotRequired[Optional[Dict[str, Dict[str, Any]]]]
