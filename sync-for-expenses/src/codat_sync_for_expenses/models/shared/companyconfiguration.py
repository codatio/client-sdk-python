...
class CompanyConfiguration(BaseModel):
    ...
    """ # noqa: E501
    bank_account: BankAccountDetails = Field(alias="bankAccount")
    supplier: SupplierDetails
    customer: CustomerDetails
    __properties: ClassVar[List[str]] = ["bankAccount", "supplier", "customer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "supplier": SupplierDetails.from_dict(obj["supplier"]) if obj.get("supplier") is not None else None,
...
class CompanyConfigurationTypedDict(TypedDict):
    """TypedDict variant of CompanyConfiguration, for dict-literal request/response inputs."""
    bank_account: NotRequired[BankAccountDetailsTypedDict]
