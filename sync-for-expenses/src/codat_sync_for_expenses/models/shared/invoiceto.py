...
class InvoiceTo(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="identifier of customer.")
    type: Optional[InvoiceToType] = Field(default=None, description="The type of contact.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvoiceTo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvoiceTo from a dict"""
        if obj is None:
            return None
...
class InvoiceToTypedDict(TypedDict):
    """TypedDict variant of InvoiceTo, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    type: NotRequired[Optional[InvoiceToType]]
