...
class UpdateExpenseRequestBankAccountReferenceTypedDict(TypedDict):
    id: NotRequired[str]
    r"""Identifier of the bank account."""


class UpdateExpenseRequestBankAccountReference(BaseModel):
...
class UpdateExpenseRequestTypedDict(TypedDict):
    ...
    r"""The type of transaction."""
    bank_account_ref: NotRequired[UpdateExpenseRequestBankAccountReferenceTypedDict]
...
class UpdateExpenseRequest(BaseModel):
    ...
    bank_account_ref: Annotated[
        Optional[UpdateExpenseRequestBankAccountReference],
        pydantic.Field(alias="bankAccountRef"),
    ] = None
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["currencyRate"])
        serialized = handler(self)
        m = {}
...
try:
    UpdateExpenseRequest.model_rebuild()
except NameError:
    pass
