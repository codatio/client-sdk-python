...
class UpdateExpenseResponse(BaseModel):
    ...
    """ # noqa: E501
    sync_id: Optional[str] = Field(default=None, description="Unique identifier for the update expense sync.", alias="syncId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateExpenseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateExpenseResponse from a dict"""
        if obj is None:
            return None
...
class UpdateExpenseResponseTypedDict(TypedDict):
    """TypedDict variant of UpdateExpenseResponse, for dict-literal request/response inputs."""
