...
class BankAccountReference(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Identifier of the bank account.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankAccountReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankAccountReference from a dict"""
        if obj is None:
            return None
...
class BankAccountReferenceTypedDict(TypedDict):
    """TypedDict variant of BankAccountReference, for dict-literal request/response inputs."""
