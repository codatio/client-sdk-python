...
class AccountingAddress(BaseModel):
    ...
    country: OptionalNullable[str] = Field(default=UNSET, description="Country of the customer address.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingAddress from a dict"""
        if obj is None:
            return None
