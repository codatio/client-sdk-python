...
class ValidDataTypeLinks(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidDataTypeLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidDataTypeLinks from a dict"""
        if obj is None:
            return None
...
class ValidDataTypeLinksTypedDict(TypedDict):
    ...
    property: NotRequired[Optional[str]]
