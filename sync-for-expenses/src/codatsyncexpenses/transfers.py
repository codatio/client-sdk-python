...
class Transfers:
    ...
    def create_transfer(self, request: operations.CreateTransferTransactionRequest, retries: Optional[utils.RetryConfig] = None) -> operations.CreateTransferTransactionResponse:
