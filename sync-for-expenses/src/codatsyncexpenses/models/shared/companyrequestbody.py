...
import dataclasses
from .group_items import GroupItems
...
class CompanyRequestBody:
    ...
    groups: Optional[List[GroupItems]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('groups'), 'exclude': lambda f: f is None }})
