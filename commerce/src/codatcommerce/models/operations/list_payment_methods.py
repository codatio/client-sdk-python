...
@dataclasses.dataclass
class ListPaymentMethods409ApplicationJSON:
...
class ListPaymentMethodsResponse:
    ...
    list_payment_methods_409_application_json_object: Optional[ListPaymentMethods409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
    payment_methods: Optional[shared_paymentmethods.PaymentMethods] = dataclasses.field(default=None)
    r"""OK"""
