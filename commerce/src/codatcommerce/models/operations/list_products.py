...
@dataclasses.dataclass
class ListProducts409ApplicationJSON:
...
class ListProductsResponse:
    ...
    list_products_409_application_json_object: Optional[ListProducts409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
    products: Optional[shared_products.Products] = dataclasses.field(default=None)
    r"""OK"""
