...
from ..shared import disputes as shared_disputes
...
@dataclasses.dataclass
class ListDisputes409ApplicationJSON:
...
class ListDisputesResponse:
    ...
    disputes: Optional[shared_disputes.Disputes] = dataclasses.field(default=None)
    r"""OK"""
    list_disputes_409_application_json_object: Optional[ListDisputes409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
