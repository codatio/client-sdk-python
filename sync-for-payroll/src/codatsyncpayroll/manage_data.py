...
class ManageData:
    ...
    def list(self, request: operations.ListPushOperationsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListPushOperationsResponse:
        ...
        def next_func() -> Optional[operations.ListPushOperationsResponse]:
        ...
        res = operations.ListPushOperationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
    ...
    def list_pull_operations(self, request: operations.ListPullOperationsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListPullOperationsResponse:
        ...
        def next_func() -> Optional[operations.ListPullOperationsResponse]:
            body = utils.unmarshal_json(http_res.text, Dict[Any, Any])
            next_cursor = JSONPath("").parse(body)
            ...
            return self.list_pull_operations(
        ...
        res = operations.ListPullOperationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
