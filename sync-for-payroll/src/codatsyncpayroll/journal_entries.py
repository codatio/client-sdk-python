...
class JournalEntries:
    ...
    def list(self, request: operations.ListJournalEntriesRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListJournalEntriesResponse:
        ...
        def next_func() -> Optional[operations.ListJournalEntriesResponse]:
        ...
        res = operations.ListJournalEntriesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
