...
class BankFeeds:
    ...
    def get_bank_feed(self, request: operations.GetBankFeedRequest) -> operations.GetBankFeedResponse:
        r"""Update BankFeed BankAccount
        ...
        res = operations.GetBankFeedResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BankFeedBankAccount])
    ...
    def get_bank_feeds(self, request: operations.GetBankFeedsRequest) -> operations.GetBankFeedsResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.BankFeedBankAccount]])
    ...
    def put_bank_feeds(self, request: operations.PutBankFeedsRequest) -> operations.PutBankFeedsResponse:
        r"""Update BankFeed BankAccounts
