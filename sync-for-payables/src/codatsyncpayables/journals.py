...
class Journals:
    ...
    def list(self, request: operations.ListJournalsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListJournalsResponse:
        ...
        def next_func() -> Optional[operations.ListJournalsResponse]:
        ...
        res = operations.ListJournalsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
