...
class Suppliers:
    ...
    def list(self, request: operations.ListSuppliersRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListSuppliersResponse:
        ...
        def next_func() -> Optional[operations.ListSuppliersResponse]:
        ...
        res = operations.ListSuppliersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
