...
class TrackingCategories:
    ...
    def list(self, request: operations.ListTrackingCategoriesRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListTrackingCategoriesResponse:
        ...
        def next_func() -> Optional[operations.ListTrackingCategoriesResponse]:
        ...
        res = operations.ListTrackingCategoriesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
