...
class Bills:
    ...
    def list(self, request: operations.ListBillsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListBillsResponse:
        ...
        def next_func() -> Optional[operations.ListBillsResponse]:
        ...
        res = operations.ListBillsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
