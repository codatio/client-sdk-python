...
class BankAccount(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'accountNumber', 'account_number', 'name', 'nominalCode', 'nominal_code', 'sortCode', 'sort_code'}
        return {
    ...
    id: Optional[str] = Field(default=None, description="Identifier for the bank account, unique for the company in the accounting software.")
    ...
    __properties: ClassVar[List[str]] = ["sourceModifiedDate", "id", "nominalCode", "name", "accountType", "accountNumber", "sortCode", "currency", "status"]
