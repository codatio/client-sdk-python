...
class Attachment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "contentType", "dateCreated", "fileSize", "includeWhenSent", "sourceModifiedDate"]
...
class AttachmentTypedDict(TypedDict):
    """TypedDict variant of Attachment, for dict-literal request/response inputs."""
