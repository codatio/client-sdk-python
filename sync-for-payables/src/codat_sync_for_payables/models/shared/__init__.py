...
if TYPE_CHECKING:
    ...
    from codat_sync_for_payables.models.client_rate_limit_webhook import ClientRateLimitWebhook, ClientRateLimitWebhookTypedDict
    from codat_sync_for_payables.models.client_rate_limit_webhook_payload import ClientRateLimitWebhookPayload, ClientRateLimitWebhookPayloadTypedDict
    ...
    from codat_sync_for_payables.models.client_rate_limit_webhook_payload import ClientRateLimitWebhookPayloadTypedDict as ClientRateLimitWebhookPayloadTypedDict
    from codat_sync_for_payables.models.client_rate_limit_webhook import ClientRateLimitWebhookTypedDict as ClientRateLimitWebhookTypedDict
...
_dynamic_imports: dict[str, tuple[str, str]] = {
    ...
    'ClientRateLimitWebhook': ('codat_sync_for_payables.models.client_rate_limit_webhook', 'ClientRateLimitWebhook'),
    'ClientRateLimitWebhookPayload': ('codat_sync_for_payables.models.client_rate_limit_webhook_payload', 'ClientRateLimitWebhookPayload'),
    'ClientRateLimitWebhookPayloadTypedDict': ('codat_sync_for_payables.models.client_rate_limit_webhook_payload', 'ClientRateLimitWebhookPayloadTypedDict'),
    'ClientRateLimitWebhookTypedDict': ('codat_sync_for_payables.models.client_rate_limit_webhook', 'ClientRateLimitWebhookTypedDict'),
