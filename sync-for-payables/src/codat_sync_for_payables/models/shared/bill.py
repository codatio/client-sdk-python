...
class Bill(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'amountDue', 'amount_due', 'currencyRate', 'currency_rate', 'lineItems', 'line_items', 'reference'}
        return {
    ...
    status: BillStatus
    total_amount: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Amount of the bill, including tax.", alias="totalAmount")
    ...
    __properties: ClassVar[List[str]] = ["id", "reference", "supplierRef", "issueDate", "dueDate", "currency", "currencyRate", "lineItems", "status", "totalAmount", "amountDue", "sourceModifiedDate"]
...
class BillTypedDict(TypedDict):
    """TypedDict variant of Bill, for dict-literal request/response inputs."""
