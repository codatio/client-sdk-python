...
class BillPayment(BaseModel):
    ...
    amount: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Amount of the payment in the bill currency.")
    date_: Optional[str] = Field(default=None, description="Date the bill payment was recorded in the accounting software.", alias="date")
    reference: OptionalNullable[str] = Field(default=UNSET, description="Additional information associated with the payment.")
    account_ref: Optional[BillPaymentAccountRef] = Field(default=None, alias="accountRef")
    ...
    __properties: ClassVar[List[str]] = ["id", "amount", "date", "reference", "accountRef", "currencyRate"]
...
class BillPaymentTypedDict(TypedDict):
    """TypedDict variant of BillPayment, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    amount: NotRequired[Optional[Decimal]]
    date_: NotRequired[Optional[str]]
    reference: NotRequired[Optional[str]]
    account_ref: NotRequired[Optional[BillPaymentAccountRefTypedDict]]
