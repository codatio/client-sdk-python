    ...
    bill_credit_note=shared.BillCreditNote(
        ...
        line_items=[
            shared.BillCreditNoteLineItem(
                ...
                description='totam',
                discount_amount=1059.07,
                discount_percentage=4146.62,
    ...
    bill_credit_note=shared.BillCreditNote(
        ...
        line_items=[
            shared.BillCreditNoteLineItem(
                ...
                description='tempora',
                discount_amount=4254.51,
                discount_percentage=7980.47,
                item_ref=shared.BillCreditNoteLineItemItemReference(
        ...
        payment_allocations=[
            shared.Items(
                allocation=shared.ItemsAllocation(
                    allocated_on_date='2022-10-23T00:00:00.000Z',
                    currency='GBP',
                    currency_rate=1783.67,
                    total_amount=3738.13,
                ),
                payment=shared.PaymentAllocationPayment(
                    account_ref=shared.AccountRef(
