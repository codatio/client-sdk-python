...
class JournalEntries(BaseSDK):
    ...
    def create(
        ...
        *,
        request: Union[
            operations.CreateJournalEntryRequest,
            operations.CreateJournalEntryRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CreateJournalEntryResponse]:
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.CreateJournalEntryRequest)
        request = cast(operations.CreateJournalEntryRequest, request)

        req = self.build_request(
            method="POST",
            path="/companies/{companyId}/connections/{connectionId}/push/journalEntries",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                OptionalNullable[shared.JournalEntry],
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="create-journal-entry",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[shared.CreateJournalEntryResponse]
            )
    ...
    def get_create_model(
        ...
        *,
        request: Union[
            operations.GetCreateJournalEntryModelRequest,
        ...
        **Integration-specific behaviour**
        ...
        request = cast(operations.GetCreateJournalEntryModelRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/connections/{connectionId}/options/journalEntries",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-create-journalEntry-model",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
