...
class Suppliers(BaseSDK):
    ...
    def get_create_update_model(
        ...
        *,
        request: Union[
            operations.GetCreateUpdateSupplierModelRequest,
            operations.GetCreateUpdateSupplierModelRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        request = cast(operations.GetCreateUpdateSupplierModelRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-create-update-supplier-model",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
