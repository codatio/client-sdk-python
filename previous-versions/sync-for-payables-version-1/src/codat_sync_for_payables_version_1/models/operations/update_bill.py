...
from codat_sync_for_payables_version_1.models.shared import bill as shared_bill
...
class UpdateBillRequestTypedDict(TypedDict):
    ...
    bill: NotRequired[Nullable[shared_bill.BillTypedDict]]
...
class UpdateBillRequest(BaseModel):
    ...
    bill: Annotated[
        OptionalNullable[shared_bill.Bill],
    ...
    def serialize_model(self, handler):
        optional_fields = ["Bill", "forceUpdate", "timeoutInMinutes"]
