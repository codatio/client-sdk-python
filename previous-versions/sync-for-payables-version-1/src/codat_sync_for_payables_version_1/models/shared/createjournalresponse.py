...
class AccountingJournalTypedDict(TypedDict):
    r"""> **Language tip:** For line items, or individual transactions, of a company's financial documents, refer to the [Journal entries](https://docs.codat.io/sync-for-payables-api#/schemas/JournalEntry) data type
...
class CreateJournalResponseTypedDict(TypedDict):
    company_id: str
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingJournalTypedDict]]
...
class CreateJournalResponse(BaseModel):
    ...
    data: OptionalNullable[AccountingJournal] = UNSET
