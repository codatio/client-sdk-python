...
class UpdateBillCreditNoteResponseRecordReferenceTypedDict(TypedDict):
...
class UpdateBillCreditNoteResponseRecordReference(BaseModel):
    r"""Links the current record to the underlying record or data type that created it.
...
class UpdateBillCreditNoteResponseAccountingBillCreditNoteTypedDict(TypedDict):
    ...
    * The supplier that issued the bill credit note.
    ...
    created_from_refs: NotRequired[
        Nullable[List[UpdateBillCreditNoteResponseRecordReferenceTypedDict]]
    ]
    ...
    payment_allocations: NotRequired[Nullable[List[ItemsTypedDict]]]
...
class UpdateBillCreditNoteResponseAccountingBillCreditNote(BaseModel):
    r"""> **Bill credit notes or credit notes?**
    >
    > In Codat, bill credit notes represent accounts payable only. For accounts receivable, see [Credit notes](https://docs.codat.io/sync-for-payables-api#/schemas/CreditNote).
    ...
    * The supplier that issued the bill credit note.
    ...
    created_from_refs: Annotated[
        OptionalNullable[List[UpdateBillCreditNoteResponseRecordReference]],
    ...
    payment_allocations: Annotated[
        OptionalNullable[List[Items]], pydantic.Field(alias="paymentAllocations")
    ] = UNSET
    r"""An array of payment allocations."""
...
class UpdateBillCreditNoteResponseTypedDict(TypedDict):
    company_id: str
    ...
    """
    data: NotRequired[
        Nullable[UpdateBillCreditNoteResponseAccountingBillCreditNoteTypedDict]
    ]
...
class UpdateBillCreditNoteResponse(BaseModel):
    ...
    data: OptionalNullable[UpdateBillCreditNoteResponseAccountingBillCreditNote] = UNSET
