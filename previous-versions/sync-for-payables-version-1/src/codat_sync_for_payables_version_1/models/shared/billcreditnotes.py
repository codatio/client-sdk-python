...
class BillCreditNotesTypedDict(TypedDict):
    ...
    results: NotRequired[List[BillCreditNoteTypedDict]]


class BillCreditNotes(BaseModel):
    ...
    results: Optional[List[BillCreditNote]] = None
