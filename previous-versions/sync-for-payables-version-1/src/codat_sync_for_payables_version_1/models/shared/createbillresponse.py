...
class CreateBillResponseAllocationTypedDict(TypedDict):
...
class CreateBillResponseAllocation(BaseModel):
...
class CreateBillResponseAccountingPaymentAllocationTypedDict(TypedDict):
    allocation: CreateBillResponseAllocationTypedDict
    payment: PaymentAllocationPaymentTypedDict


class CreateBillResponseAccountingPaymentAllocation(BaseModel):
    allocation: CreateBillResponseAllocation

    payment: PaymentAllocationPayment


class CreateBillResponsePurchaseOrderReferenceTypedDict(TypedDict):
    id: NotRequired[str]
...
class CreateBillResponsePurchaseOrderReference(BaseModel):
...
class CreateBillResponseWithholdingTaxTypedDict(TypedDict):
    amount: Decimal
...
class CreateBillResponseWithholdingTax(BaseModel):
    amount: Annotated[
        Decimal,
        BeforeValidator(validate_decimal),
        PlainSerializer(serialize_decimal(False)),
...
class AccountingBillTypedDict(TypedDict):
    ...
    * What the bill is for — the *line items*.
    ...
    payment_allocations: NotRequired[
        Nullable[List[CreateBillResponseAccountingPaymentAllocationTypedDict]]
    ]
    r"""An array of payment allocations."""
    purchase_order_refs: NotRequired[
        Nullable[List[CreateBillResponsePurchaseOrderReferenceTypedDict]]
    ]
    ...
    withholding_tax: NotRequired[
        Nullable[List[CreateBillResponseWithholdingTaxTypedDict]]
    ]
...
class AccountingBill(BaseModel):
    ...
    * What the bill is for — the *line items*.
    ...
    payment_allocations: Annotated[
        OptionalNullable[List[CreateBillResponseAccountingPaymentAllocation]],
        pydantic.Field(alias="paymentAllocations"),
    ] = UNSET
    r"""An array of payment allocations."""

    purchase_order_refs: Annotated[
        OptionalNullable[List[CreateBillResponsePurchaseOrderReference]],
    ...
    withholding_tax: Annotated[
        OptionalNullable[List[CreateBillResponseWithholdingTax]],
...
class CreateBillResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingBillTypedDict]]
...
class CreateBillResponse(BaseModel):
    ...
    data: OptionalNullable[AccountingBill] = UNSET
