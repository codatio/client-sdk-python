...
class UpdateBillResponseAllocationTypedDict(TypedDict):
...
class UpdateBillResponseAllocation(BaseModel):
...
class UpdateBillResponseAccountingPaymentAllocationTypedDict(TypedDict):
    allocation: UpdateBillResponseAllocationTypedDict
    payment: PaymentAllocationPaymentTypedDict


class UpdateBillResponseAccountingPaymentAllocation(BaseModel):
    allocation: UpdateBillResponseAllocation

    payment: PaymentAllocationPayment


class UpdateBillResponsePurchaseOrderReferenceTypedDict(TypedDict):
    id: NotRequired[str]
...
class UpdateBillResponsePurchaseOrderReference(BaseModel):
...
class UpdateBillResponseWithholdingTaxTypedDict(TypedDict):
    amount: Decimal
...
class UpdateBillResponseWithholdingTax(BaseModel):
    amount: Annotated[
        Decimal,
        BeforeValidator(validate_decimal),
        PlainSerializer(serialize_decimal(False)),
...
class UpdateBillResponseAccountingBillTypedDict(TypedDict):
    r"""> **Invoices or bills?**
    >
    ...
    * What the bill is for — the *line items*.
    ...
    payment_allocations: NotRequired[
        Nullable[List[UpdateBillResponseAccountingPaymentAllocationTypedDict]]
    ]
    r"""An array of payment allocations."""
    purchase_order_refs: NotRequired[
        Nullable[List[UpdateBillResponsePurchaseOrderReferenceTypedDict]]
    ]
    ...
    withholding_tax: NotRequired[
        Nullable[List[UpdateBillResponseWithholdingTaxTypedDict]]
    ]
...
class UpdateBillResponseAccountingBill(BaseModel):
    r"""> **Invoices or bills?**
    >
    > We distinguish between invoices where the company *owes money* vs. *is owed money*. If the company has received an invoice, and owes money to someone else (accounts payable) we call this a Bill.
    >
    ...
    * What the bill is for — the *line items*.
    ...
    payment_allocations: Annotated[
        OptionalNullable[List[UpdateBillResponseAccountingPaymentAllocation]],
        pydantic.Field(alias="paymentAllocations"),
    ] = UNSET
    r"""An array of payment allocations."""

    purchase_order_refs: Annotated[
        OptionalNullable[List[UpdateBillResponsePurchaseOrderReference]],
    ...
    withholding_tax: Annotated[
        OptionalNullable[List[UpdateBillResponseWithholdingTax]],
...
class UpdateBillResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[UpdateBillResponseAccountingBillTypedDict]]
...
class UpdateBillResponse(BaseModel):
    ...
    data: OptionalNullable[UpdateBillResponseAccountingBill] = UNSET
