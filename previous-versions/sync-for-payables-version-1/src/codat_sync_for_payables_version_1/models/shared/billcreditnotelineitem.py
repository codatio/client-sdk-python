...
class BillCreditNoteLineItemCustomerRefTypedDict(TypedDict):
    id: str
...
class BillCreditNoteLineItemCustomerRef(BaseModel):
    id: str
    r"""`id` from the Customers data type"""
...
class BillCreditNoteLineItemAccountingProjectReferenceTypedDict(TypedDict):
    id: str
...
class BillCreditNoteLineItemAccountingProjectReference(BaseModel):
    id: str
    r"""Unique identifier to the project reference."""
...
class BillCreditNoteLineItemTrackingTypedDict(TypedDict):
    ...
    r"""Defines if the invoice or credit note is billed/rebilled to a project or customer."""
    customer_ref: NotRequired[BillCreditNoteLineItemCustomerRefTypedDict]
    project_ref: NotRequired[BillCreditNoteLineItemAccountingProjectReferenceTypedDict]
...
class BillCreditNoteLineItemTracking(BaseModel):
    ...
    customer_ref: Annotated[
        Optional[BillCreditNoteLineItemCustomerRef], pydantic.Field(alias="customerRef")
    ] = None

    project_ref: Annotated[
        Optional[BillCreditNoteLineItemAccountingProjectReference],
        pydantic.Field(alias="projectRef"),
    ] = None
