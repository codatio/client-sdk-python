...
class AccountingBillPaymentTypedDict(TypedDict):
    ...
    lines: NotRequired[Nullable[List[BillPaymentLineTypedDict]]]
...
class CreateBillPaymentResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingBillPaymentTypedDict]]
...
class CreateBillPaymentResponse(BaseModel):
    ...
    data: OptionalNullable[AccountingBillPayment] = UNSET
