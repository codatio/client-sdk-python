...
class CreateBillCreditNoteResponseRecordReferenceTypedDict(TypedDict):
...
class CreateBillCreditNoteResponseRecordReference(BaseModel):
    r"""Links the current record to the underlying record or data type that created it.
...
class AccountingBillCreditNoteTypedDict(TypedDict):
    ...
    * The supplier that issued the bill credit note.
    ...
    created_from_refs: NotRequired[
        Nullable[List[CreateBillCreditNoteResponseRecordReferenceTypedDict]]
    ]
...
class AccountingBillCreditNote(BaseModel):
    ...
    * The supplier that issued the bill credit note.
    ...
    created_from_refs: Annotated[
        OptionalNullable[List[CreateBillCreditNoteResponseRecordReference]],
...
class CreateBillCreditNoteResponseTypedDict(TypedDict):
    company_id: str
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingBillCreditNoteTypedDict]]
...
class CreateBillCreditNoteResponse(BaseModel):
    ...
    data: OptionalNullable[AccountingBillCreditNote] = UNSET
