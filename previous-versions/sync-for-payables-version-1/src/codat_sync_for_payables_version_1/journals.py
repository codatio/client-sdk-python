...
class Journals(BaseSDK):
    ...
    def get_create_model(
        ...
        *,
        request: Union[
            operations.GetCreateJournalModelRequest,
            operations.GetCreateJournalModelRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreateJournalModelRequest)
        request = cast(operations.GetCreateJournalModelRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-create-journal-model",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
