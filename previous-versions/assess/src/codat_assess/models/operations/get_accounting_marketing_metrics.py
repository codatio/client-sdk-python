...
class GetAccountingMarketingMetricsRequestTypedDict(TypedDict):
    company_id: str
    ...
    show_input_values: NotRequired[bool]
    r"""If set to true, then the system includes the input values within the response."""


class GetAccountingMarketingMetricsRequest(BaseModel):
    ...
    show_input_values: Annotated[
        Optional[bool],
        pydantic.Field(alias="showInputValues"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""If set to true, then the system includes the input values within the response."""
