...
class AccountingCompanyInfo:
    ...
    def get_accounting_company_info(self, request: operations.GetAccountingCompanyInfoRequest, retries: Optional[utils.RetryConfig] = None) -> operations.GetAccountingCompanyInfoResponse:
        r"""Get company info
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AccountingCompanyDataset])
                res.accounting_company_dataset = out
            else:
