...
class AccountingBankAccounts:
    ...
    def get_accounting_bank_account(self, request: operations.GetAccountingBankAccountRequest, retries: Optional[utils.RetryConfig] = None) -> operations.GetAccountingBankAccountResponse:
        r"""Get bank account
    ...
    def list_accounting_bank_accounts(self, request: operations.ListAccountingBankAccountsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListAccountingBankAccountsResponse:
        ...
        def next_func() -> Optional[operations.ListAccountingBankAccountsResponse]:
            ...
            return self.list_accounting_bank_accounts(
