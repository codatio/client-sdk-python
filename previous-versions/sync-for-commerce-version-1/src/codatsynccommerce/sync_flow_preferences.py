...
class SyncFlowPreferences:
    ...
    def get_config_text_sync_flow(self, request: operations.GetConfigTextSyncFlowRequest, retries: Optional[utils.RetryConfig] = None) -> operations.GetConfigTextSyncFlowResponse:
        ...
        headers = {}
        query_params = utils.get_query_params(operations.GetConfigTextSyncFlowRequest, request)
    ...
    def update_config_text_sync_flow(self, request: operations.UpdateConfigTextSyncFlowRequest, retries: Optional[utils.RetryConfig] = None) -> operations.UpdateConfigTextSyncFlowResponse:
        ...
        url = base_url + '/sync/commerce/config/ui/text'
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateConfigTextSyncFlowRequest, "request_body", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.UpdateConfigTextSyncFlowRequest, request)
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
    ...
    def update_visible_accounts_sync_flow(self, request: operations.UpdateVisibleAccountsSyncFlowRequest, retries: Optional[utils.RetryConfig] = None) -> operations.UpdateVisibleAccountsSyncFlowResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateVisibleAccountsSyncFlowRequest, "visible_accounts", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
