...
class CommerceProducts:
    ...
    def get_commerce_product(self, request: operations.GetCommerceProductRequest, retries: Optional[utils.RetryConfig] = None) -> operations.GetCommerceProductResponse:
        r"""Get product
    ...
    def list_commerce_products(self, request: operations.ListCommerceProductsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListCommerceProductsResponse:
        r"""List products
        ...
        def next_func() -> Optional[operations.ListCommerceProductsResponse]:
            ...
            return self.list_commerce_products(
