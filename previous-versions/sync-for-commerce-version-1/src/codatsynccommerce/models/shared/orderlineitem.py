...
from .taxe_items import TaxeItems
...
class OrderLineItem:
    ...
    """
    taxes: Optional[List[TaxeItems]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxes'), 'exclude': lambda f: f is None }})
