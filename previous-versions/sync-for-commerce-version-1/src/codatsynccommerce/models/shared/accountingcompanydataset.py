...
class AccountingCompanyDatasetAddresses:
...
class AccountingCompanyDatasetWeblinkType(str, Enum):
...
class AccountingCompanyDatasetWeblink:
    ...
    type: Optional[AccountingCompanyDatasetWeblinkType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the weblink."""
...
class AccountingCompanyDataset:
    ...
    addresses: Optional[list[AccountingCompanyDatasetAddresses]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('addresses'), 'exclude': lambda f: f is None }})
