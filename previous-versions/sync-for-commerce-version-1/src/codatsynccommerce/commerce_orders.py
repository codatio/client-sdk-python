...
class CommerceOrders:
    ...
    def get_commerce_order(self, request: operations.GetCommerceOrderRequest, retries: Optional[utils.RetryConfig] = None) -> operations.GetCommerceOrderResponse:
        r"""Get order
    ...
    def list_commerce_orders(self, request: operations.ListCommerceOrdersRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListCommerceOrdersResponse:
        r"""List orders
        ...
        def next_func() -> Optional[operations.ListCommerceOrdersResponse]:
            ...
            return self.list_commerce_orders(
