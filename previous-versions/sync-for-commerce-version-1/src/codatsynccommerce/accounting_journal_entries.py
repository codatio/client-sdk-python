...
class AccountingJournalEntries:
    ...
    def create_accounting_journal_entry(self, request: operations.CreateAccountingJournalEntryRequest, retries: Optional[utils.RetryConfig] = None) -> operations.CreateAccountingJournalEntryResponse:
        ...
        **Integration-specific behaviour**
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, operations.CreateAccountingJournalEntryRequest, "accounting_journal_entry", True, True, 'json')
