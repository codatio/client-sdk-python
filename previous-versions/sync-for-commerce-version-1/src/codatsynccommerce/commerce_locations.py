...
class CommerceLocations:
    ...
    def get_commerce_location(self, request: operations.GetCommerceLocationRequest, retries: Optional[utils.RetryConfig] = None) -> operations.GetCommerceLocationResponse:
        r"""Get location
    ...
    def list_commerce_locations(self, request: operations.ListCommerceLocationsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListCommerceLocationsResponse:
        r"""List locations
