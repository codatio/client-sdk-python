...
class CommerceCompanyInfo:
    ...
    def get_commerce_company_info(self, request: operations.GetCommerceCompanyInfoRequest, retries: Optional[utils.RetryConfig] = None) -> operations.GetCommerceCompanyInfoResponse:
        r"""Get company info
