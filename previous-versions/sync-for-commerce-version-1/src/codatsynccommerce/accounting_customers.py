...
class AccountingCustomers:
    ...
    def create_accounting_customer(self, request: operations.CreateAccountingCustomerRequest, retries: Optional[utils.RetryConfig] = None) -> operations.CreateAccountingCustomerResponse:
        r"""Create customer
        ...
        **Integration-specific behaviour**
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, operations.CreateAccountingCustomerRequest, "accounting_customer", True, True, 'json')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreateCustomerResponse])
                res.accounting_create_customer_response = out
            else:
