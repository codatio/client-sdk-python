...
class Orders:
    ...
    def list(self, request: operations.ListOrdersRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListOrdersResponse:
        ...
        def next_func() -> Optional[operations.ListOrdersResponse]:
        ...
        res = operations.ListOrdersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
