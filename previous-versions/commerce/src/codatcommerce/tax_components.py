...
class TaxComponents:
    ...
    def list(self, request: operations.ListTaxComponentsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListTaxComponentsResponse:
        ...
        def next_func() -> Optional[operations.ListTaxComponentsResponse]:
        ...
        res = operations.ListTaxComponentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
