...
class CompanyInfoSDK(BaseSDK):
    ...
    def get(
        ...
        *,
        request: Union[
            models.GetCompanyInfoRequest, models.GetCompanyInfoRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.CompanyInfo]:
        r"""Get company info
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetCompanyInfoRequest)
        request = cast(models.GetCompanyInfoRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.CompanyInfo])
