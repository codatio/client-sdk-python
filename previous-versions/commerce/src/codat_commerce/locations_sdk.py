...
class LocationsSDK(BaseSDK):
    r"""Retrieve standardized data from linked commerce software."""

    def get(
        self,
        *,
        request: Union[models.GetLocationRequest, models.GetLocationRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetLocationRequest)
        request = cast(models.GetLocationRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.Location])
    ...
    def list(
        ...
        *,
        request: Union[
            models.ListLocationsRequest, models.ListLocationsRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.Locations]:
        r"""List locations
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.ListLocationsRequest)
        request = cast(models.ListLocationsRequest, request)
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.Locations])
        if utils.match_response(
            http_res,
            ["401", "402", "403", "404", "409", "429", "500", "503"],
            "application/json",
