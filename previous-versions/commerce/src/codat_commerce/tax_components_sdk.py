...
class TaxComponentsSDK(BaseSDK):
    ...
    def get(
        ...
        *,
        request: Union[
            models.GetTaxComponentRequest, models.GetTaxComponentRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.TaxComponent]:
        r"""Get tax component
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetTaxComponentRequest)
        request = cast(models.GetTaxComponentRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/connections/{connectionId}/data/commerce-taxComponents/{taxId}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-tax-component",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.TaxComponent])
    ...
    def list(
        ...
        *,
        request: Union[
            models.ListTaxComponentsRequest, models.ListTaxComponentsRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.TaxComponents]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.ListTaxComponentsRequest)
        request = cast(models.ListTaxComponentsRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/connections/{connectionId}/data/commerce-taxComponents",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list-tax-components",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.TaxComponents])
        if utils.match_response(
            http_res,
