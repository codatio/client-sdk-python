...
class DisputesSDK(BaseSDK):
    r"""Retrieve standardized data from linked commerce software."""

    def get(
        self,
        *,
        request: Union[models.GetDisputeRequest, models.GetDisputeRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetDisputeRequest)
        request = cast(models.GetDisputeRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.Dispute])
    ...
    def list(
        self,
        *,
        request: Union[models.ListDisputesRequest, models.ListDisputesRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.Disputes]:
        r"""List disputes
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.Disputes])
        if utils.match_response(
            http_res,
