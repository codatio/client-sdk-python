...
from codat_files._hooks import HookContext
from codat_files.models import errors, operations, shared
from codat_files.types import BaseModel, OptionalNullable, UNSET
import httpx
...
class Files(BaseSDK):
    ...
    def download_files(
        ...
        *,
        ...
        if utils.match_response(
            http_res,
            ["400", "401", "402", "404", "429", "500", "503"],
            "application/json",
        ):
            data = utils.unmarshal_json(http_res.text, errors.SchemaData)
            raise errors.Schema(data=data)
        if utils.match_response(http_res, "403", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, errors.DownloadFilesErrorMessageData
            )
            raise errors.DownloadFilesErrorMessage(data=data)
    ...
    def list_files(
        ...
        *,
        ...
        if utils.match_response(
            http_res, ["401", "402", "404", "429", "500", "503"], "application/json"
        ):
            data = utils.unmarshal_json(http_res.text, errors.SchemaData)
            raise errors.Schema(data=data)
        if utils.match_response(http_res, "403", "application/json"):
            data = utils.unmarshal_json(http_res.text, errors.ListFilesErrorMessageData)
            raise errors.ListFilesErrorMessage(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise errors.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
            )
    ...
    def upload_files(
        ...
        *,
        ...
        if utils.match_response(http_res, "403", "application/json"):
            data = utils.unmarshal_json(
                http_res.text, errors.UploadFilesErrorMessageData
            )
            raise errors.UploadFilesErrorMessage(data=data)
        if utils.match_response(http_res, ["4XX", "5XX"], "*"):
            raise errors.SDKError(
                "API error occurred", http_res.status_code, http_res.text, http_res
            )
