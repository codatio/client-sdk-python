...
class UploadFilesErrorMessageData(BaseModel):
...
class UploadFilesErrorMessage(Exception):
    r"""You are using an outdated API key or a key not associated with that resource."""

    data: UploadFilesErrorMessageData

    def __init__(self, data: UploadFilesErrorMessageData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, UploadFilesErrorMessageData)
