...
class ListFilesErrorMessageData(BaseModel):
...
class ListFilesErrorMessage(Exception):
    r"""You are using an outdated API key or a key not associated with that resource."""

    data: ListFilesErrorMessageData

    def __init__(self, data: ListFilesErrorMessageData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, ListFilesErrorMessageData)
