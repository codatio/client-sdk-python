...
from codat_files.models.shared import errorvalidation as shared_errorvalidation
...
class DownloadFilesErrorMessageData(BaseModel):
...
class DownloadFilesErrorMessage(Exception):
    r"""You are using an outdated API key or a key not associated with that resource."""

    data: DownloadFilesErrorMessageData

    def __init__(self, data: DownloadFilesErrorMessageData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, DownloadFilesErrorMessageData)
