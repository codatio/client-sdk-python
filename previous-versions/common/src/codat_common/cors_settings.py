...
class CorsSettings(BaseSDK):
        ...
        *,
    ...
    ) -> Optional[models.ConnectionManagementAllowedOrigins]:
        r"""Get CORS settings
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.ConnectionManagementAllowedOrigins]
            )
    ...
    def set(
        ...
        *,
        request: Optional[
            Union[
                models.ConnectionManagementAllowedOrigins,
                models.ConnectionManagementAllowedOriginsTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        if not isinstance(request, BaseModel) and request is not None:
            request = utils.unmarshal(
                request, models.ConnectionManagementAllowedOrigins
            )
        request = cast(models.ConnectionManagementAllowedOrigins, request)
