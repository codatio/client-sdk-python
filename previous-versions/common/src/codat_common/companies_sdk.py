...
class CompaniesSDK(BaseSDK):
    ...
    def create(
        ...
        *,
        request: Optional[
            Union[models.CompanyRequestBody, models.CompanyRequestBodyTypedDict]
        ] = None,
        ...
        if not isinstance(request, BaseModel) and request is not None:
            request = utils.unmarshal(request, models.CompanyRequestBody)
        request = cast(models.CompanyRequestBody, request)
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.CompanyRequestBody]
            ),
    ...
    def delete(
        ...
        *,
        request: Union[
            models.DeleteCompanyRequest, models.DeleteCompanyRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.DeleteCompanyRequest)
        request = cast(models.DeleteCompanyRequest, request)
    ...
    def get(
        self,
        *,
        request: Union[models.GetCompanyRequest, models.GetCompanyRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.Company]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetCompanyRequest)
        request = cast(models.GetCompanyRequest, request)
    ...
    def list(
        ...
        *,
        request: Union[
            models.ListCompaniesRequest, models.ListCompaniesRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.Companies]:
        r"""List companies
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.ListCompaniesRequest)
        request = cast(models.ListCompaniesRequest, request)
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.Companies])
        if utils.match_response(
            http_res,
    ...
    def update(
        ...
        *,
        request: Union[
            models.UpdateCompanyRequest, models.UpdateCompanyRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.UpdateCompanyRequest)
        request = cast(models.UpdateCompanyRequest, request)
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.CompanyRequestBody],
            ),
            timeout_ms=timeout_ms,
        )
