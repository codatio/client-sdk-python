...
from codat_common.cors_settings import CorsSettings
from codat_common.types import BaseModel, OptionalNullable, UNSET
from typing import Any, Optional, Union, cast


class ConnectionManagement(BaseSDK):
    ...
    def get_access_token(
        ...
        *,
        request: Union[
            models.GetConnectionManagementAccessTokenRequest,
            models.GetConnectionManagementAccessTokenRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.ConnectionManagementAccessToken]:
        r"""Get access token
        ...
        request = cast(models.GetConnectionManagementAccessTokenRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.ConnectionManagementAccessToken]
            )
