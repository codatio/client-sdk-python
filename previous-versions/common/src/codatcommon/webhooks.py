...
class Webhooks:
    ...
    def list(self, request: operations.ListRulesRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListRulesResponse:
        ...
        def next_func() -> Optional[operations.ListRulesResponse]:
        ...
        res = operations.ListRulesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
