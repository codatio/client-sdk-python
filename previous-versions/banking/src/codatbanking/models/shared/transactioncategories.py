...
class TransactionCategories:
    ...
    results: Optional[List[TransactionCategory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
