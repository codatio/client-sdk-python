...
class TransactionCategoriesSDK(BaseSDK):
    ...
    def get(
        ...
        *,
        request: Union[
            models.GetTransactionCategoryRequest,
            models.GetTransactionCategoryRequestTypedDict,
        ],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetTransactionCategoryRequest)
        request = cast(models.GetTransactionCategoryRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-transaction-category",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.TransactionCategory]
            )
    ...
    def list(
        ...
        *,
        request: Union[
            models.ListTransactionCategoriesRequest,
            models.ListTransactionCategoriesRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.TransactionCategories]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.ListTransactionCategoriesRequest)
        request = cast(models.ListTransactionCategoriesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list-transaction-categories",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[models.TransactionCategories]
            )
        if utils.match_response(
            http_res,
