...
from codat_banking.utils import FieldMetadata, PathParamMetadata
import pydantic
from typing import TypedDict
from typing_extensions import Annotated


class GetTransactionCategoryRequestTypedDict(TypedDict):
    company_id: str
...
class GetTransactionCategoryRequest(BaseModel):
