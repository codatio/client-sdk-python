...
class AccountsSDK(BaseSDK):
    r"""Where payments are made or received, and bank transactions are recorded."""

    def get(
        self,
        *,
        request: Union[models.GetAccountRequest, models.GetAccountRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetAccountRequest)
        request = cast(models.GetAccountRequest, request)
    ...
    def list(
        self,
        *,
        request: Union[models.ListAccountsRequest, models.ListAccountsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.Accounts]:
        r"""List accounts
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.Accounts])
        if utils.match_response(
            http_res,
