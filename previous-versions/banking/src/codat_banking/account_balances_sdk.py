...
class AccountBalancesSDK(BaseSDK):
    ...
    def list(
        ...
        *,
        request: Union[
            models.ListAccountBalancesRequest,
            models.ListAccountBalancesRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.AccountBalances]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.ListAccountBalancesRequest)
        request = cast(models.ListAccountBalancesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list-account-balances",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[models.AccountBalances])
