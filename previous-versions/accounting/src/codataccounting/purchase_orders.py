...
class PurchaseOrders:
    ...
    def list(self, request: operations.ListPurchaseOrdersRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListPurchaseOrdersResponse:
        ...
        def next_func() -> Optional[operations.ListPurchaseOrdersResponse]:
            ...
            return self.list(
                request=operations.ListPurchaseOrdersRequest(
        ...
        res = operations.ListPurchaseOrdersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
