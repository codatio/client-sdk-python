...
class CreditNotes:
    ...
    def list(self, request: operations.ListCreditNotesRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListCreditNotesResponse:
        ...
        def next_func() -> Optional[operations.ListCreditNotesResponse]:
        ...
        res = operations.ListCreditNotesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
