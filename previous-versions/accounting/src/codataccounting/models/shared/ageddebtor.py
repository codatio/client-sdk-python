...
import dataclasses
from .agedcurrencyoutstanding_items import AgedCurrencyOutstandingItems
...
class AgedDebtor:
    aged_currency_outstanding: Optional[List[AgedCurrencyOutstandingItems]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('agedCurrencyOutstanding'), 'exclude': lambda f: f is None }})
