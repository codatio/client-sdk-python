...
from .salesorderref import SalesOrderRef
...
class Invoice:
    ...
    sales_order_refs: Optional[List[SalesOrderRef]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('salesOrderRefs') }})
