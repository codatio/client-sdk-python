...
from ...models.shared import itemreceipts as shared_itemreceipts
from typing import Optional


@dataclasses.dataclass
class ListItemReceiptsRequest:
...
@dataclasses.dataclass
class ListItemReceiptsResponse:
    ...
    item_receipts: Optional[shared_itemreceipts.ItemReceipts] = dataclasses.field(default=None)
    r"""Success"""
