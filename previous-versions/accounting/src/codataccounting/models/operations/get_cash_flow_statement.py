...
from ...models.shared import cashflowstatement_input as shared_cashflowstatement_input
...
class GetCashFlowStatementResponse:
    ...
    cash_flow_statement: Optional[shared_cashflowstatement_input.CashFlowStatementInput] = dataclasses.field(default=None)
    r"""Success"""
