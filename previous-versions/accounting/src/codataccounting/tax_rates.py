...
class TaxRates:
    ...
    def list(self, request: operations.ListTaxRatesRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListTaxRatesResponse:
        ...
        def next_func() -> Optional[operations.ListTaxRatesResponse]:
        ...
        res = operations.ListTaxRatesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
