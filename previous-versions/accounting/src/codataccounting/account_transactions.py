...
class AccountTransactions:
    ...
    def list(self, request: operations.ListAccountTransactionsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListAccountTransactionsResponse:
        ...
        def next_func() -> Optional[operations.ListAccountTransactionsResponse]:
        ...
        res = operations.ListAccountTransactionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
