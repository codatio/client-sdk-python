...
class BillPayments:
    ...
    def list(self, request: operations.ListBillPaymentsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListBillPaymentsResponse:
        ...
        def next_func() -> Optional[operations.ListBillPaymentsResponse]:
        ...
        res = operations.ListBillPaymentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
