...
class Invoices:
    ...
    def list(self, request: operations.ListInvoicesRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListInvoicesResponse:
        ...
        def next_func() -> Optional[operations.ListInvoicesResponse]:
        ...
        res = operations.ListInvoicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
