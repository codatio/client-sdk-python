...
class BankAccounts:
    ...
    def list(self, request: operations.ListBankAccountsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListBankAccountsResponse:
        ...
        def next_func() -> Optional[operations.ListBankAccountsResponse]:
        ...
        res = operations.ListBankAccountsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
