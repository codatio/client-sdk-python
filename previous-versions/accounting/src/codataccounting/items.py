...
class Items:
    ...
    def list(self, request: operations.ListItemsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListItemsResponse:
        ...
        def next_func() -> Optional[operations.ListItemsResponse]:
        ...
        res = operations.ListItemsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
