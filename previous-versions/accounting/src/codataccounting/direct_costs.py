...
class DirectCosts:
    ...
    def list(self, request: operations.ListDirectCostsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListDirectCostsResponse:
        ...
        def next_func() -> Optional[operations.ListDirectCostsResponse]:
            ...
            return self.list(
                request=operations.ListDirectCostsRequest(
        ...
        res = operations.ListDirectCostsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
