...
class Transfers:
    ...
    def list(self, request: operations.ListTransfersRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListTransfersResponse:
        ...
        def next_func() -> Optional[operations.ListTransfersResponse]:
        ...
        res = operations.ListTransfersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
