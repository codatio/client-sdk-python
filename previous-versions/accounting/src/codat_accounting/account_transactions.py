...
class AccountTransactions(BaseSDK):
    ...
    def get(
        ...
        *,
        request: Union[
            operations.GetAccountTransactionRequest,
            operations.GetAccountTransactionRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountTransaction]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountTransactionRequest)
        request = cast(operations.GetAccountTransactionRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-account-transaction",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[shared.AccountTransaction]
            )
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListAccountTransactionsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountTransactions]:
        ...
        request = cast(operations.ListAccountTransactionsRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[shared.AccountTransactions]
            )
        if utils.match_response(
            http_res,
