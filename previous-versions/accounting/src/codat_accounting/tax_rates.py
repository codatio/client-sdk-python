...
class TaxRates(BaseSDK):
    ...
    def get(
        ...
        *,
        request: Union[
            operations.GetTaxRateRequest, operations.GetTaxRateRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.TaxRate]:
        r"""Get tax rate
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetTaxRateRequest)
        request = cast(operations.GetTaxRateRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/data/taxRates/{taxRateId}",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.TaxRate])
    ...
    def list(
        ...
        *,
        request: Union[
            operations.ListTaxRatesRequest, operations.ListTaxRatesRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.TaxRates]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListTaxRatesRequest)
        request = cast(operations.ListTaxRatesRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/data/taxRates",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.TaxRates])
        if utils.match_response(
            http_res,
