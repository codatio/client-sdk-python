...
class DirectIncomesTypedDict(TypedDict):
    ...
    results: NotRequired[List[DirectIncomeTypedDict]]


class DirectIncomes(BaseModel):
    ...
    results: Optional[List[DirectIncome]] = None
