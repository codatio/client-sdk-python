...
from .salesorderref import SalesOrderRef, SalesOrderRefTypedDict
...
class AccountingInvoiceTypedDict(TypedDict):
    ...
    sales_order_refs: NotRequired[Nullable[List[SalesOrderRefTypedDict]]]
...
class AccountingInvoice(BaseModel):
    ...
    sales_order_refs: Annotated[
        OptionalNullable[List[SalesOrderRef]], pydantic.Field(alias="salesOrderRefs")
    ] = UNSET
    r"""List of references to related Sales orders."""
...
class CreateInvoiceResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingInvoiceTypedDict]]
...
class CreateInvoiceResponse(BaseModel):
    ...
    data: OptionalNullable[AccountingInvoice] = UNSET
