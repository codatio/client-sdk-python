...
class UpdateCreditNoteResponseAccountingCreditNoteTypedDict(TypedDict):
...
class UpdateCreditNoteResponseAccountingCreditNote(BaseModel):
    r"""> View the coverage for credit notes in the <a className=\"external\" href=\"https://knowledge.codat.io/supported-features/accounting?view=tab-by-data-type&dataType=creditNotes\" target=\"_blank\">Data coverage explorer</a>.
...
class UpdateCreditNoteResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[UpdateCreditNoteResponseAccountingCreditNoteTypedDict]]
...
class UpdateCreditNoteResponse(BaseModel):
    ...
    data: OptionalNullable[UpdateCreditNoteResponseAccountingCreditNote] = UNSET
