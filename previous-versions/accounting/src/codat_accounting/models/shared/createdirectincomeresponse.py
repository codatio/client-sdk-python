...
class AccountingDirectIncomeTypedDict(TypedDict):
    ...
    payment_allocations: List[PaymentAllocationItemsTypedDict]
    sub_total: Decimal
...
class AccountingDirectIncome(BaseModel):
    ...
    payment_allocations: Annotated[
        List[PaymentAllocationItems], pydantic.Field(alias="paymentAllocations")
    ]
...
class CreateDirectIncomeResponseTypedDict(TypedDict):
    company_id: str
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingDirectIncomeTypedDict]]
...
class CreateDirectIncomeResponse(BaseModel):
    ...
    data: OptionalNullable[AccountingDirectIncome] = UNSET
