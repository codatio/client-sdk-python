...
from .accounttransaction import AccountTransaction, AccountTransactionTypedDict
...
class AccountTransactionsTypedDict(TypedDict):
    ...
    results: NotRequired[List[AccountTransactionTypedDict]]
...
class AccountTransactions(BaseModel):
    ...
    results: Optional[List[AccountTransaction]] = None
