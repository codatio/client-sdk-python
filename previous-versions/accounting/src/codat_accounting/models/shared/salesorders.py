...
from .salesorder import SalesOrder, SalesOrderTypedDict
...
class SalesOrdersTypedDict(TypedDict):
    ...
    results: NotRequired[List[SalesOrderTypedDict]]
...
class SalesOrders(BaseModel):
    ...
    results: Optional[List[SalesOrder]] = None
