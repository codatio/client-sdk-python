...
class DirectCostAllocationTypedDict(TypedDict):
...
class DirectCostAllocation(BaseModel):
...
class DirectCostAccountingPaymentAllocationTypedDict(TypedDict):
    allocation: DirectCostAllocationTypedDict
    payment: PaymentAllocationPaymentTypedDict


class DirectCostAccountingPaymentAllocation(BaseModel):
    allocation: DirectCostAllocation

    payment: PaymentAllocationPayment


class DirectCostTypedDict(TypedDict):
    ...
    * Writing a cheque
    ...
    payment_allocations: List[DirectCostAccountingPaymentAllocationTypedDict]
...
class DirectCost(BaseModel):
    ...
    * Writing a cheque
    ...
    payment_allocations: Annotated[
        List[DirectCostAccountingPaymentAllocation],
