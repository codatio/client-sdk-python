...
from .directcost import DirectCost, DirectCostTypedDict
...
class DirectCostsTypedDict(TypedDict):
    ...
    results: NotRequired[List[DirectCostTypedDict]]
...
class DirectCosts(BaseModel):
    ...
    results: Optional[List[DirectCost]] = None
