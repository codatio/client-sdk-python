...
from codat_accounting.models.shared import billpayment as shared_billpayment
...
class CreateBillPaymentRequestTypedDict(TypedDict):
    ...
    bill_payment: NotRequired[Nullable[shared_billpayment.BillPaymentTypedDict]]
...
class CreateBillPaymentRequest(BaseModel):
    ...
    bill_payment: Annotated[
        OptionalNullable[shared_billpayment.BillPayment],
    ...
    def serialize_model(self, handler):
        optional_fields = ["BillPayment", "timeoutInMinutes"]
        nullable_fields = ["BillPayment"]
        null_default_fields = []
