...
from codat_accounting.models.shared import purchaseorder as shared_purchaseorder
...
class UpdatePurchaseOrderRequestTypedDict(TypedDict):
    company_id: str
    ...
    purchase_order: NotRequired[Nullable[shared_purchaseorder.PurchaseOrderTypedDict]]
...
class UpdatePurchaseOrderRequest(BaseModel):
    ...
    purchase_order: Annotated[
        OptionalNullable[shared_purchaseorder.PurchaseOrder],
    ...
    def serialize_model(self, handler):
        optional_fields = ["PurchaseOrder", "forceUpdate", "timeoutInMinutes"]
        nullable_fields = ["PurchaseOrder"]
        null_default_fields = []
