...
from codat_accounting.models.shared import invoice as shared_invoice
...
class UpdateInvoiceRequestTypedDict(TypedDict):
    ...
    invoice: NotRequired[Nullable[shared_invoice.InvoiceTypedDict]]
...
class UpdateInvoiceRequest(BaseModel):
    ...
    invoice: Annotated[
        OptionalNullable[shared_invoice.Invoice],
    ...
    def serialize_model(self, handler):
        optional_fields = ["Invoice", "forceUpdate", "timeoutInMinutes"]
