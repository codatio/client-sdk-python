...
class Items(BaseSDK):
    ...
    def create(
        ...
        *,
        request: Union[
            operations.CreateItemRequest, operations.CreateItemRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CreateItemResponse]:
        r"""Create item
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.CreateItemRequest)
        request = cast(operations.CreateItemRequest, request)

        req = self.build_request(
            method="POST",
            path="/companies/{companyId}/connections/{connectionId}/push/items",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.item, True, True, "json", OptionalNullable[shared.Item]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[shared.CreateItemResponse]
            )
    ...
    def get(
        self,
        *,
        request: Union[operations.GetItemRequest, operations.GetItemRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.Item]:
        r"""Get item
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetItemRequest)
        request = cast(operations.GetItemRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/data/items/{itemId}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.Item])
        if utils.match_response(
            http_res,
    ...
    def get_create_model(
        ...
        *,
        request: Union[
            operations.GetCreateItemsModelRequest,
            operations.GetCreateItemsModelRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreateItemsModelRequest)
        request = cast(operations.GetCreateItemsModelRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/connections/{connectionId}/options/items",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-create-items-model",
                oauth2_scopes=[],
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    def list(
        ...
        *,
        request: Union[
            operations.ListItemsRequest, operations.ListItemsRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.SchemaItems]:
        r"""List items
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListItemsRequest)
        request = cast(operations.ListItemsRequest, request)

        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/data/items",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.SchemaItems])
        if utils.match_response(
            http_res,
