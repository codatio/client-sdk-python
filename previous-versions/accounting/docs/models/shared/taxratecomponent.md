...
| `name`                                                                             | *OptionalNullable[str]*                                                            | :heavy_minus_sign:                                                                 | Name of the tax rate component.                                                    |
| `rate`                                                                             | *OptionalNullable[Decimal]*                                                        | :heavy_minus_sign:                                                                 | The rate of the tax rate component, usually a percentage.                          |