    ...
    direct_income=shared.DirectIncome(
        ...
        line_items=[
            shared.DirectIncomeLineItem(
                ...
                description='id',
                discount_amount=8409.92,
                discount_percentage=590.23,
                ...
                tax_rate_ref=shared.TaxRateRef(
                    effective_tax_rate=9559.62,
                    id='3ffdd9f7-f079-4af4-9357-24cdb0f4d281',
                    name='Irma Kub',
                ),
                total_amount=4357.13,
