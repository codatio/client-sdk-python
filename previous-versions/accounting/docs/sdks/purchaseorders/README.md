    ...
    purchase_order=shared.PurchaseOrder(
        ...
        line_items=[
            shared.PurchaseOrderLineItem(
                ...
                description='iusto',
                discount_amount=6339.56,
                discount_percentage=4531.11,
        ...
        total_amount=1230.16,
        total_discount=9225.93,
        total_tax_amount=8182.73,
    ),
    ...
    purchase_order=shared.PurchaseOrder(
        ...
        line_items=[
            shared.PurchaseOrderLineItem(
                ...
                description='facere',
                discount_amount=113.92,
                discount_percentage=9309.42,
                item_ref=shared.ItemRef(
        ...
        total_amount=9708.48,
        total_discount=1170.53,
        total_tax_amount=234.1,
    ),
    company_id='8a210b68-6988-11ed-a1eb-0242ac120002',
    connection_id='2e9d2c44-f675-40ba-8049-353bfcb5e171',
    force_update=False,
