...
<!-- UsageSnippet language="python" operationID="get-commerce-transaction" method="get" path="/companies/{companyId}/connections/{connectionId}/data/commerce-transactions/{transactionId}" -->
```python
...
<!-- UsageSnippet language="python" operationID="list-commerce-transactions" method="get" path="/companies/{companyId}/connections/{connectionId}/data/commerce-transactions" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
