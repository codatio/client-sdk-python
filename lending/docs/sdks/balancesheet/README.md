...
<!-- UsageSnippet language="python" operationID="get-categorized-balance-sheet-statement" method="get" path="/companies/{companyId}/reports/enhancedBalanceSheet/accounts" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
...
with CodatLending(
    ...
    res = cl_client.financial_statements.balance_sheet.get_categorized_accounts(request={
        "company_id": "8a210b68-6988-11ed-a1eb-0242ac120002",
