...
<!-- UsageSnippet language="python" operationID="list-banking-account-balances" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accountBalances" example="Basiq" -->
```python
...
with CodatLending(
    ...
    res = cl_client.banking.account_balances.list(request={
...
<!-- UsageSnippet language="python" operationID="list-banking-account-balances" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accountBalances" example="Plaid" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
