...
<!-- UsageSnippet language="python" operationID="get-banking-account" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accounts/{accountId}" example="Basiq" -->
```python
...
<!-- UsageSnippet language="python" operationID="get-banking-account" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accounts/{accountId}" example="Plaid" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
...
<!-- UsageSnippet language="python" operationID="list-banking-accounts" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accounts" example="Basiq" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
...
<!-- UsageSnippet language="python" operationID="list-banking-accounts" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-accounts" example="Plaid" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
