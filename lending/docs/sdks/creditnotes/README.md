...
<!-- UsageSnippet language="python" operationID="get-accounting-credit-note" method="get" path="/companies/{companyId}/data/creditNotes/{creditNoteId}" -->
```python
...
<!-- UsageSnippet language="python" operationID="list-accounting-credit-notes" method="get" path="/companies/{companyId}/data/creditNotes" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
