...
with CodatLending(
    ...
    res = codat_lending.sales.payments.get(request={
...
**[shared.CommercePayment](../../models/shared/commercepayment.md)**
...
with CodatLending(
    ...
    res = codat_lending.sales.payments.list(request={
        "company_id": "8a210b68-6988-11ed-a1eb-0242ac120002",
        "connection_id": "2e9d2c44-f675-40ba-8049-353bfcb5e171",
...
**[shared.CommercePayments](../../models/shared/commercepayments.md)**
