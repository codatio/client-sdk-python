...
<!-- UsageSnippet language="python" operationID="create-supplier" method="post" path="/companies/{companyId}/connections/{connectionId}/push/suppliers" -->
```python
...
<!-- UsageSnippet language="python" operationID="get-create-update-suppliers-model" method="get" path="/companies/{companyId}/connections/{connectionId}/options/suppliers" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
