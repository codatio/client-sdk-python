...
<!-- UsageSnippet language="python" operationID="get-banking-transaction-category" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories/{transactionCategoryId}" example="Basiq" -->
```python
...
with CodatLending(
    ...
    res = cl_client.banking.transaction_categories.get(request={
...
<!-- UsageSnippet language="python" operationID="get-banking-transaction-category" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories/{transactionCategoryId}" example="Plaid" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
...
<!-- UsageSnippet language="python" operationID="list-banking-transaction-categories" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories" example="Basiq" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
...
with CodatLending(
    ...
    res = cl_client.banking.transaction_categories.list(request={
        "company_id": "8a210b68-6988-11ed-a1eb-0242ac120002",
        "connection_id": "2e9d2c44-f675-40ba-8049-353bfcb5e171",
...
<!-- UsageSnippet language="python" operationID="list-banking-transaction-categories" method="get" path="/companies/{companyId}/connections/{connectionId}/data/banking-transactionCategories" example="Plaid" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
