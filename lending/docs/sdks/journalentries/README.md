...
<!-- UsageSnippet language="python" operationID="get-accounting-journal-entry" method="get" path="/companies/{companyId}/data/journalEntries/{journalEntryId}" -->
```python
...
<!-- UsageSnippet language="python" operationID="list-accounting-journal-entries" method="get" path="/companies/{companyId}/data/journalEntries" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
