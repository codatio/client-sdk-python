...
<!-- UsageSnippet language="python" operationID="get-accounting-supplier" method="get" path="/companies/{companyId}/data/suppliers/{supplierId}" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
...
<!-- UsageSnippet language="python" operationID="list-accounting-suppliers" method="get" path="/companies/{companyId}/data/suppliers" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
