...
<!-- UsageSnippet language="python" operationID="get-accounting-profile" method="get" path="/companies/{companyId}/data/info" example="Example 1" -->
```python
...
<!-- UsageSnippet language="python" operationID="get-commerce-profile" method="get" path="/companies/{companyId}/connections/{connectionId}/data/commerce-info" example="Example 1" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
