...
<!-- UsageSnippet language="python" operationID="get-commerce-customer" method="get" path="/companies/{companyId}/connections/{connectionId}/data/commerce-customers/{customerId}" -->
```python
...
<!-- UsageSnippet language="python" operationID="list-commerce-customers" method="get" path="/companies/{companyId}/connections/{connectionId}/data/commerce-customers" -->
```python
from codat_lending import CodatLending
from codat_lending.models import shared
