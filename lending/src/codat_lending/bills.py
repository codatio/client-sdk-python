...
class Bills(BaseSDK):
    ...
    def download_attachment(
        self, *,
        request: Union[operations.DownloadAccountingBillAttachmentRequest, operations.DownloadAccountingBillAttachmentRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.DownloadAccountingBillAttachmentRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="download-accounting-bill-attachment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingBillRequest, operations.GetAccountingBillRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBill]:
        r"""Get bill
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-bill", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBill])
    ...
    def get_attachment(
        self, *,
        request: Union[operations.GetAccountingBillAttachmentRequest, operations.GetAccountingBillAttachmentRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingBillAttachmentRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-bill-attachment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingBillsRequest, operations.ListAccountingBillsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBills]:
        r"""List bills
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-bills", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBills])
    ...
    def list_attachments(
        self, *,
        request: Union[operations.ListAccountingBillAttachmentsRequest, operations.ListAccountingBillAttachmentsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingBillAttachmentsRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-bill-attachments", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["401","402","403","404","409","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
