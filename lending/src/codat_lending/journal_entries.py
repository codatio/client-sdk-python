...
class JournalEntries(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingJournalEntryRequest, operations.GetAccountingJournalEntryRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingJournalEntryRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-journal-entry", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingJournalEntry])
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingJournalEntriesRequest, operations.ListAccountingJournalEntriesRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingJournalEntriesRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-journal-entries", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingJournalEntries])
