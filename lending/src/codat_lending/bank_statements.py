...
class BankStatements(BaseSDK):
    ...
    def end_upload_session(
        self, *,
        request: Union[operations.EndBankStatementUploadSessionRequest, operations.EndBankStatementUploadSessionRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.EndBankStatementUploadSessionRequest)
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.end_upload_session_request, False, True, "json", Optional[shared.EndUploadSessionRequest]),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="end-bank-statement-upload-session", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def get_upload_configuration(
        self, *,
        request: Union[operations.GetBankStatementUploadConfigurationRequest, operations.GetBankStatementUploadConfigurationRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetBankStatementUploadConfigurationRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-bank-statement-upload-configuration", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.BankStatementUploadConfiguration])
        if utils.match_response(http_res, ["400","401","402","403","404","429","500","503"], "application/json"):
            data = utils.unmarshal_json(http_res.text, errors.ErrorMessageData)
            raise errors.ErrorMessage(data=data)
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
    ...
    def set_upload_configuration(
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.SetBankStatementUploadConfigurationRequest)
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.bank_statement_upload_configuration, False, True, "json", Optional[shared.BankStatementUploadConfiguration]),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="set-bank-statement-upload-configuration", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
    ...
    def start_upload_session(
        self, *,
        request: Union[operations.StartBankStatementUploadSessionRequest, operations.StartBankStatementUploadSessionRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.StartBankStatementUploadSessionRequest)
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.start_upload_session_request, False, True, "json", Optional[shared.StartUploadSessionRequest]),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="start-bank-statement-upload-session", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
    ...
    def upload_bank_statement_data(
        self, *,
        request: Union[operations.UploadBankStatementDataRequest, operations.UploadBankStatementDataRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ):
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.UploadBankStatementDataRequest)
        ...
        req = self.build_request(
            ...
            accept_header_value="application/json",
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(request.request_body, False, False, "json", operations.UploadBankStatementDataRequestBody),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="upload-bank-statement-data", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
