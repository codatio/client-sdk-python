...
class CreateOperations(BaseSDK):
    
    
    def get(
        self, *,
        request: Union[operations.GetCreateOperationRequest, operations.GetCreateOperationRequestTypedDict],
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-create-operation", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def list(
        self, *,
        request: Union[operations.ListCreateOperationsRequest, operations.ListCreateOperationsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-create-operations", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
