...
class BankTransactions(BaseSDK):
    ...
    def create(
        self, *,
        request: Union[operations.CreateBankTransactionsRequest, operations.CreateBankTransactionsRequestTypedDict],
        ...
        **Integration-specific behaviour**
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.accounting_create_bank_transactions, False, True, "json", Optional[shared.AccountingCreateBankTransactions]),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="create-bank-transactions", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreateBankTransactionsResponse])
    ...
    def get_create_model(
        self, *,
        request: Union[operations.GetCreateBankTransactionsModelRequest, operations.GetCreateBankTransactionsModelRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreateBankTransactionsModelRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-create-bank-transactions-model", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
