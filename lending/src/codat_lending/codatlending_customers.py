...
class CodatLendingCustomers(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetCommerceCustomerRequest, operations.GetCommerceCustomerRequestTypedDict],
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-customer", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceCustomer])
    ...
    def list(
        self, *,
        request: Union[operations.ListCommerceCustomersRequest, operations.ListCommerceCustomersRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-commerce-customers", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceCustomers])
