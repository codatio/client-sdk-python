    ...
    def get(
        ...
        *,
        request: Union[
            ...
            operations.GetAccountingPaymentRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingPayment, http_res)
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListAccountingPaymentsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingPayments, http_res)
        if utils.match_response(
            http_res,
