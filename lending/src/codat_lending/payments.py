...
class Payments(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingPaymentRequest, operations.GetAccountingPaymentRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingPayment]:
        r"""Get payment
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingPaymentRequest)
        request = cast(operations.GetAccountingPaymentRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-payment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingPayment])
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingPaymentsRequest, operations.ListAccountingPaymentsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingPayments]:
        r"""List payments
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingPaymentsRequest)
        request = cast(operations.ListAccountingPaymentsRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-payments", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingPayments])
