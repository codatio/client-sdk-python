...
class CodatLendingReports(BaseSDK):
    ...
    def get_orders(
        self, *,
        request: Union[operations.GetCommerceOrdersReportRequest, operations.GetCommerceOrdersReportRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCommerceOrdersReportRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-orders-report", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def get_refunds(
        self, *,
        request: Union[operations.GetCommerceRefundsReportRequest, operations.GetCommerceRefundsReportRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceReport]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCommerceRefundsReportRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-refunds-report", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
