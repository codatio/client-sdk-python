...
class AccountBalances(BaseSDK):
    
    
    def list(
        self, *,
        request: Union[operations.ListBankingAccountBalancesRequest, operations.ListBankingAccountBalancesRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.BankingAccountBalances]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListBankingAccountBalancesRequest)
        request = cast(operations.ListBankingAccountBalancesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-banking-account-balances", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.BankingAccountBalances])
