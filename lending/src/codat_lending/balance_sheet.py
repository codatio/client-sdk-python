...
class BalanceSheet(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingBalanceSheetRequest, operations.GetAccountingBalanceSheetRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingBalanceSheetRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-balance-sheet", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBalanceSheet])
    ...
    def get_categorized_accounts(
        self, *,
        request: Union[operations.GetCategorizedBalanceSheetStatementRequest, operations.GetCategorizedBalanceSheetStatementRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCategorizedBalanceSheetStatementRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-categorized-balance-sheet-statement", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
