...
class CommerceTaxComponent(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="Name of the Tax Rate Component in the source commerce software.")
    rate: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Rate of taxation represented as a fraction of the net price (typically in the range 0.00 - 1.00).")
    is_compound: Optional[bool] = Field(default=None, description="The Boolean flag to indicate when a Tax Rate Component compounds on a sale.", alias="isCompound")
    __properties: ClassVar[List[str]] = ["id", "modifiedDate", "sourceModifiedDate", "name", "rate", "isCompound"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceTaxComponent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceTaxComponent from a dict"""
        if obj is None:
            return None
...
class CommerceTaxComponentTypedDict(TypedDict):
    """TypedDict variant of CommerceTaxComponent, for dict-literal request/response inputs."""
    id: NotRequired[str]
    modified_date: NotRequired[Optional[str]]
    source_modified_date: NotRequired[Optional[str]]
    name: NotRequired[Optional[str]]
    rate: NotRequired[Optional[Decimal]]
    is_compound: NotRequired[Optional[bool]]
