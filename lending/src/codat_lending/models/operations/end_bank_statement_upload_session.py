...
from codat_lending.models.shared import enduploadsessionrequest as shared_enduploadsessionrequest
...
class EndBankStatementUploadSessionRequestTypedDict(TypedDict):
    ...
    end_upload_session_request: NotRequired[shared_enduploadsessionrequest.EndUploadSessionRequestTypedDict]
...
class EndBankStatementUploadSessionRequest(BaseModel):
    ...
    r"""Unique identifier for the dataset that completed its sync."""
    end_upload_session_request: Annotated[Optional[shared_enduploadsessionrequest.EndUploadSessionRequest], FieldMetadata(request=RequestMetadata(media_type="application/json"))] = None
