...
class CreatePaymentRequestTypedDict(TypedDict):
    ...
    accounting_payment: NotRequired[Nullable[shared_accountingpayment.AccountingPaymentTypedDict]]
...
class CreatePaymentRequest(BaseModel):
    ...
    r"""Unique identifier for a connection."""
    accounting_payment: Annotated[OptionalNullable[shared_accountingpayment.AccountingPayment], FieldMetadata(request=RequestMetadata(media_type="application/json"))] = UNSET
    ...
    def serialize_model(self, handler):
        optional_fields = ["AccountingPayment", "allowSyncOnPushComplete", "timeoutInMinutes"]
