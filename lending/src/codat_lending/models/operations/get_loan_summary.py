...
class GetLoanSummaryRequest(BaseModel):
    ...
    r"""Unique identifier for a company."""
    source_type: Annotated[GetLoanSummaryQueryParamSourceType, pydantic.Field(alias="sourceType"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    r"""Data source type."""
