...
from codat_lending.models.shared import accountingcreatebanktransactions as shared_accountingcreatebanktransactions
...
class CreateBankTransactionsRequestTypedDict(TypedDict):
    ...
    accounting_create_bank_transactions: NotRequired[shared_accountingcreatebanktransactions.AccountingCreateBankTransactionsTypedDict]
...
class CreateBankTransactionsRequest(BaseModel):
    account_id: Annotated[str, pydantic.Field(alias="accountId"), FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
    r"""Unique identifier for an account."""
    ...
    r"""Unique identifier for a connection."""
    accounting_create_bank_transactions: Annotated[Optional[shared_accountingcreatebanktransactions.AccountingCreateBankTransactions], FieldMetadata(request=RequestMetadata(media_type="application/json"))] = None
