...
from codat_lending.models.shared import dataintegritydatatype as shared_dataintegritydatatype
...
class ListDataIntegrityDetailsRequest(BaseModel):
    ...
    r"""Unique identifier for a company."""
    data_type: Annotated[shared_dataintegritydatatype.DataIntegrityDataType, pydantic.Field(alias="dataType"), FieldMetadata(path=PathParamMetadata(style="simple", explode=False))]
    r"""A key for a Codat data type."""
