...
from codat_lending.models.shared import (
    accountingbankaccount as shared_accountingbankaccount,
)
...
class CreateBankAccountRequestTypedDict(TypedDict):
    ...
    accounting_bank_account: NotRequired[
        Nullable[shared_accountingbankaccount.AccountingBankAccountTypedDict]
    ]
...
class CreateBankAccountRequest(BaseModel):
    ...
    accounting_bank_account: Annotated[
        OptionalNullable[shared_accountingbankaccount.AccountingBankAccount],
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["AccountingBankAccount", "allowSyncOnPushComplete", "timeoutInMinutes"]
        )
        nullable_fields = set(["AccountingBankAccount"])
