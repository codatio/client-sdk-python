...
from codat_lending.models.shared import accountingbankaccount as shared_accountingbankaccount
...
class CreateBankAccountRequestTypedDict(TypedDict):
    ...
    accounting_bank_account: NotRequired[Nullable[shared_accountingbankaccount.AccountingBankAccountTypedDict]]
...
class CreateBankAccountRequest(BaseModel):
    ...
    r"""Unique identifier for a connection."""
    accounting_bank_account: Annotated[OptionalNullable[shared_accountingbankaccount.AccountingBankAccount], FieldMetadata(request=RequestMetadata(media_type="application/json"))] = UNSET
    ...
    def serialize_model(self, handler):
        optional_fields = ["AccountingBankAccount", "allowSyncOnPushComplete", "timeoutInMinutes"]
        nullable_fields = ["AccountingBankAccount"]
        null_default_fields = []
