...
class GetAccountingCashFlowStatementRequest(BaseModel):
    ...
    r"""Number of months defining the period of interest."""
    periods_to_compare: Annotated[int, pydantic.Field(alias="periodsToCompare"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))]
    r"""Number of periods with `periodLength` to compare."""
    start_month: Annotated[Optional[str], pydantic.Field(alias="startMonth"), FieldMetadata(query=QueryParamMetadata(style="form", explode=True))] = None
    r"""The month the report starts from."""
