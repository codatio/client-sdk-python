...
from codat_lending.models.shared import accountingtransfer as shared_accountingtransfer
...
class CreateTransferRequestTypedDict(TypedDict):
    ...
    accounting_transfer: NotRequired[Nullable[shared_accountingtransfer.AccountingTransferTypedDict]]
...
class CreateTransferRequest(BaseModel):
    ...
    r"""Unique identifier for a connection."""
    accounting_transfer: Annotated[OptionalNullable[shared_accountingtransfer.AccountingTransfer], FieldMetadata(request=RequestMetadata(media_type="application/json"))] = UNSET
    ...
    def serialize_model(self, handler):
        optional_fields = ["AccountingTransfer", "allowSyncOnPushComplete", "timeoutInMinutes"]
        nullable_fields = ["AccountingTransfer"]
        null_default_fields = []
