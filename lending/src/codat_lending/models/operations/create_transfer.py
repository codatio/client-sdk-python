...
class CreateTransferRequestTypedDict(TypedDict):
    ...
    accounting_transfer: NotRequired[
        Nullable[shared_accountingtransfer.AccountingTransferTypedDict]
    ]
...
class CreateTransferRequest(BaseModel):
    ...
    accounting_transfer: Annotated[
        OptionalNullable[shared_accountingtransfer.AccountingTransfer],
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["AccountingTransfer", "allowSyncOnPushComplete", "timeoutInMinutes"]
        )
        nullable_fields = set(["AccountingTransfer"])
