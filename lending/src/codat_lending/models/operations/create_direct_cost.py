...
from codat_lending.models.shared import directcostprototype as shared_directcostprototype
...
class CreateDirectCostRequestTypedDict(TypedDict):
    ...
    direct_cost_prototype: NotRequired[shared_directcostprototype.DirectCostPrototypeTypedDict]
...
class CreateDirectCostRequest(BaseModel):
    ...
    r"""Allow a sync upon push completion."""
    direct_cost_prototype: Annotated[Optional[shared_directcostprototype.DirectCostPrototype], FieldMetadata(request=RequestMetadata(media_type="application/json"))] = None
