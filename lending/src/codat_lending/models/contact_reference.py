...
from codat_lending.models._compat.journalline import JournalLineDataType
...
class ContactReference(BaseModel):
    ...
    data_type: OptionalNullable[JournalLineDataType] = Field(default=UNSET, description="Allowed name of the 'dataType'.", alias="dataType")
...
class ContactReferenceTypedDict(TypedDict):
    """TypedDict variant of ContactReference, for dict-literal request/response inputs."""
    id: NotRequired[str]
    data_type: NotRequired[Optional[JournalLineDataType]]
