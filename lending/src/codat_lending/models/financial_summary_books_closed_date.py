...
class FinancialSummaryBooksClosedDate(BaseModel):
    ...
    """ # noqa: E501
    date_: Optional[str] = Field(default=None, description="The date time in UTC the books closed.", alias="date")
    reason: Optional[List[str]] = Field(default=None, description="List of reasons explaining the books closed date.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinancialSummaryBooksClosedDate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinancialSummaryBooksClosedDate from a dict"""
        if obj is None:
            return None
...
class FinancialSummaryBooksClosedDateTypedDict(TypedDict):
    """TypedDict variant of FinancialSummaryBooksClosedDate, for dict-literal request/response inputs."""
