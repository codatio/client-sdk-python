...
from codat_lending.models.shared import errorvalidation as shared_errorvalidation
...
class ErrorMessageData(BaseModel):
    can_be_retried: Annotated[Optional[str], pydantic.Field(alias="canBeRetried")] = None
    r"""`True` if the error occurred transiently and can be retried."""
    correlation_id: Annotated[Optional[str], pydantic.Field(alias="correlationId")] = None
    r"""Unique identifier used to propagate to all downstream services and determine the source of the error."""
    detailed_error_code: Annotated[Optional[int], pydantic.Field(alias="detailedErrorCode")] = None
