...
class ReportSourceReference(BaseModel):
    ...
    """ # noqa: E501
    source_type: Optional[str] = Field(default=None, description="The data source type.", alias="sourceType")
    __properties: ClassVar[List[str]] = ["sourceType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportSourceReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportSourceReference from a dict"""
        if obj is None:
            return None
...
class ReportSourceReferenceTypedDict(TypedDict):
    """TypedDict variant of ReportSourceReference, for dict-literal request/response inputs."""
