...
class AccountingPaymentAllocationAllocation(BaseModel):
    ...
    total_amount: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The total amount that has been allocated.", alias="totalAmount")
    __properties: ClassVar[List[str]] = ["currency", "currencyRate", "allocatedOnDate", "totalAmount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingPaymentAllocationAllocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingPaymentAllocationAllocation from a dict"""
        if obj is None:
            return None
...
class AccountingPaymentAllocationAllocationTypedDict(TypedDict):
    """TypedDict variant of AccountingPaymentAllocationAllocation, for dict-literal request/response inputs."""
