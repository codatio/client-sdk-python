...
class AccountTransactionLineRecordRef(BaseModel):
    ...
    data_type: Optional[AccountTransactionLineRecordRefDataType] = Field(default=None, description="Name of underlying data type.", alias="dataType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountTransactionLineRecordRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountTransactionLineRecordRef from a dict"""
        if obj is None:
            return None
...
class AccountTransactionLineRecordRefTypedDict(TypedDict):
    """TypedDict variant of AccountTransactionLineRecordRef, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    data_type: NotRequired[Optional[AccountTransactionLineRecordRefDataType]]
