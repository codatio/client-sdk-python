...
class Account(BaseModel):
    ...
    Account
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="The ID of the account from the provider.")
    ...
    identifiers: Optional[AccountIdentifiers] = None
    __properties: ClassVar[List[str]] = ["id", "sourceRef", "platformName", "accountProvider", "accountName", "accountType", "currency", "currentBalance", "identifiers"]
...
class AccountTypedDict(TypedDict):
    ...
    identifiers: NotRequired[Optional[AccountIdentifiersTypedDict]]
