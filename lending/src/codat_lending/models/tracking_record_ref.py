...
from codat_lending.models._compat.trackingrecordref import TrackingRecordRefDataType
class TrackingRecordRef(BaseModel):
    ...
    data_type: Optional[TrackingRecordRefDataType] = Field(default=None, description="Name of underlying data type.", alias="dataType")
    ...
    def data_type_validate_enum(cls, value):
        ...
        if value not in set(['customers', 'suppliers', 'trackingCategories']):
            raise ValueError("must be one of enum values ('customers', 'suppliers', 'trackingCategories')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingRecordRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingRecordRef from a dict"""
        if obj is None:
            return None
...
class TrackingRecordRefTypedDict(TypedDict):
    """TypedDict variant of TrackingRecordRef, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    data_type: NotRequired[Optional[TrackingRecordRefDataType]]
