...
class PurchaseOrderReference(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Identifier for the purchase order, unique for the company in the accounting software.")
    purchase_order_number: OptionalNullable[str] = Field(default=UNSET, description="Friendly reference for the purchase order, commonly generated by the accounting software.", alias="purchaseOrderNumber")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "purchaseOrderNumber"]
...
class PurchaseOrderReferenceTypedDict(TypedDict):
    """TypedDict variant of PurchaseOrderReference, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    purchase_order_number: NotRequired[Optional[str]]
