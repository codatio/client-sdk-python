...
class ProjectRef(BaseModel):
    ...
    ProjectRef
    """ # noqa: E501
    id: str = Field(description="Unique identifier to the project reference.")
    name: OptionalNullable[str] = Field(default=UNSET, description="The project's name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectRef from a dict"""
        if obj is None:
            return None
...
class ProjectRefTypedDict(TypedDict):
    """TypedDict variant of ProjectRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
