...
class DataIntegrityConnectionId(BaseModel):
    ...
    """ # noqa: E501
    source: Optional[List[str]] = Field(default=None, description="An array of strings. The connection IDs for the type specified in the url.")
    target: Optional[List[str]] = Field(default=None, description="An array of strings. The connection IDs for the type being matched to.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataIntegrityConnectionId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataIntegrityConnectionId from a dict"""
        if obj is None:
            return None
...
class DataIntegrityConnectionIdTypedDict(TypedDict):
    """TypedDict variant of DataIntegrityConnectionId, for dict-literal request/response inputs."""
    source: NotRequired[Optional[List[str]]]
    target: NotRequired[Optional[List[str]]]
