...
class LocationRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique identitifer of the location being referenced.")
...
class LocationRefTypedDict(TypedDict):
    """TypedDict variant of LocationRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
