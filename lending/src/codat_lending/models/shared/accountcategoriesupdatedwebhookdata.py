...
class AccountCategoriesUpdatedWebhookData(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'modifiedDate', 'modified_date'}
        return {
    ...
    """ # noqa: E501
    modified_date: OptionalNullable[str] = Field(default=UNSET, description="In Codat's data model, dates are represented using the <a class=\"external\" href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601 standard</a>. Date fields are formatted as strings; for example: ``` 2020-10-08 ```", alias="modifiedDate")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountCategoriesUpdatedWebhookData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountCategoriesUpdatedWebhookData from a dict"""
        if obj is None:
            return None
...
class AccountCategoriesUpdatedWebhookDataTypedDict(TypedDict):
    """TypedDict variant of AccountCategoriesUpdatedWebhookData, for dict-literal request/response inputs."""
