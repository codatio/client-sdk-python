...
class LoanRef(BaseModel):
    ...
    type: Optional[str] = Field(default=None, description="The object type data is referring to, e.g. Account.")
    __properties: ClassVar[List[str]] = ["id", "dataConnectionId", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoanRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoanRef from a dict"""
        if obj is None:
            return None
...
class LoanRefTypedDict(TypedDict):
    """TypedDict variant of LoanRef, for dict-literal request/response inputs."""
