...
class AccountingTransfers(BaseModel):
    ...
    results: Optional[List[Nullable[AccountingTransfer]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingTransfers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingTransfers from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [AccountingTransfer.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
...
class AccountingTransfersTypedDict(TypedDict):
    """TypedDict variant of AccountingTransfers, for dict-literal request/response inputs."""
