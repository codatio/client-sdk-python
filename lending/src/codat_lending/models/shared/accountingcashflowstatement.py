...
class AccountingCashFlowStatement(BaseModel):
    ...
    """ # noqa: E501
    reports: List[CashFlowStatement] = Field(description="Array of cash flow statements.")
    report_basis: ReportBasis = Field(alias="reportBasis")
    report_input: ReportInput = Field(alias="reportInput")
    ...
    __properties: ClassVar[List[str]] = ["reports", "reportBasis", "reportInput", "currency", "mostRecentAvailableMonth", "earliestAvailableMonth"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingCashFlowStatement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingCashFlowStatement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reports": [CashFlowStatement.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
            "reportBasis": obj.get("reportBasis"),
            "reportInput": obj.get("reportInput"),
...
class AccountingCashFlowStatementTypedDict(TypedDict):
    """TypedDict variant of AccountingCashFlowStatement, for dict-literal request/response inputs."""
    reports: NotRequired[List[CashFlowStatementTypedDict]]
    report_basis: NotRequired[ReportBasis]
    report_input: NotRequired[ReportInput]
