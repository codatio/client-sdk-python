...
class BillPaymentLine(BaseModel):
    ...
    BillPaymentLine
    """ # noqa: E501
    amount: Annotated[Decimal, BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(description="Amount in the bill payment currency.")
    ...
    __properties: ClassVar[List[str]] = ["amount", "links", "allocatedOnDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BillPaymentLine from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BillPaymentLine from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "links": [BillPaymentLineLink.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
...
class BillPaymentLineTypedDict(TypedDict):
    """TypedDict variant of BillPaymentLine, for dict-literal request/response inputs."""
    amount: NotRequired[Decimal]
    links: NotRequired[Optional[List[BillPaymentLineLinkTypedDict]]]
