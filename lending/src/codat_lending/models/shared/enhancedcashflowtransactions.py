...
class EnhancedCashFlowTransactions(BaseModel):
    ...
    """ # noqa: E501
    report_info: Optional[ReportInfo] = Field(default=None, alias="reportInfo")
    data_sources: Optional[List[DataSource]] = Field(default=None, alias="dataSources")
    report_items: Optional[List[EnhancedCashFlowItem]] = Field(default=None, alias="reportItems")
    __properties: ClassVar[List[str]] = ["reportInfo", "dataSources", "reportItems"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnhancedCashFlowTransactions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnhancedCashFlowTransactions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reportInfo": ReportInfo.from_dict(obj["reportInfo"]) if obj.get("reportInfo") is not None else None,
            "dataSources": [DataSource.from_dict(_item) for _item in obj["dataSources"]] if obj.get("dataSources") is not None else None,
            "reportItems": [EnhancedCashFlowItem.from_dict(_item) for _item in obj["reportItems"]] if obj.get("reportItems") is not None else None
        })
        return _obj
...
class EnhancedCashFlowTransactionsTypedDict(TypedDict):
    """TypedDict variant of EnhancedCashFlowTransactions, for dict-literal request/response inputs."""
    report_info: NotRequired[Optional[ReportInfoTypedDict]]
    data_sources: NotRequired[Optional[List[DataSourceTypedDict]]]
    report_items: NotRequired[Optional[List[EnhancedCashFlowItemTypedDict]]]
