...
class BankingTransactionRef(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier for the bank transaction.")
    data_connection_id: Optional[str] = Field(default=None, description="Unique identifier of the bank transaction's connection.", alias="dataConnectionId")
    account_id: Optional[str] = Field(default=None, description="Unique identifier of the bank transaction's account.", alias="accountId")
    ...
    description: Optional[str] = Field(default=None, description="Description given to bank transaction.")
    amount: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Bank transaction amount.")
    __properties: ClassVar[List[str]] = ["id", "dataConnectionId", "accountId", "accountName", "date", "description", "amount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankingTransactionRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankingTransactionRef from a dict"""
        if obj is None:
            return None
...
class BankingTransactionRefTypedDict(TypedDict):
    """TypedDict variant of BankingTransactionRef, for dict-literal request/response inputs."""
