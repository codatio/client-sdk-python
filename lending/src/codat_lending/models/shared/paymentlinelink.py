...
class PaymentLineLink(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'amount', 'currencyRate', 'currency_rate'}
        return {
    ...
    id: Optional[str] = Field(default=None, description="Unique identifier of the transaction represented by the link.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentLineLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentLineLink from a dict"""
        if obj is None:
            return None
...
class PaymentLineLinkTypedDict(TypedDict):
    """TypedDict variant of PaymentLineLink, for dict-literal request/response inputs."""
    type: PaymentLinkType
