...
class RecordLineReference(BaseModel):
    ...
    data_type: Annotated[Optional[BillLineItemDataType], pydantic.Field(alias="dataType")] = None
    r"""Allowed name of the 'dataType'."""
...
class BillLineItem(BaseModel):
    ...
    r"""Percentage rate of any discount applied to the bill."""
    is_direct_cost: Annotated[Optional[bool], pydantic.Field(alias="isDirectCost")] = None
    r"""The bill is a direct cost if `True`."""
    item_ref: Annotated[Optional[PropertieItemRef], pydantic.Field(alias="itemRef")] = None
    r"""Reference to the item the line is linked to."""
    line_number: Annotated[OptionalNullable[str], pydantic.Field(alias="lineNumber")] = UNSET
    r"""The bill line's number."""
    purchase_order_line_ref: Annotated[Optional[RecordLineReference], pydantic.Field(alias="purchaseOrderLineRef")] = None
    ...
    def serialize_model(self, handler):
        optional_fields = ["accountRef", "description", "discountAmount", "discountPercentage", "isDirectCost", "itemRef", "lineNumber", "purchaseOrderLineRef", "subTotal", "taxAmount", "taxRateRef", "totalAmount", "tracking", "trackingCategoryRefs", "unitOfMeasurement"]
        nullable_fields = ["description", "discountAmount", "discountPercentage", "lineNumber", "subTotal", "taxAmount", "totalAmount", "trackingCategoryRefs", "unitOfMeasurement"]
        null_default_fields = []
