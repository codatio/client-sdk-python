...
class CommerceReportError(BaseModel):
    ...
    CommerceReportError
    """ # noqa: E501
    message: Optional[str] = Field(default=None, description="Message returned by error.")
    type: Optional[str] = Field(default=None, description="The type of error.")
    details: Optional[Dict[str, List[str]]] = Field(default=None, description="Additional details on the error.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceReportError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceReportError from a dict"""
        if obj is None:
            return None
...
class CommerceReportErrorTypedDict(TypedDict):
    """TypedDict variant of CommerceReportError, for dict-literal request/response inputs."""
    message: NotRequired[Optional[str]]
    type: NotRequired[Optional[str]]
    details: NotRequired[Optional[Dict[str, List[str]]]]
