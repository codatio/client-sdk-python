...
from .accounttransactionlinerecordref import AccountTransactionLineRecordRef, AccountTransactionLineRecordRefTypedDict
...
class AccountTransactionLine(BaseModel):
    ...
    r"""Description of the account transaction."""
    record_ref: Annotated[Optional[AccountTransactionLineRecordRef], pydantic.Field(alias="recordRef")] = None
    r"""Links an account transaction line to the underlying record that created it."""
