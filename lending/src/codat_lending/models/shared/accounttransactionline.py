...
class AccountTransactionLine(BaseModel):
    ...
    """ # noqa: E501
    description: OptionalNullable[str] = Field(default=UNSET, description="Description of the account transaction.")
    record_ref: Optional[AccountTransactionLineRecordRef] = Field(default=None, alias="recordRef")
    amount: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Amount in the bill payment currency.")
    __properties: ClassVar[List[str]] = ["description", "recordRef", "amount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountTransactionLine from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountTransactionLine from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "recordRef": AccountTransactionLineRecordRef.from_dict(obj["recordRef"]) if obj.get("recordRef") is not None else None,
...
class AccountTransactionLineTypedDict(TypedDict):
    """TypedDict variant of AccountTransactionLine, for dict-literal request/response inputs."""
    description: NotRequired[Optional[str]]
    record_ref: NotRequired[Optional[AccountTransactionLineRecordRefTypedDict]]
