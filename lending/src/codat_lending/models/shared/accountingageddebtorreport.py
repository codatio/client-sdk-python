...
class AccountingAgedDebtorReport(BaseModel):
    ...
    data: Optional[List[AgedDebtor]] = Field(default=None, description="Array of aged debtors.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingAgedDebtorReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingAgedDebtorReport from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [AgedDebtor.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
...
class AccountingAgedDebtorReportTypedDict(TypedDict):
    """TypedDict variant of AccountingAgedDebtorReport, for dict-literal request/response inputs."""
    generated: NotRequired[Optional[str]]
    report_date: NotRequired[Optional[str]]
    data: NotRequired[Optional[List[AgedDebtorTypedDict]]]
