...
from .accountingbill import AccountingBill, AccountingBillTypedDict
...
class AccountingBillsTypedDict(TypedDict):
    ...
    results: NotRequired[List[Nullable[AccountingBillTypedDict]]]
