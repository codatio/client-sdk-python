...
class AccountingPaymentAllocation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payment", "allocation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingPaymentAllocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingPaymentAllocation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "payment": PaymentAllocationPayment.from_dict(obj["payment"]) if obj.get("payment") is not None else None,
            "allocation": AccountingPaymentAllocationAllocation.from_dict(obj["allocation"]) if obj.get("allocation") is not None else None
        })
        return _obj
...
class AccountingPaymentAllocationTypedDict(TypedDict):
    """TypedDict variant of AccountingPaymentAllocation, for dict-literal request/response inputs."""
    payment: PaymentAllocationPaymentTypedDict
    allocation: AccountingPaymentAllocationAllocationTypedDict
