...
class CommerceReportComponent(BaseModel):
    ...
    """ # noqa: E501
    dimension: Optional[int] = Field(default=None, description="The component's dimension.")
    dimension_display_name: Optional[str] = Field(default=None, description="The component's display name.", alias="dimensionDisplayName")
    item: Optional[int] = Field(default=None, description="The component's item number.")
    item_display_name: Optional[str] = Field(default=None, description="The component's item display name.", alias="itemDisplayName")
    measures: Optional[List[ReportComponentMeasure]] = None
    components: Optional[List[CommerceReportComponent]] = None
    __properties: ClassVar[List[str]] = ["dimension", "dimensionDisplayName", "item", "itemDisplayName", "measures", "components"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceReportComponent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceReportComponent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dimensionDisplayName": obj.get("dimensionDisplayName"),
            "item": obj.get("item"),
            "itemDisplayName": obj.get("itemDisplayName"),
            "measures": [ReportComponentMeasure.from_dict(_item) for _item in obj["measures"]] if obj.get("measures") is not None else None,
            "components": [CommerceReportComponent.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
CommerceReportComponent.model_rebuild(raise_errors=False)




class CommerceReportComponentTypedDict(TypedDict):
    """TypedDict variant of CommerceReportComponent, for dict-literal request/response inputs."""
    dimension: NotRequired[Optional[int]]
    dimension_display_name: NotRequired[Optional[str]]
    item: NotRequired[Optional[int]]
    item_display_name: NotRequired[Optional[str]]
    measures: NotRequired[Optional[List[ReportComponentMeasureTypedDict]]]
    components: NotRequired[Optional[List[CommerceReportComponentTypedDict]]]
