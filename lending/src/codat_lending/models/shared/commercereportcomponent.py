...
class CommerceReportComponent(BaseModel):
    ...
    r"""The component's dimension."""
    dimension_display_name: Annotated[Optional[str], pydantic.Field(alias="dimensionDisplayName")] = None
    r"""The component's display name."""
    item: Optional[int] = None
    r"""The component's item number."""
    item_display_name: Annotated[Optional[str], pydantic.Field(alias="itemDisplayName")] = None
    r"""The component's item display name."""
