...
class LoanSummaryReportInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["reportName", "companyName", "generatedDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoanSummaryReportInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoanSummaryReportInfo from a dict"""
        if obj is None:
            return None
...
class LoanSummaryReportInfoTypedDict(TypedDict):
    """TypedDict variant of LoanSummaryReportInfo, for dict-literal request/response inputs."""
