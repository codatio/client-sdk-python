...
class DirectCostPrototype(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["reference", "note", "contactRef", "issueDate", "currency", "currencyRate", "lineItems", "paymentAllocations", "subTotal", "taxAmount", "totalAmount", "supplementalData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DirectCostPrototype from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DirectCostPrototype from a dict"""
        if obj is None:
            return None
...
class DirectCostPrototypeTypedDict(TypedDict):
    """TypedDict variant of DirectCostPrototype, for dict-literal request/response inputs."""
