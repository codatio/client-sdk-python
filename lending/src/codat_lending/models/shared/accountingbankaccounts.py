...
class AccountingBankAccounts(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingBankAccounts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingBankAccounts from a dict"""
        if obj is None:
            return None
...
class AccountingBankAccountsTypedDict(TypedDict):
    """TypedDict variant of AccountingBankAccounts, for dict-literal request/response inputs."""
