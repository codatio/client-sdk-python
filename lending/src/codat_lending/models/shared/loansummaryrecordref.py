...
class LoanSummaryRecordRef(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="The id of the object being referred to.")
    data_connection_id: Optional[str] = Field(default=None, description="The dataConnectionId the object being referred to is associated with.", alias="dataConnectionId")
    integration_type: Optional[LoanSummaryIntegrationType] = Field(default=None, alias="integrationType")
    record_ref_type: Optional[LoanSummaryRecordRefType] = Field(default=None, alias="recordRefType")
    __properties: ClassVar[List[str]] = ["id", "dataConnectionId", "integrationType", "recordRefType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoanSummaryRecordRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoanSummaryRecordRef from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "recordRefType": obj.get("recordRefType")
        })
        return _obj
...
class LoanSummaryRecordRefTypedDict(TypedDict):
    """TypedDict variant of LoanSummaryRecordRef, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    data_connection_id: NotRequired[Optional[str]]
    integration_type: NotRequired[Optional[LoanSummaryIntegrationType]]
    record_ref_type: NotRequired[Optional[LoanSummaryRecordRefType]]
