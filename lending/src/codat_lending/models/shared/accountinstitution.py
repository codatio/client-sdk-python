...
class AccountInstitution(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="The institution's ID, according to the provider.")
    name: Optional[str] = Field(default=None, description="The institution's name, according to the underlying provider.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountInstitution from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountInstitution from a dict"""
        if obj is None:
            return None
...
class AccountInstitutionTypedDict(TypedDict):
    """TypedDict variant of AccountInstitution, for dict-literal request/response inputs."""
