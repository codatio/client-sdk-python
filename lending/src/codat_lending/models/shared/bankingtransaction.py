...
class BankingTransaction(BaseModel):
    ...
    r"""The amount of the bank transaction."""
    authorized_date: Annotated[Optional[str], pydantic.Field(alias="authorizedDate")] = None
    r"""In Codat's data model, dates and times are represented using the <a class=\"external\" href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
    ...
    r"""The description of the bank transaction."""
    merchant_name: Annotated[OptionalNullable[str], pydantic.Field(alias="merchantName")] = UNSET
    r"""The name of the merchant."""
    ...
    transaction_category_ref: Annotated[Optional[TransactionCategoryRef], pydantic.Field(alias="transactionCategoryRef")] = None
    r"""An object of bank transaction category reference data."""
    
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["amount", "authorizedDate", "code", "description", "merchantName", "modifiedDate", "postedDate", "sourceModifiedDate", "transactionCategoryRef"]
