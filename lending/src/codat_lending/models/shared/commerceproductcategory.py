...
class CommerceProductCategory(BaseModel):
    ...
    id: Optional[str] = Field(default=None, description="The unique identifier of the product category")
    name: Optional[str] = Field(default=None, description="The name of the product category")
    ancestor_refs: Optional[List[CommerceRecordRef]] = Field(default=None, description="A collection of parent product categories implicitly ordered with the immediate parent last in the list.", alias="ancestorRefs")
    has_children: Optional[bool] = Field(default=None, description="A boolean indicating whether there are other product categories beneath this one in the hierarchy.", alias="hasChildren")
    __properties: ClassVar[List[str]] = ["modifiedDate", "sourceModifiedDate", "id", "name", "ancestorRefs", "hasChildren"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceProductCategory from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in ancestor_refs (list)
        _items = []
        if self.ancestor_refs:
            for _item_ancestor_refs in self.ancestor_refs:
                if _item_ancestor_refs:
                    _items.append(_item_ancestor_refs.to_dict())
            _dict['ancestorRefs'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceProductCategory from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "ancestorRefs": [CommerceRecordRef.from_dict(_item) for _item in obj["ancestorRefs"]] if obj.get("ancestorRefs") is not None else None,
...
class CommerceProductCategoryTypedDict(TypedDict):
    """TypedDict variant of CommerceProductCategory, for dict-literal request/response inputs."""
    modified_date: NotRequired[Optional[str]]
    source_modified_date: NotRequired[Optional[str]]
    id: NotRequired[Optional[str]]
    name: NotRequired[Optional[str]]
    ancestor_refs: NotRequired[Optional[List[CommerceRecordRefTypedDict]]]
