...
class EnhancedInvoicesReport(BaseModel):
    ...
    report_items: Optional[List[Nullable[EnhancedInvoiceReportItem]]] = Field(default=None, alias="reportItems")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnhancedInvoicesReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnhancedInvoicesReport from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "reportItems": [EnhancedInvoiceReportItem.from_dict(_item) for _item in obj["reportItems"]] if obj.get("reportItems") is not None else None
        })
        return _obj
...
class EnhancedInvoicesReportTypedDict(TypedDict):
    """TypedDict variant of EnhancedInvoicesReport, for dict-literal request/response inputs."""
    report_info: NotRequired[Optional[ReportInfoTypedDict]]
    report_items: NotRequired[Optional[List[Nullable[EnhancedInvoiceReportItemTypedDict]]]]
