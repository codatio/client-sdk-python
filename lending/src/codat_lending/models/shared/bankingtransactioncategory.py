...
class BankingTransactionCategory(BaseModel):
    ...
    id: str = Field(description="The unique identifier of the bank transaction category.")
    name: str = Field(description="The name of the bank transaction category.")
    parent_id: OptionalNullable[str] = Field(default=UNSET, description="The unique identifier of the parent bank transaction category.", alias="parentId")
    has_children: Optional[bool] = Field(default=None, description="A Boolean indicating whether there are other bank transaction categories beneath this one in the hierarchy.", alias="hasChildren")
    status: Optional[TransactionCategoryStatus] = None
    __properties: ClassVar[List[str]] = ["modifiedDate", "sourceModifiedDate", "id", "name", "parentId", "hasChildren", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankingTransactionCategory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankingTransactionCategory from a dict"""
        if obj is None:
            return None
...
class BankingTransactionCategoryTypedDict(TypedDict):
    """TypedDict variant of BankingTransactionCategory, for dict-literal request/response inputs."""
    ...
    status: NotRequired[Optional[TransactionCategoryStatus]]
