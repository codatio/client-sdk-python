...
class AccountCategoryLevel(BaseModel):
    ...
    """ # noqa: E501
    level_name: Optional[str] = Field(default=None, description="Account category name.", alias="levelName")
    confidence: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Confidence level of the category. This will only be populated where `status` is `Suggested`.")
    __properties: ClassVar[List[str]] = ["levelName", "confidence"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountCategoryLevel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountCategoryLevel from a dict"""
        if obj is None:
            return None
...
class AccountCategoryLevelTypedDict(TypedDict):
    ...
    level_name: NotRequired[Optional[str]]
