...
class ReportInfo(BaseModel):
    ...
    """ # noqa: E501
    page_number: Optional[int] = Field(default=None, description="The number of the page queried.", alias="pageNumber")
    page_size: Optional[int] = Field(default=None, description="The number of transactions returned per page.", alias="pageSize")
    total_results: Optional[int] = Field(default=None, description="The total number of transactions available for a company for the period specified in the query string.", alias="totalResults")
    report_name: Optional[str] = Field(default=None, description="Name of the report.", alias="reportName")
    company_name: Optional[str] = Field(default=None, description="The name of the company being queried.", alias="companyName")
    generated_date: Optional[str] = Field(default=None, description="Date the report was generated.", alias="generatedDate")
...
class ReportInfoTypedDict(TypedDict):
    """TypedDict variant of ReportInfo, for dict-literal request/response inputs."""
