...
class BankingTransactions(BaseModel):
    ...
    results: Optional[List[Nullable[BankingTransaction]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankingTransactions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankingTransactions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [BankingTransaction.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
...
class BankingTransactionsTypedDict(TypedDict):
    """TypedDict variant of BankingTransactions, for dict-literal request/response inputs."""
