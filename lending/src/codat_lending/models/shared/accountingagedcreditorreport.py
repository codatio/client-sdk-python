...
class AccountingAgedCreditorReportTypedDict(TypedDict):
    ...
    data: NotRequired[List[AgedCreditorTypedDict]]
...
class AccountingAgedCreditorReport(BaseModel):
    ...
    data: Optional[List[AgedCreditor]] = None
    r"""Array of aged creditor."""
    ...
    def serialize_model(self, handler):
        optional_fields = set(["data", "generated", "reportDate"])
...
try:
    AccountingAgedCreditorReport.model_rebuild()
except NameError:
    pass
