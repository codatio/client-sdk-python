...
class JournalRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="GUID of the underlying journal.")
    name: OptionalNullable[str] = Field(default=UNSET, description="Name of journal")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JournalRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JournalRef from a dict"""
        if obj is None:
            return None
...
class JournalRefTypedDict(TypedDict):
    """TypedDict variant of JournalRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
