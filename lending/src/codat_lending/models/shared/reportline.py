...
class ReportLine(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'accountId', 'account_id', 'items', 'name'}
        return {
    ...
    ReportLine
    """ # noqa: E501
    account_id: OptionalNullable[str] = Field(default=UNSET, description="Identifier for the account, unique for the company in the accounting software.", alias="accountId")
    name: OptionalNullable[str] = Field(default=UNSET, description="Name of the report line item.")
    value: Annotated[Decimal, BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(description="Numerical value of the line item.")
    items: OptionalNullable[List[ReportLine]] = Field(default=UNSET, description="An array of ReportLine items.")
    __properties: ClassVar[List[str]] = ["accountId", "name", "value", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "value": obj.get("value"),
            "items": [ReportLine.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ReportLine.model_rebuild(raise_errors=False)




class ReportLineTypedDict(TypedDict):
    """TypedDict variant of ReportLine, for dict-literal request/response inputs."""
    account_id: NotRequired[Optional[str]]
    name: NotRequired[Optional[str]]
    value: NotRequired[Decimal]
    items: NotRequired[Optional[List[ReportLineTypedDict]]]
