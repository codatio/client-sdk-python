...
class BankFeedBankAccountMapping(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankFeedBankAccountMapping from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankFeedBankAccountMapping from a dict"""
        if obj is None:
            return None
...
class BankFeedBankAccountMappingTypedDict(TypedDict):
    """TypedDict variant of BankFeedBankAccountMapping, for dict-literal request/response inputs."""
