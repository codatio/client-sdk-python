...
class Tracking(BaseModel):
    ...
    Tracking
    """ # noqa: E501
    record_refs: List[TrackingRecordRef] = Field(alias="recordRefs")
    invoice_to: Optional[AccountingRecordRef] = Field(default=None, alias="invoiceTo")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["recordRefs", "invoiceTo"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in record_refs (list)
        _items = []
        if self.record_refs:
            for _item_record_refs in self.record_refs:
                if _item_record_refs:
                    _items.append(_item_record_refs.to_dict())
            _dict['recordRefs'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recordRefs": [TrackingRecordRef.from_dict(_item) for _item in obj["recordRefs"]] if obj.get("recordRefs") is not None else None,
            "invoiceTo": AccountingRecordRef.from_dict(obj["invoiceTo"]) if obj.get("invoiceTo") is not None else None
        })
...
class TrackingTypedDict(TypedDict):
    """TypedDict variant of Tracking, for dict-literal request/response inputs."""
    record_refs: NotRequired[List[TrackingRecordRefTypedDict]]
    invoice_to: NotRequired[Optional[AccountingRecordRefTypedDict]]
