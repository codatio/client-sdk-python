...
class LendingCustomerRef(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'customerName', 'customer_name'}
        return {
    ...
    LendingCustomerRef
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="`id` from the Customers data type.")
    customer_name: OptionalNullable[str] = Field(default=UNSET, description="`customerName` from the Customer data type.", alias="customerName")
    __properties: ClassVar[List[str]] = ["id", "customerName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LendingCustomerRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LendingCustomerRef from a dict"""
        if obj is None:
            return None
...
class LendingCustomerRefTypedDict(TypedDict):
    """TypedDict variant of LendingCustomerRef, for dict-literal request/response inputs."""
