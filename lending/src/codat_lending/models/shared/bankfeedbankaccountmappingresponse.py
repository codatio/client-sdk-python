...
class BankFeedBankAccountMappingResponse(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'error', 'status', 'targetAccountId', 'target_account_id'}
        return {
    ...
    status: OptionalNullable[str] = Field(default=UNSET, description="Status of the POST request.")
    error: OptionalNullable[str] = Field(default=UNSET, description="Error returned during the post request")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sourceAccountId", "targetAccountId", "status", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankFeedBankAccountMappingResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankFeedBankAccountMappingResponse from a dict"""
        if obj is None:
            return None
...
class BankFeedBankAccountMappingResponseTypedDict(TypedDict):
    """TypedDict variant of BankFeedBankAccountMappingResponse, for dict-literal request/response inputs."""
