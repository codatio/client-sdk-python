...
class PaymentMethodRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique identifier of the location being referenced.")
    name: Optional[str] = Field(default=None, description="Name of the location being referenced.")
...
class PaymentMethodRefTypedDict(TypedDict):
    """TypedDict variant of PaymentMethodRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
