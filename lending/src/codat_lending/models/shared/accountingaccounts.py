...
from .accountingaccount import AccountingAccount, AccountingAccountTypedDict
...
class AccountingAccountsTypedDict(TypedDict):
    ...
    results: NotRequired[List[Nullable[AccountingAccountTypedDict]]]
...
try:
    AccountingAccounts.model_rebuild()
except NameError:
    pass
