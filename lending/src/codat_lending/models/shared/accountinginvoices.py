...
from .accountinginvoice import AccountingInvoice, AccountingInvoiceTypedDict
...
class AccountingInvoicesTypedDict(TypedDict):
    ...
    results: NotRequired[List[Nullable[AccountingInvoiceTypedDict]]]
...
try:
    AccountingInvoices.model_rebuild()
except NameError:
    pass
