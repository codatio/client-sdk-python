...
class AccountingInvoices(BaseModel):
    ...
    results: Optional[List[Nullable[AccountingInvoice]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingInvoices from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingInvoices from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [AccountingInvoice.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
...
class AccountingInvoicesTypedDict(TypedDict):
    ...
    results: NotRequired[Optional[List[Nullable[AccountingInvoiceTypedDict]]]]
