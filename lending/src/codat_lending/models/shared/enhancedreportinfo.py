...
class EnhancedReportInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currency", "reportName", "companyName", "generatedDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnhancedReportInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnhancedReportInfo from a dict"""
        if obj is None:
            return None
...
class EnhancedReportInfoTypedDict(TypedDict):
    """TypedDict variant of EnhancedReportInfo, for dict-literal request/response inputs."""
