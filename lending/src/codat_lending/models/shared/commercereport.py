...
from .commercereportdimension import CommerceReportDimension, CommerceReportDimensionTypedDict
...
class CommerceReport(BaseModel):
    ...
    report_data: Annotated[Optional[List[CommerceReportComponent]], pydantic.Field(alias="reportData")] = None
    report_info: Annotated[Optional[Dict[str, str]], pydantic.Field(alias="reportInfo")] = None
