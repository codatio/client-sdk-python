...
class CommerceReportMeasure(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[str] = Field(default=None, description="The measure's display name.", alias="displayName")
    units: Optional[str] = Field(default=None, description="The measure's units e.g. percentage (%).")
    index: Optional[int] = Field(default=None, description="The measure's index.")
    type: Optional[str] = Field(default=None, description="The measure's type.")
    __properties: ClassVar[List[str]] = ["displayName", "units", "index", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceReportMeasure from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceReportMeasure from a dict"""
        if obj is None:
            return None
...
class CommerceReportMeasureTypedDict(TypedDict):
    """TypedDict variant of CommerceReportMeasure, for dict-literal request/response inputs."""
