...
class AgedOutstandingAmountDetail(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[str] = Field(default=None, description="Name of data type with outstanding amount for given period.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgedOutstandingAmountDetail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgedOutstandingAmountDetail from a dict"""
        if obj is None:
            return None
...
class AgedOutstandingAmountDetailTypedDict(TypedDict):
    """TypedDict variant of AgedOutstandingAmountDetail, for dict-literal request/response inputs."""
