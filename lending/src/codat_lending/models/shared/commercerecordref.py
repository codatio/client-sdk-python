...
class CommerceRecordRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique identitifer of the record being referenced")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceRecordRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceRecordRef from a dict"""
        if obj is None:
            return None
...
class CommerceRecordRefTypedDict(TypedDict):
    """TypedDict variant of CommerceRecordRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
