...
class DataIntegrityAmounts(BaseModel):
    ...
    """ # noqa: E501
    min: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Lowest value of transaction set.")
    max: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Highest value of transaction set.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataIntegrityAmounts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataIntegrityAmounts from a dict"""
        if obj is None:
            return None
...
class DataIntegrityAmountsTypedDict(TypedDict):
    """TypedDict variant of DataIntegrityAmounts, for dict-literal request/response inputs."""
    min: NotRequired[Optional[Decimal]]
    max: NotRequired[Optional[Decimal]]
