...
class TaxComponentRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique identitifer of the tax component being referenced.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaxComponentRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaxComponentRef from a dict"""
        if obj is None:
            return None
