...
class AccountingCreateBankTransactions(BaseModel):
    ...
    """ # noqa: E501
    account_id: Optional[str] = Field(default=None, description="Unique identifier for a bank account.", alias="accountId")
    transactions: Optional[List[CreateBankAccountTransaction]] = None
    __properties: ClassVar[List[str]] = ["accountId", "transactions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingCreateBankTransactions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingCreateBankTransactions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [CreateBankAccountTransaction.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
...
class AccountingCreateBankTransactionsTypedDict(TypedDict):
    """TypedDict variant of AccountingCreateBankTransactions, for dict-literal request/response inputs."""
