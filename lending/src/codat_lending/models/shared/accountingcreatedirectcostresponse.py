...
class AccountingCreateDirectCostResponseAccountingDirectCost(BaseModel):
    ...
    * Writing a cheque
    ...
    r"""An array of line items."""
    payment_allocations: Annotated[List[AccountingPaymentAllocation], pydantic.Field(alias="paymentAllocations")]
    r"""An array of payment allocations."""
    ...
    def serialize_model(self, handler):
        optional_fields = ["contactRef", "currencyRate", "id", "metadata", "modifiedDate", "note", "reference", "sourceModifiedDate", "supplementalData"]
...
class AccountingCreateDirectCostResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingCreateDirectCostResponseAccountingDirectCostTypedDict]]
...
class AccountingCreateDirectCostResponse(BaseModel):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: OptionalNullable[AccountingCreateDirectCostResponseAccountingDirectCost] = UNSET
