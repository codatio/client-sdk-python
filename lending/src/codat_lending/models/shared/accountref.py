...
class AccountRef(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="'name' from the Accounts data type.")
...
class AccountRefTypedDict(TypedDict):
    """TypedDict variant of AccountRef, for dict-literal request/response inputs."""
