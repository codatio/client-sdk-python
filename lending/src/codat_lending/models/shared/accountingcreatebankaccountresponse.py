...
class AccountingCreateBankAccountResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingCreateBankAccountResponseAccountingBankAccountTypedDict]]
...
class AccountingCreateBankAccountResponse(BaseModel):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: OptionalNullable[AccountingCreateBankAccountResponseAccountingBankAccount] = UNSET
