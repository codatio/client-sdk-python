...
class AccountingCreateBankAccountResponseAccountingBankAccountTypedDict(TypedDict):
    ...
    * The sort code and account number.
    ...
    """
    account_type: NotRequired[AccountingBankAccountType]
...
class AccountingCreateBankAccountResponseAccountingBankAccount(BaseModel):
    r"""> **Accessing Bank Accounts through Banking API**
    >
    > This datatype was originally used for accessing bank account data both in accounting integrations and open banking aggregators.
    >
...
class AccountingCreateBankAccountResponseTypedDict(TypedDict):
    ...
    """
    data: NotRequired[
        Nullable[AccountingCreateBankAccountResponseAccountingBankAccountTypedDict]
    ]
...
class AccountingCreateBankAccountResponse(BaseModel):
    ...
    data: OptionalNullable[AccountingCreateBankAccountResponseAccountingBankAccount] = (
        UNSET
    )
...
try:
    AccountingCreateBankAccountResponseAccountingBankAccount.model_rebuild()
except NameError:
    pass
try:
    AccountingCreateBankAccountResponse.model_rebuild()
except NameError:
    pass
