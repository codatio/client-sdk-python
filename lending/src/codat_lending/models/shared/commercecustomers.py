...
class CommerceCustomers(BaseModel):
    ...
    results: Optional[List[Nullable[CommerceCustomer]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceCustomers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceCustomers from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [CommerceCustomer.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
...
class CommerceCustomersTypedDict(TypedDict):
    """TypedDict variant of CommerceCustomers, for dict-literal request/response inputs."""
