...
class TransactionSourceRef(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionSourceRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionSourceRef from a dict"""
        if obj is None:
            return None
...
class TransactionSourceRefTypedDict(TypedDict):
    """TypedDict variant of TransactionSourceRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
    type: TransactionSourceType
