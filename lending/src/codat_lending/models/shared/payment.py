...
class Payment(BaseModel):
    ...
    payment_type: Optional[str] = Field(default=None, description="The type of payment.", alias="paymentType")
    amount: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Payment amount.")
    ...
    banking_transaction_refs: Optional[List[BankingTransactionRef]] = Field(default=None, alias="bankingTransactionRefs")
    __properties: ClassVar[List[str]] = ["id", "date", "paymentType", "amount", "currency", "currencyRate", "bankingTransactionRefs"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in banking_transaction_refs (list)
        _items = []
        if self.banking_transaction_refs:
            for _item_banking_transaction_refs in self.banking_transaction_refs:
                if _item_banking_transaction_refs:
                    _items.append(_item_banking_transaction_refs.to_dict())
            _dict['bankingTransactionRefs'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bankingTransactionRefs": [BankingTransactionRef.from_dict(_item) for _item in obj["bankingTransactionRefs"]] if obj.get("bankingTransactionRefs") is not None else None
        })
        return _obj
...
class PaymentTypedDict(TypedDict):
    """TypedDict variant of Payment, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    date_: NotRequired[Optional[str]]
    payment_type: NotRequired[Optional[str]]
    amount: NotRequired[Optional[Decimal]]
    currency: NotRequired[Optional[str]]
    currency_rate: NotRequired[Optional[Decimal]]
    banking_transaction_refs: NotRequired[Optional[List[BankingTransactionRefTypedDict]]]
