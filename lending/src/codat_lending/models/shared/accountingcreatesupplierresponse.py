...
class AccountingCreateSupplierResponseAccountingSupplier(BaseModel):
    ...
    r"""Name of the main contact for the supplier."""
    default_currency: Annotated[OptionalNullable[str], pydantic.Field(alias="defaultCurrency")] = UNSET
    r"""Default currency the supplier's transactional data is recorded in."""
    ...
    It is referenced as a configured dynamic key value pair that is unique to the accounting software. [Learn more](https://docs.codat.io/using-the-api/supplemental-data/overview) about supplemental data.
    """
    supplier_name: Annotated[OptionalNullable[str], pydantic.Field(alias="supplierName")] = UNSET
    r"""Name of the supplier as recorded in the accounting system, typically the company name."""
    ...
    def serialize_model(self, handler):
        optional_fields = ["addresses", "contactName", "defaultCurrency", "emailAddress", "id", "metadata", "modifiedDate", "phone", "registrationNumber", "sourceModifiedDate", "supplementalData", "supplierName", "taxNumber"]
        nullable_fields = ["addresses", "contactName", "defaultCurrency", "emailAddress", "phone", "registrationNumber", "supplierName", "taxNumber"]
        null_default_fields = []
...
class AccountingCreateSupplierResponseTypedDict(TypedDict):
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    data: NotRequired[Nullable[AccountingCreateSupplierResponseAccountingSupplierTypedDict]]
