...
class DataConnectionError(BaseModel):
    ...
    r"""A message about a error returned by Codat."""
    errored_on_utc: Annotated[Optional[str], pydantic.Field(alias="erroredOnUtc")] = None
    r"""In Codat's data model, dates and times are represented using the <a class=\"external\" href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    resolved_on_utc: Annotated[Optional[str], pydantic.Field(alias="resolvedOnUtc")] = None
    r"""In Codat's data model, dates and times are represented using the <a class=\"external\" href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:
    ...
    def serialize_model(self, handler):
        optional_fields = ["errorMessage", "erroredOnUtc", "resolvedOnUtc", "status", "statusCode", "statusText"]
