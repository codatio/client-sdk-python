...
class AccountingSuppliers(BaseModel):
    ...
    results: Optional[List[Nullable[AccountingSupplier]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingSuppliers from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingSuppliers from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [AccountingSupplier.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
...
class AccountingSuppliersTypedDict(TypedDict):
    """TypedDict variant of AccountingSuppliers, for dict-literal request/response inputs."""
    page_number: NotRequired[int]
    page_size: NotRequired[int]
    total_results: NotRequired[int]
    links: NotRequired[LinksTypedDict]
    results: NotRequired[Optional[List[Nullable[AccountingSupplierTypedDict]]]]
