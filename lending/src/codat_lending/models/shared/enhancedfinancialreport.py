...
class ReportItem(BaseModel):
    account_category: Annotated[Optional[EnhancedReportAccountCategory], pydantic.Field(alias="accountCategory")] = None
...
class EnhancedFinancialReport(BaseModel):
    report_info: Annotated[Optional[EnhancedReportInfo], pydantic.Field(alias="reportInfo")] = None
    report_items: Annotated[Optional[List[ReportItem]], pydantic.Field(alias="reportItems")] = None
    r"""An array of report items."""
