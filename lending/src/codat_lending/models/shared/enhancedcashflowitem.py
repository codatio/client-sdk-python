...
class EnhancedCashFlowItem(BaseModel):
    ...
    """ # noqa: E501
    transactions: Optional[List[CashFlowTransaction]] = Field(default=None, description="An array of transaction data.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnhancedCashFlowItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnhancedCashFlowItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "transactions": [CashFlowTransaction.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
...
class EnhancedCashFlowItemTypedDict(TypedDict):
    """TypedDict variant of EnhancedCashFlowItem, for dict-literal request/response inputs."""
    transactions: NotRequired[Optional[List[CashFlowTransactionTypedDict]]]
