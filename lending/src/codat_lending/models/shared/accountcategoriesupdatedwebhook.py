...
class AccountCategoriesUpdatedWebhook(BaseModel):
    ...
    r"""Unique identifier for your SMB in Codat."""
    data: Annotated[Optional[AccountCategoriesUpdatedWebhookData], pydantic.Field(alias="Data")] = None
    ...
    r"""A human-readable message about the webhook."""
    rule_id: Annotated[Optional[str], pydantic.Field(deprecated="warning: ** DEPRECATED ** - This will be removed in a future release, please migrate away from it as soon as possible.", alias="RuleId")] = None
    r"""Unique identifier for the rule."""
