...
class TrackingCategoryRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="Unique identifier to the tracking category.")
    name: OptionalNullable[str] = Field(default=UNSET, description="Name of tracking category.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackingCategoryRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackingCategoryRef from a dict"""
        if obj is None:
            return None
...
class TrackingCategoryRefTypedDict(TypedDict):
    """TypedDict variant of TrackingCategoryRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
