...
class Attachments(BaseModel):
    ...
    Attachments
    """ # noqa: E501
    attachments: OptionalNullable[List[Nullable[AccountingAttachment]]] = UNSET
...
class AttachmentsTypedDict(TypedDict):
    """TypedDict variant of Attachments, for dict-literal request/response inputs."""
    attachments: NotRequired[Optional[List[Nullable[AccountingAttachmentTypedDict]]]]
