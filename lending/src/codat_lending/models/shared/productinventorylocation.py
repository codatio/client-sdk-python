...
class ProductInventoryLocation(BaseModel):
    ...
    """ # noqa: E501
    quantity: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The quantity of stock remaining at location.")
    location_ref: Optional[LocationRef] = Field(default=None, alias="locationRef")
    __properties: ClassVar[List[str]] = ["quantity", "locationRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductInventoryLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductInventoryLocation from a dict"""
        if obj is None:
            return None
...
class ProductInventoryLocationTypedDict(TypedDict):
    """TypedDict variant of ProductInventoryLocation, for dict-literal request/response inputs."""
