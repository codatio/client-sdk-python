...
class DataIntegritySummaries(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataIntegritySummaries from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataIntegritySummaries from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "summaries": [DataIntegritySummary.from_dict(_item) for _item in obj["summaries"]] if obj.get("summaries") is not None else None
        })
        return _obj
...
class DataIntegritySummariesTypedDict(TypedDict):
    """TypedDict variant of DataIntegritySummaries, for dict-literal request/response inputs."""
    summaries: NotRequired[Optional[List[DataIntegritySummaryTypedDict]]]
