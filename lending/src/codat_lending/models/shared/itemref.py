...
class ItemRef(BaseModel):
    ...
    ItemRef
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="The id of the object, e.g. the Journal entry.")
    data_connection_id: Optional[str] = Field(default=None, description="The data connection id being referenced.", alias="dataConnectionId")
    type: Optional[str] = Field(default=None, description="The data type the loan transaction entry was extracted from.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ItemRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ItemRef from a dict"""
        if obj is None:
            return None
...
class ItemRefTypedDict(TypedDict):
    """TypedDict variant of ItemRef, for dict-literal request/response inputs."""
