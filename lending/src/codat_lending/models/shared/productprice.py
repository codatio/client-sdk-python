...
class ProductPrice(BaseModel):
    ...
    unit_price: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The product variant's unit price.", alias="unitPrice")
    __properties: ClassVar[List[str]] = ["currency", "unitPrice"]
...
class ProductPriceTypedDict(TypedDict):
    """TypedDict variant of ProductPrice, for dict-literal request/response inputs."""
