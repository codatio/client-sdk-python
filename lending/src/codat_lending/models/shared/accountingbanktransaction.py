...
class AccountingBankTransaction(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'accountId', 'account_id', 'description'}
        return {
    ...
    id: Optional[str] = Field(default=None, description="Identifier for the bank transaction, unique to the company in the accounting software.")
    ...
    cleared_on_date: Optional[str] = Field(default=None, description="In Codat's data model, dates and times are represented using the <a class=\"external\" href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:  ``` 2020-10-08T22:40:50Z 2021-01-01T00:00:00 ```    When syncing data that contains `DateTime` fields from Codat, make sure you support the following cases when reading time information:  - Coordinated Universal Time (UTC): `2021-11-15T06:00:00Z` - Unqualified local time: `2021-11-15T01:00:00` - UTC time offsets: `2021-11-15T01:00:00-05:00`  > Time zones >  > Not all dates from Codat will contain information about time zones.   > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.", alias="clearedOnDate")
    ...
    balance: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The remaining balance in the account with ID `accountId`.")
    transaction_type: Optional[BankTransactionType] = Field(default=None, alias="transactionType")
    __properties: ClassVar[List[str]] = ["modifiedDate", "sourceModifiedDate", "id", "accountId", "clearedOnDate", "description", "reconciled", "amount", "balance", "transactionType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingBankTransaction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingBankTransaction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "clearedOnDate": obj.get("clearedOnDate"),
...
class AccountingBankTransactionTypedDict(TypedDict):
    """TypedDict variant of AccountingBankTransaction, for dict-literal request/response inputs."""
    ...
    cleared_on_date: NotRequired[Optional[str]]
