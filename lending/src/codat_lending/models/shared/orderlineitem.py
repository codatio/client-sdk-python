...
class OrderLineItem(BaseModel):
    id: str
    r"""A unique, persistent identifier for this record"""
    discount_allocations: Annotated[Optional[List[OrderDiscountAllocation]], pydantic.Field(alias="discountAllocations")] = None
    product_ref: Annotated[Optional[ProductRef], pydantic.Field(alias="productRef")] = None
    r"""Reference that links the line item to the correct product details."""
    product_variant_ref: Annotated[Optional[ProductVariantRef], pydantic.Field(alias="productVariantRef")] = None
    r"""Reference that links the line item to the specific version of product that has been ordered."""
