...
class AgedCurrencyOutstanding(BaseModel):
    ...
    aged_outstanding_amounts: Optional[List[AgedOutstandingAmount]] = Field(default=None, description="Array of outstanding amounts by period.", alias="agedOutstandingAmounts")
    __properties: ClassVar[List[str]] = ["currency", "agedOutstandingAmounts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgedCurrencyOutstanding from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in aged_outstanding_amounts (list)
        _items = []
        if self.aged_outstanding_amounts:
            for _item_aged_outstanding_amounts in self.aged_outstanding_amounts:
                if _item_aged_outstanding_amounts:
                    _items.append(_item_aged_outstanding_amounts.to_dict())
            _dict['agedOutstandingAmounts'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgedCurrencyOutstanding from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "agedOutstandingAmounts": [AgedOutstandingAmount.from_dict(_item) for _item in obj["agedOutstandingAmounts"]] if obj.get("agedOutstandingAmounts") is not None else None
        })
        return _obj
...
class AgedCurrencyOutstandingTypedDict(TypedDict):
    ...
    aged_outstanding_amounts: NotRequired[Optional[List[AgedOutstandingAmountTypedDict]]]
