...
class ProductRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique identifier of the product being referenced.")
    name: Optional[str] = Field(default=None, description="Name of the product being referenced.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductRef from a dict"""
        if obj is None:
            return None
...
class ProductRefTypedDict(TypedDict):
    """TypedDict variant of ProductRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
