...
class AccountingSupplier(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingSupplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingSupplier from a dict"""
        if obj is None:
            return None
...
class AccountingSupplierTypedDict(TypedDict):
    """TypedDict variant of AccountingSupplier, for dict-literal request/response inputs."""
