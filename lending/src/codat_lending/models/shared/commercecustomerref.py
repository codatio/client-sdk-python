...
class CommerceCustomerRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique identitifer of the customer being referenced")
    name: Optional[str] = Field(default=None, description="Name of the customer being referenced.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceCustomerRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceCustomerRef from a dict"""
        if obj is None:
            return None
...
class CommerceCustomerRefTypedDict(TypedDict):
    """TypedDict variant of CommerceCustomerRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
