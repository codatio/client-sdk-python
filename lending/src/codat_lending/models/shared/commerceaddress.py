...
class CommerceAddress(BaseModel):
    ...
    line1: Optional[str] = Field(default=None, description="The first line of the address")
    line2: Optional[str] = Field(default=None, description="The second line of the address")
    city: Optional[str] = Field(default=None, description="The third line of the address, or city")
    region: Optional[str] = Field(default=None, description="The fourth line of the address, or region")
    country: Optional[str] = Field(default=None, description="The country for the address")
    postal_code: Optional[str] = Field(default=None, description="The postal (or zip) code for the address", alias="postalCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceAddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceAddress from a dict"""
        if obj is None:
            return None
...
class CommerceAddressTypedDict(TypedDict):
    """TypedDict variant of CommerceAddress, for dict-literal request/response inputs."""
    type: NotRequired[Optional[CommerceAddressType]]
