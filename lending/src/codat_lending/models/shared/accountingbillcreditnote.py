...
from .billcreditnotelineitem import BillCreditNoteLineItem, BillCreditNoteLineItemTypedDict
...
class AccountingBillCreditNote(BaseModel):
    ...
    * The supplier that issued the bill credit note.
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    bill_credit_note_number: Annotated[OptionalNullable[str], pydantic.Field(alias="billCreditNoteNumber")] = UNSET
    r"""Friendly reference for the bill credit note."""
    created_from_refs: Annotated[OptionalNullable[List[RecordRef]], pydantic.Field(alias="createdFromRefs")] = UNSET
    r"""An array of records the credit note was created from."""
    ...
    > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.
    """
    line_items: Annotated[OptionalNullable[List[BillCreditNoteLineItem]], pydantic.Field(alias="lineItems")] = UNSET
    r"""An array of line"""
    ...
    r"""An array of payment allocations."""
    remaining_credit: Annotated[Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))], pydantic.Field(alias="remainingCredit")] = None
    r"""Amount of the bill credit note that is still outstanding."""
    ...
    def serialize_model(self, handler):
        optional_fields = ["allocatedOnDate", "billCreditNoteNumber", "createdFromRefs", "currency", "currencyRate", "id", "issueDate", "lineItems", "metadata", "modifiedDate", "note", "paymentAllocations", "remainingCredit", "sourceModifiedDate", "supplementalData", "supplierRef", "withholdingTax"]
        nullable_fields = ["billCreditNoteNumber", "createdFromRefs", "currencyRate", "lineItems", "note", "paymentAllocations", "withholdingTax"]
        null_default_fields = []
