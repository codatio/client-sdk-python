...
class BankAccountRef(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Bank account 'id' for the account transaction.")
    name: Optional[str] = Field(default=None, description="bank account 'name' for the account transaction.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankAccountRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankAccountRef from a dict"""
        if obj is None:
            return None
...
class BankAccountRefTypedDict(TypedDict):
    """TypedDict variant of BankAccountRef, for dict-literal request/response inputs."""
