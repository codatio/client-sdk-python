...
class DataSource(BaseModel):
    ...
    DataSource
    """ # noqa: E501
    accounts: Optional[List[Accounts]] = Field(default=None, description="An array containing bank account data for each connected banking data source that have the following data types enabled: `banking-accounts`, `banking-transactions`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [Accounts.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
...
class DataSourceTypedDict(TypedDict):
    """TypedDict variant of DataSource, for dict-literal request/response inputs."""
    accounts: NotRequired[Optional[List[AccountsTypedDict]]]
