...
class AccountingCustomerRef(BaseModel):

    @model_serializer(mode="wrap")
    def _serialize_drop_none(self, handler):
        serialized = handler(self)
        _nullable = {'companyName', 'company_name'}
        return {
    ...
    """ # noqa: E501
    id: str = Field(description="`id` from the Customers data type")
    company_name: OptionalNullable[str] = Field(default=UNSET, description="`customerName` from the Customer data type", alias="companyName")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingCustomerRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingCustomerRef from a dict"""
        if obj is None:
            return None
...
class AccountingCustomerRefTypedDict(TypedDict):
