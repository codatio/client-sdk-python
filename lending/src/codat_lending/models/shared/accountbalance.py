...
class AccountBalance(BaseModel):
    ...
    AccountBalance
    """ # noqa: E501
    available: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The account's current balance")
    pending: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Funds that are not yet available in the balance")
    reserved: Optional[Any] = None
    currency: Optional[str] = Field(default=None, description="The currency of the account")
    __properties: ClassVar[List[str]] = ["available", "pending", "reserved", "currency"]
...
class AccountBalanceTypedDict(TypedDict):
    """TypedDict variant of AccountBalance, for dict-literal request/response inputs."""
    available: NotRequired[Optional[Decimal]]
    pending: NotRequired[Optional[Decimal]]
    reserved: NotRequired[Optional[Any]]
