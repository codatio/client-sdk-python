...
class AccountingAccount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nominalCode", "name", "description", "fullyQualifiedCategory", "fullyQualifiedName", "currency", "currentBalance", "type", "status", "isBankAccount", "validDatatypeLinks", "supplementalData", "modifiedDate", "sourceModifiedDate", "id", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingAccount from a dict"""
        if obj is None:
            return None
...
class AccountingAccountTypedDict(TypedDict):
    """TypedDict variant of AccountingAccount, for dict-literal request/response inputs."""
