...
class StartUploadSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    data_type: Optional[StartUploadSessionRequestDataType] = Field(default=None, description="A key for a Codat data type.", alias="dataType")
    ...
    def data_type_validate_enum(cls, value):
        ...
        if value not in set(['banking-accounts', 'banking-transactions']):
            raise ValueError("must be one of enum values ('banking-accounts', 'banking-transactions')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartUploadSessionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartUploadSessionRequest from a dict"""
        if obj is None:
            return None
...
class StartUploadSessionRequestTypedDict(TypedDict):
    """TypedDict variant of StartUploadSessionRequest, for dict-literal request/response inputs."""
    data_type: NotRequired[Optional[StartUploadSessionRequestDataType]]
