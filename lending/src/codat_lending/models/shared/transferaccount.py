...
class TransferAccount(BaseModel):
    ...
    """ # noqa: E501
    account_ref: Optional[AccountingRecordRef] = Field(default=None, description="The account that the transfer is moving from or to.", alias="accountRef")
    ...
    amount: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The amount transferred between accounts.")
    __properties: ClassVar[List[str]] = ["accountRef", "currency", "amount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferAccount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accountRef": AccountingRecordRef.from_dict(obj["accountRef"]) if obj.get("accountRef") is not None else None,
...
class TransferAccountTypedDict(TypedDict):
    """TypedDict variant of TransferAccount, for dict-literal request/response inputs."""
