...
class LoanSummary(BaseModel):
    ...
    LoanSummary
    """ # noqa: E501
    report_info: Optional[LoanSummaryReportInfo] = Field(default=None, alias="reportInfo")
    report_items: Optional[List[LoanSummaryReportItem]] = Field(default=None, description="Returns a summary of all loan activity for that integration type", alias="reportItems")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoanSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoanSummary from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reportInfo": LoanSummaryReportInfo.from_dict(obj["reportInfo"]) if obj.get("reportInfo") is not None else None,
            "reportItems": [LoanSummaryReportItem.from_dict(_item) for _item in obj["reportItems"]] if obj.get("reportItems") is not None else None
        })
        return _obj
...
class LoanSummaryTypedDict(TypedDict):
    """TypedDict variant of LoanSummary, for dict-literal request/response inputs."""
    report_info: NotRequired[Optional[LoanSummaryReportInfoTypedDict]]
    report_items: NotRequired[Optional[List[LoanSummaryReportItemTypedDict]]]
