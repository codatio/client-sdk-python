...
class CommerceReportDimension(BaseModel):
    ...
    """ # noqa: E501
    index: Optional[int] = Field(default=None, description="The dimension's index.")
    display_name: Optional[str] = Field(default=None, description="The dimension's display name.", alias="displayName")
    type: Optional[str] = Field(default=None, description="The dimension's type.")
    items: Optional[List[CommerceReportDimensionItems]] = None
    __properties: ClassVar[List[str]] = ["index", "displayName", "type", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceReportDimension from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceReportDimension from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "items": [CommerceReportDimensionItems.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
...
class CommerceReportDimensionTypedDict(TypedDict):
    """TypedDict variant of CommerceReportDimension, for dict-literal request/response inputs."""
    index: NotRequired[Optional[int]]
    display_name: NotRequired[Optional[str]]
    type: NotRequired[Optional[str]]
    items: NotRequired[Optional[List[CommerceReportDimensionItemsTypedDict]]]
