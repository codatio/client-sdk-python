...
class PaymentRef(BaseModel):
    ...
    amount: Annotated[OptionalNullable[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=UNSET, description="Payment Amount (including gratuity).")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdDate", "modifiedDate", "sourceModifiedDate", "amount", "currency", "type", "status", "paymentProvider", "dueDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentRef from a dict"""
        if obj is None:
            return None
...
class PaymentRefTypedDict(TypedDict):
    """TypedDict variant of PaymentRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
    ...
    type: NotRequired[Optional[PaymentType]]
