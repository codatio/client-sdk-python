...
class CreateBankAccountTransaction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "amount", "date", "description", "balance"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBankAccountTransaction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBankAccountTransaction from a dict"""
        if obj is None:
            return None
...
class CreateBankAccountTransactionTypedDict(TypedDict):
    """TypedDict variant of CreateBankAccountTransaction, for dict-literal request/response inputs."""
