...
from .commercepaymentmethod import CommercePaymentMethod, CommercePaymentMethodTypedDict
...
class CommercePaymentMethodsTypedDict(TypedDict):
    ...
    results: NotRequired[List[Nullable[CommercePaymentMethodTypedDict]]]
...
try:
    CommercePaymentMethods.model_rebuild()
except NameError:
    pass
