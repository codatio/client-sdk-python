...
class BankStatementUploadConfiguration(BaseModel):
    ...
    """ # noqa: E501
    source: Optional[Source] = Field(default=None, description="The source of the banking data that determines its format")
    account_id: Optional[str] = Field(default=None, description="The ID of the account in the third-party platform", alias="accountId")
    provider_id: Optional[str] = Field(default=None, description="TrueLayer provider ID (only required if source is TrueLayer)", alias="providerId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["source", "accountId", "providerId"]
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(['codat']):
            raise ValueError("must be one of enum values ('codat')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BankStatementUploadConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankStatementUploadConfiguration from a dict"""
        if obj is None:
            return None
...
class BankStatementUploadConfigurationTypedDict(TypedDict):
    """TypedDict variant of BankStatementUploadConfiguration, for dict-literal request/response inputs."""
    source: NotRequired[Optional[Source]]
    account_id: NotRequired[Optional[str]]
    provider_id: NotRequired[Optional[str]]
