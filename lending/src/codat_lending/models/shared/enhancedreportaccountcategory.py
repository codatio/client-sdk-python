...
class EnhancedReportAccountCategory(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[str] = Field(default=None, description="Returns a status of \"Suggested\" or \"Confirmed\". If an account has a confirmed category, it will replace any suggested category returned.")
    levels: Optional[List[AccountCategoryLevel]] = None
    __properties: ClassVar[List[str]] = ["status", "levels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnhancedReportAccountCategory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnhancedReportAccountCategory from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "levels": [AccountCategoryLevel.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None
        })
        return _obj
...
class EnhancedReportAccountCategoryTypedDict(TypedDict):
    """TypedDict variant of EnhancedReportAccountCategory, for dict-literal request/response inputs."""
    status: NotRequired[Optional[str]]
    levels: NotRequired[Optional[List[AccountCategoryLevelTypedDict]]]
