...
class AccountingTransfer(BaseModel):
    ...
    status: OptionalNullable[AccountingTransferStatus] = Field(default=UNSET, description="The status of the transfer in the account")
    ...
    __properties: ClassVar[List[str]] = ["modifiedDate", "sourceModifiedDate", "id", "description", "contactRef", "date", "from", "to", "status", "trackingCategoryRefs", "depositedRecordRefs", "metadata", "supplementalData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingTransfer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingTransfer from a dict"""
        if obj is None:
            return None
...
class AccountingTransferTypedDict(TypedDict):
    """TypedDict variant of AccountingTransfer, for dict-literal request/response inputs."""
    ...
    status: NotRequired[Optional[AccountingTransferStatus]]
