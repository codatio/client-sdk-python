...
class AccountingDirectIncome(BaseModel):
    ...
    id: Optional[str] = Field(default=None, description="Identifier of the direct income, unique for the company.")
    reference: OptionalNullable[str] = Field(default=UNSET, description="User-friendly reference for the direct income.")
    note: OptionalNullable[str] = Field(default=UNSET, description="An optional note on the direct income that can be used to assign the direct income with a reference ID in your application.")
    contact_ref: Optional[ContactRef] = Field(default=None, description="A customer or supplier associated with the direct income.", alias="contactRef")
    ...
    line_items: List[DirectIncomeLineItem] = Field(description="An array of line items.", alias="lineItems")
    payment_allocations: List[AccountingPaymentAllocation] = Field(alias="paymentAllocations")
    sub_total: Annotated[Decimal, BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(description="The total amount of the direct incomes, excluding any taxes.", alias="subTotal")
    tax_amount: Annotated[Decimal, BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(description="The total amount of tax on the direct incomes.", alias="taxAmount")
    total_amount: Annotated[Decimal, BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(description="The amount of the direct incomes, inclusive of tax.", alias="totalAmount")
    metadata: Optional[Metadata] = None
    supplemental_data: Optional[SupplementalData] = Field(default=None, alias="supplementalData")
    __properties: ClassVar[List[str]] = ["modifiedDate", "sourceModifiedDate", "id", "reference", "note", "contactRef", "issueDate", "currency", "currencyRate", "lineItems", "paymentAllocations", "subTotal", "taxAmount", "totalAmount", "metadata", "supplementalData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingDirectIncome from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingDirectIncome from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lineItems": [DirectIncomeLineItem.from_dict(_item) for _item in obj["lineItems"]] if obj.get("lineItems") is not None else None,
...
class AccountingDirectIncomeTypedDict(TypedDict):
    """TypedDict variant of AccountingDirectIncome, for dict-literal request/response inputs."""
    ...
    line_items: NotRequired[List[DirectIncomeLineItemTypedDict]]
