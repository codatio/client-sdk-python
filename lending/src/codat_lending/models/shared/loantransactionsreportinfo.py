...
class LoanTransactionsReportInfo(BaseModel):
    ...
    """ # noqa: E501
    page_number: Optional[int] = Field(default=None, description="The page number.", alias="pageNumber")
    page_size: Optional[int] = Field(default=None, description="Queried page size.", alias="pageSize")
    total_results: Optional[int] = Field(default=None, description="The total number of transactions returned.", alias="totalResults")
    report_name: Optional[str] = Field(default=None, description="The name of the report.", alias="reportName")
    company_name: Optional[str] = Field(default=None, description="Name of the company queried.", alias="companyName")
    generated_date: Optional[str] = Field(default=None, description="In Codat's data model, dates and times are represented using the <a class=\"external\" href=\"https://en.wikipedia.org/wiki/ISO_8601\" target=\"_blank\">ISO 8601 standard</a>. Date and time fields are formatted as strings; for example:  ``` 2020-10-08T22:40:50Z 2021-01-01T00:00:00 ```    When syncing data that contains `DateTime` fields from Codat, make sure you support the following cases when reading time information:  - Coordinated Universal Time (UTC): `2021-11-15T06:00:00Z` - Unqualified local time: `2021-11-15T01:00:00` - UTC time offsets: `2021-11-15T01:00:00-05:00`  > Time zones >  > Not all dates from Codat will contain information about time zones.   > Where it is not available from the underlying platform, Codat will return these as times local to the business whose data has been synced.", alias="generatedDate")
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "totalResults", "reportName", "companyName", "generatedDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoanTransactionsReportInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoanTransactionsReportInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "generatedDate": obj.get("generatedDate")
        })
        return _obj
...
class LoanTransactionsReportInfoTypedDict(TypedDict):
    """TypedDict variant of LoanTransactionsReportInfo, for dict-literal request/response inputs."""
    page_number: NotRequired[Optional[int]]
    page_size: NotRequired[Optional[int]]
    total_results: NotRequired[Optional[int]]
    report_name: NotRequired[Optional[str]]
