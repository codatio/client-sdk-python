...
class ReportComponentMeasure(BaseModel):
    ...
    """ # noqa: E501
    index: Optional[int] = Field(default=None, description="The measure's index.")
    measure_display_name: Optional[str] = Field(default=None, description="The measure's display name.", alias="measureDisplayName")
    value: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The measure's value.")
    __properties: ClassVar[List[str]] = ["index", "measureDisplayName", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportComponentMeasure from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportComponentMeasure from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "measureDisplayName": obj.get("measureDisplayName"),
            "value": obj.get("value")
        })
        return _obj
...
class ReportComponentMeasureTypedDict(TypedDict):
    """TypedDict variant of ReportComponentMeasure, for dict-literal request/response inputs."""
    index: NotRequired[Optional[int]]
    measure_display_name: NotRequired[Optional[str]]
    value: NotRequired[Optional[Decimal]]
