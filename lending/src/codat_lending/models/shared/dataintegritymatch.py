...
class DataIntegrityMatch(BaseModel):
    ...
    date_: Optional[str] = Field(default=None, description="The date of the transaction.", alias="date")
    description: Optional[str] = Field(default=None, description="The transaction description.")
    amount: Optional[str] = Field(default=None, description="The transaction value.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "connectionId", "date", "description", "amount", "currency"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataIntegrityMatch from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataIntegrityMatch from a dict"""
        if obj is None:
            return None
...
class DataIntegrityMatchTypedDict(TypedDict):
    """TypedDict variant of DataIntegrityMatch, for dict-literal request/response inputs."""
