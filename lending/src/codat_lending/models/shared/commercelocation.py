...
class CommerceLocation(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="Name of this location")
    address: Optional[CommerceAddress] = Field(default=None, description="Address associated with the location")
    __properties: ClassVar[List[str]] = ["id", "modifiedDate", "sourceModifiedDate", "name", "address"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceLocation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "address": CommerceAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
...
class CommerceLocationTypedDict(TypedDict):
    """TypedDict variant of CommerceLocation, for dict-literal request/response inputs."""
    id: NotRequired[str]
    modified_date: NotRequired[Optional[str]]
    source_modified_date: NotRequired[Optional[str]]
    name: NotRequired[Optional[str]]
    address: NotRequired[Optional[CommerceAddressTypedDict]]
