...
class EndUploadSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[EndUploadSessionRequestStatus] = Field(default=None, description="An indicator to cancel the dataset processing or trigger ingestion and enrichment of data.")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Cancel', 'Process']):
            raise ValueError("must be one of enum values ('Cancel', 'Process')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EndUploadSessionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EndUploadSessionRequest from a dict"""
        if obj is None:
            return None
...
class EndUploadSessionRequestTypedDict(TypedDict):
    """TypedDict variant of EndUploadSessionRequest, for dict-literal request/response inputs."""
    status: NotRequired[Optional[EndUploadSessionRequestStatus]]
