...
class TransactionCategoryRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique category reference id for the bank transaction.")
    name: OptionalNullable[str] = Field(default=UNSET, description="The category name reference for the bank transaction.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransactionCategoryRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransactionCategoryRef from a dict"""
        if obj is None:
            return None
...
class TransactionCategoryRefTypedDict(TypedDict):
    """TypedDict variant of TransactionCategoryRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
