...
class PaymentLine(BaseModel):
    ...
    PaymentLine
    """ # noqa: E501
    amount: Annotated[Decimal, BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(description="Amount in the payment currency.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": [PaymentLineLink.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
...
class PaymentLineTypedDict(TypedDict):
    """TypedDict variant of PaymentLine, for dict-literal request/response inputs."""
    amount: NotRequired[Decimal]
    links: NotRequired[Optional[List[PaymentLineLinkTypedDict]]]
