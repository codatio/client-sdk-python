...
class AccountingRecordRef(BaseModel):
    ...
    """
    Links the current record to the underlying record or data type that created it.   For example, if a journal entry is generated based on an invoice, this property allows you to connect the journal entry to the underlying invoice in our data model. 
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="'id' of the underlying record or data type.")
    data_type: Optional[str] = Field(default=None, description="Allowed name of the 'dataType'.", alias="dataType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingRecordRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingRecordRef from a dict"""
        if obj is None:
            return None
...
class AccountingRecordRefTypedDict(TypedDict):
    """TypedDict variant of AccountingRecordRef, for dict-literal request/response inputs."""
