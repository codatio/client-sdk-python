...
class CommercePaymentMethod(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="The name of the PaymentMethod")
    status: Optional[CommercePaymentMethodStatus] = Field(default=None, description="Status of the Payment Method.")
    __properties: ClassVar[List[str]] = ["id", "modifiedDate", "sourceModifiedDate", "name", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Unknown', 'Active', 'Archived']):
            raise ValueError("must be one of enum values ('Unknown', 'Active', 'Archived')")
        return value
...
class CommercePaymentMethodTypedDict(TypedDict):
    """TypedDict variant of CommercePaymentMethod, for dict-literal request/response inputs."""
    id: NotRequired[str]
    modified_date: NotRequired[Optional[str]]
    source_modified_date: NotRequired[Optional[str]]
    name: NotRequired[Optional[str]]
    status: NotRequired[Optional[CommercePaymentMethodStatus]]
