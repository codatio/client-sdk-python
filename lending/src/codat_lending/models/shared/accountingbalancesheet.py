...
class AccountingBalanceSheet(BaseModel):
    ...
    reports: List[BalanceSheet] = Field(description="An array of balance sheet reports.")
    ...
    __properties: ClassVar[List[str]] = ["currency", "reports", "mostRecentAvailableMonth", "earliestAvailableMonth"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingBalanceSheet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingBalanceSheet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "reports": [BalanceSheet.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
...
class AccountingBalanceSheetTypedDict(TypedDict):
    """TypedDict variant of AccountingBalanceSheet, for dict-literal request/response inputs."""
    currency: NotRequired[Optional[str]]
    reports: NotRequired[List[BalanceSheetTypedDict]]
