...
class ProductVariantRef(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="The unique identifier of the product variant being referenced.")
    name: Optional[str] = Field(default=None, description="Name of the product variant being referenced.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductVariantRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductVariantRef from a dict"""
        if obj is None:
            return None
...
class ProductVariantRefTypedDict(TypedDict):
    """TypedDict variant of ProductVariantRef, for dict-literal request/response inputs."""
    id: NotRequired[str]
