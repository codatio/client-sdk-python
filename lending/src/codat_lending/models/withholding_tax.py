...
class WithholdingTax(BaseModel):
    ...
    WithholdingTax
    """ # noqa: E501
    name: str = Field(description="Name assigned to withheld tax.")
    amount: Annotated[Decimal, BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(description="Amount of tax withheld.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WithholdingTax from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WithholdingTax from a dict"""
        if obj is None:
            return None
...
class WithholdingTaxTypedDict(TypedDict):
    """TypedDict variant of WithholdingTax, for dict-literal request/response inputs."""
