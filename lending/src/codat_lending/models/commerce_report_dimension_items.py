...
class CommerceReportDimensionItems(BaseModel):
    ...
    """ # noqa: E501
    index: Optional[int] = Field(default=None, description="The dimension's items index.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CommerceReportDimensionItems from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CommerceReportDimensionItems from a dict"""
        if obj is None:
            return None
...
class CommerceReportDimensionItemsTypedDict(TypedDict):
    """TypedDict variant of CommerceReportDimensionItems, for dict-literal request/response inputs."""
