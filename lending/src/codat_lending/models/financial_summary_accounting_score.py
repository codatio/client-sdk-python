...
class FinancialSummaryAccountingScore(BaseModel):
    ...
    """ # noqa: E501
    score: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="The accounting score value.")
    reason: Optional[List[str]] = Field(default=None, description="List of reasons explaining the accounting score.")
    __properties: ClassVar[List[str]] = ["score", "reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FinancialSummaryAccountingScore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FinancialSummaryAccountingScore from a dict"""
        if obj is None:
            return None
...
class FinancialSummaryAccountingScoreTypedDict(TypedDict):
    """TypedDict variant of FinancialSummaryAccountingScore, for dict-literal request/response inputs."""
    score: NotRequired[Optional[Decimal]]
    reason: NotRequired[Optional[List[str]]]
