...
class DataIntegrityType(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataIntegrityType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataIntegrityType from a dict"""
        if obj is None:
            return None
...
class DataIntegrityTypeTypedDict(TypedDict):
    """TypedDict variant of DataIntegrityType, for dict-literal request/response inputs."""
