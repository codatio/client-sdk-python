...
class ReportItem(BaseModel):
    ...
    balance: Annotated[Optional[Decimal], BeforeValidator(validate_decimal), PlainSerializer(serialize_decimal(False))] = Field(default=None, description="Balance of the account as reported on the profit and loss or Balance sheet.")
    account_name: Optional[str] = Field(default=None, description="Name of the account.", alias="accountName")
    account_id: Optional[str] = Field(default=None, description="The unique account ID.", alias="accountId")
    account_category: Optional[EnhancedReportAccountCategory] = Field(default=None, alias="accountCategory")
    __properties: ClassVar[List[str]] = ["date", "balance", "accountName", "accountId", "accountCategory"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of account_category
        if self.account_category:
            _dict['accountCategory'] = self.account_category.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountCategory": EnhancedReportAccountCategory.from_dict(obj["accountCategory"]) if obj.get("accountCategory") is not None else None
        })
        return _obj
...
class ReportItemTypedDict(TypedDict):
    """TypedDict variant of ReportItem, for dict-literal request/response inputs."""
    ...
    account_category: NotRequired[Optional[EnhancedReportAccountCategoryTypedDict]]
