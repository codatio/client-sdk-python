...
class SalesOrderReference(BaseModel):
    ...
    SalesOrderReference
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier to a record in `dataType`.")
    data_type: Optional[AccountingInvoiceDataType] = Field(default=None, description="The underlying data type associated to the reference `id`.", alias="dataType")
    ...
    def data_type_validate_enum(cls, value):
        ...
        if value not in set(['salesOrders']):
            raise ValueError("must be one of enum values ('salesOrders')")
        return value
...
class SalesOrderReferenceTypedDict(TypedDict):
    """TypedDict variant of SalesOrderReference, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    data_type: NotRequired[Optional[AccountingInvoiceDataType]]
