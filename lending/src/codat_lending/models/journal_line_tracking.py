...
class JournalLineTracking(BaseModel):
    ...
    def _serialize_drop_none(self, handler):
        ...
        _nullable = {'recordRefs', 'record_refs'}
        return {
    ...
    """ # noqa: E501
    record_refs: OptionalNullable[List[TrackingRecordRef]] = Field(default=UNSET, alias="recordRefs")
    __properties: ClassVar[List[str]] = ["recordRefs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JournalLineTracking from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JournalLineTracking from a dict"""
        if obj is None:
            return None
...
class JournalLineTrackingTypedDict(TypedDict):
    """TypedDict variant of JournalLineTracking, for dict-literal request/response inputs."""
    record_refs: NotRequired[Optional[List[TrackingRecordRefTypedDict]]]
