...
class JournalPrototype(BaseModel):
    ...
    JournalPrototype
    """ # noqa: E501
    journal_code: Optional[str] = Field(default=None, description="Native journal number or code.", alias="journalCode")
    name: Optional[str] = Field(default=None, description="Journal name. The maximum length for a journal name is 256 characters. All characters above that number will be truncated.")
    type: Optional[str] = Field(default=None, description="The type of the journal.")
    parent_id: Optional[str] = Field(default=None, description="Parent journal ID. If the journal is a parent journal, this value is not present.", alias="parentId")
    ...
    __properties: ClassVar[List[str]] = ["journalCode", "name", "type", "parentId", "hasChildren", "createdOn", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JournalPrototype from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JournalPrototype from a dict"""
        if obj is None:
            return None
...
class JournalPrototypeTypedDict(TypedDict):
    """TypedDict variant of JournalPrototype, for dict-literal request/response inputs."""
