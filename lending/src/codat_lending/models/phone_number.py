...
class PhoneNumber(BaseModel):
    ...
    type: PhoneNumberType = Field(description="The type of phone number")
...
class PhoneNumberTypedDict(TypedDict):
    """TypedDict variant of PhoneNumber, for dict-literal request/response inputs."""
    number: NotRequired[Optional[str]]
    type: NotRequired[PhoneNumberType]
