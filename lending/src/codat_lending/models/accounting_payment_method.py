...
class AccountingPaymentMethod(BaseModel):
    ...
    id: Optional[str] = Field(default=None, description="Unique identifier for the payment method.")
    name: Optional[str] = Field(default=None, description="Name of the payment method.")
    type: Optional[PaymentMethodType] = None
    status: Optional[Status] = None
    metadata: Optional[Metadata] = None
    __properties: ClassVar[List[str]] = ["modifiedDate", "sourceModifiedDate", "id", "name", "type", "status", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountingPaymentMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountingPaymentMethod from a dict"""
        if obj is None:
            return None
...
class AccountingPaymentMethodTypedDict(TypedDict):
    """TypedDict variant of AccountingPaymentMethod, for dict-literal request/response inputs."""
    modified_date: NotRequired[Optional[str]]
    source_modified_date: NotRequired[Optional[str]]
    id: NotRequired[Optional[str]]
    name: NotRequired[Optional[str]]
    type: NotRequired[Optional[PaymentMethodType]]
