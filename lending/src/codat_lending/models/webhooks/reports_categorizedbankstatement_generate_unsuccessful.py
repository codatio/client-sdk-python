...
class ReportsCategorizedBankStatementGenerateUnsuccessfulReportGenerationWebhookTypedDict(TypedDict):
...
class ReportsCategorizedBankStatementGenerateUnsuccessfulReportGenerationWebhook(BaseModel):
