...
class ReportsCreditModelGenerateUnsuccessfulReportGenerationWebhookTypedDict(TypedDict):
...
class ReportsCreditModelGenerateUnsuccessfulReportGenerationWebhook(BaseModel):
