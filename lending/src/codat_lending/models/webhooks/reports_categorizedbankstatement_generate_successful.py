...
class ReportsCategorizedBankStatementGenerateSuccessfulReportGenerationWebhookTypedDict(TypedDict):
...
class ReportsCategorizedBankStatementGenerateSuccessfulReportGenerationWebhook(BaseModel):
