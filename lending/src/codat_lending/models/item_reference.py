...
class ItemReference(BaseModel):
    ...
    """ # noqa: E501
    id: str = Field(description="Unique identifier for the item in the accounting software.")
...
class ItemReferenceTypedDict(TypedDict):
    """TypedDict variant of ItemReference, for dict-literal request/response inputs."""
    id: NotRequired[str]
