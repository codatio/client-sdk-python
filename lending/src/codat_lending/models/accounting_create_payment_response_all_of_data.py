...
class AccountingCreatePaymentResponseAllOfData(BaseModel):
    ...
    note: OptionalNullable[str] = Field(default=UNSET, description="Any additional information associated with the payment.")
    lines: OptionalNullable[List[PaymentLine]] = Field(default=UNSET, description="An array of payment lines.")
    reference: OptionalNullable[str] = Field(default=UNSET, description="Friendly reference for the payment.")
