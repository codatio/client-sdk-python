...
from codat_lending.models._compat.billlineitem import BillLineItemDataType
class RecordLineReference(BaseModel):
    ...
    """
    Links the current record line to the underlying record line that created it.   For example, if a bill is generated from a purchase order, this property allows you to connect the bill line item to the purchase order line item in our data model. 
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="'id' of the underlying record.")
    data_type: Optional[BillLineItemDataType] = Field(default=None, description="Allowed name of the 'dataType'.", alias="dataType")
    line_number: Optional[str] = Field(default=None, description="Line number of the underlying record.", alias="lineNumber")
    __properties: ClassVar[List[str]] = ["id", "dataType", "lineNumber"]
    ...
    def data_type_validate_enum(cls, value):
        ...
        if value not in set(['purchaseOrders', 'bills']):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecordLineReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecordLineReference from a dict"""
        if obj is None:
            return None
...
class RecordLineReferenceTypedDict(TypedDict):
    """TypedDict variant of RecordLineReference, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    data_type: NotRequired[Optional[BillLineItemDataType]]
