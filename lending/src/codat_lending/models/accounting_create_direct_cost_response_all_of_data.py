...
class AccountingCreateDirectCostResponseAllOfData(BaseModel):
    ...
    reference: Optional[str] = Field(default=None, description="User-friendly reference for the direct cost.")
    note: Optional[str] = Field(default=None, description="A note attached to the direct cost.")
