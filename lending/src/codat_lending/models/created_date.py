...
class CreatedDate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatedDate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatedDate from a dict"""
        if obj is None:
            return None
...
class CreatedDateTypedDict(TypedDict):
    """TypedDict variant of CreatedDate, for dict-literal request/response inputs."""
