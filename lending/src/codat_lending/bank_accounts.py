...
class BankAccounts(BaseSDK):
    ...
    def create(
        self, *,
        request: Union[operations.CreateBankAccountRequest, operations.CreateBankAccountRequestTypedDict],
        ...
        **Integration-specific behaviour**
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.accounting_bank_account, True, True, "json", OptionalNullable[shared.AccountingBankAccount]),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="create-bank-account", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreateBankAccountResponse])
    ...
    def get_create_update_model(
        self, *,
        request: Union[operations.GetCreateUpdateBankAccountsModelRequest, operations.GetCreateUpdateBankAccountsModelRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreateUpdateBankAccountsModelRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-create-update-bankAccounts-model", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
