...
class BillPayments(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingBillPaymentRequest, operations.GetAccountingBillPaymentRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBillPayment]:
        r"""Get bill payment
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingBillPaymentRequest)
        request = cast(operations.GetAccountingBillPaymentRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-bill-payment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBillPayment])
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingBillPaymentsRequest, operations.ListAccountingBillPaymentsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBillPayments]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingBillPaymentsRequest)
        request = cast(operations.ListAccountingBillPaymentsRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-bill-payments", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBillPayments])
