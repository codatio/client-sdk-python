...
class Liabilities(BaseSDK):
    ...
    def generate_loan_summary(
        self, *,
        request: Union[operations.GenerateLoanSummaryRequest, operations.GenerateLoanSummaryRequestTypedDict],
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="generate-loan-summary", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def generate_loan_transactions(
        self, *,
        request: Union[operations.GenerateLoanTransactionsRequest, operations.GenerateLoanTransactionsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ):
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GenerateLoanTransactionsRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="generate-loan-transactions", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def get_loan_summary(
        self, *,
        request: Union[operations.GetLoanSummaryRequest, operations.GetLoanSummaryRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-loan-summary", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
    ...
    def list_loan_transactions(
        self, *,
        request: Union[operations.ListLoanTransactionsRequest, operations.ListLoanTransactionsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-loan-transactions", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["400","401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.LoanTransactions])
        if utils.match_response(http_res, ["400","401","402","403","404","429","500","503"], "application/json"):
            data = utils.unmarshal_json(http_res.text, errors.ErrorMessageData)
            raise errors.ErrorMessage(data=data)
        if utils.match_response(http_res, ["4XX","5XX"], "*"):
