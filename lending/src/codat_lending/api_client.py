...
from codat_lending.api_response import ApiResponse, T as ApiResponseT
import codat_lending.models
from codat_lending import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(codat_lending.models, klass)
