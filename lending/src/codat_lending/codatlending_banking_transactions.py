...
class CodatLendingBankingTransactions(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetBankingTransactionRequest, operations.GetBankingTransactionRequestTypedDict],
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-banking-transaction", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.BankingTransaction])
    ...
    def list(
        self, *,
        request: Union[operations.ListBankingTransactionsRequest, operations.ListBankingTransactionsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListBankingTransactionsRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-banking-transactions", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.BankingTransactions])
