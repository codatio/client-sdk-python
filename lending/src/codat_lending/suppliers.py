...
class Suppliers(BaseSDK):
    ...
    def download_attachment(
        self, *,
        request: Union[operations.DownloadAccountingSupplierAttachmentRequest, operations.DownloadAccountingSupplierAttachmentRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.DownloadAccountingSupplierAttachmentRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="download-accounting-supplier-attachment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingSupplierRequest, operations.GetAccountingSupplierRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-supplier", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingSupplier])
    ...
    def get_attachment(
        self, *,
        request: Union[operations.GetAccountingSupplierAttachmentRequest, operations.GetAccountingSupplierAttachmentRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingSupplierAttachmentRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-supplier-attachment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingSuppliersRequest, operations.ListAccountingSuppliersRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingSuppliersRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-suppliers", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingSuppliers])
    ...
    def list_attachments(
        self, *,
        request: Union[operations.ListAccountingSupplierAttachmentsRequest, operations.ListAccountingSupplierAttachmentsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingSupplierAttachmentsRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-supplier-attachments", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["401","402","403","404","409","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
