...
class CategorizedStatement(BaseSDK):
    
    
    def get(
        self, *,
        request: Union[operations.GetCategorizedBankStatementRequest, operations.GetCategorizedBankStatementRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCategorizedBankStatementRequest)
        request = cast(operations.GetCategorizedBankStatementRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-categorized-bank-statement", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.EnhancedCashFlowTransactions])
