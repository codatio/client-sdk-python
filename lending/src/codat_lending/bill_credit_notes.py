...
class BillCreditNotes(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingBillCreditNoteRequest, operations.GetAccountingBillCreditNoteRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBillCreditNote]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingBillCreditNoteRequest)
        request = cast(operations.GetAccountingBillCreditNoteRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-bill-credit-note", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBillCreditNote])
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingBillCreditNotesRequest, operations.ListAccountingBillCreditNotesRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBillCreditNotes]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingBillCreditNotesRequest)
        request = cast(operations.ListAccountingBillCreditNotesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-bill-credit-notes", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBillCreditNotes])
