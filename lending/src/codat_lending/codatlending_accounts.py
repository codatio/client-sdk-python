...
class CodatLendingAccounts(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetBankingAccountRequest,
            operations.GetBankingAccountRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.BankingAccount, http_res)
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListBankingAccountsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.BankingAccounts, http_res)
        if utils.match_response(
            http_res,
