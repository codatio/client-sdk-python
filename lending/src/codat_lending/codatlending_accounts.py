...
class CodatLendingAccounts(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetBankingAccountRequest, operations.GetBankingAccountRequestTypedDict],
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-banking-account", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.BankingAccount])
    ...
    def list(
        self, *,
        request: Union[operations.ListBankingAccountsRequest, operations.ListBankingAccountsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-banking-accounts", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.BankingAccounts])
