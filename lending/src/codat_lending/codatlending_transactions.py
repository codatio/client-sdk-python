...
class CodatLendingTransactions(BaseSDK):
    
    
    def get(
        self, *,
        request: Union[operations.GetCommerceTransactionRequest, operations.GetCommerceTransactionRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceTransaction]:
        r"""Get transaction
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCommerceTransactionRequest)
        request = cast(operations.GetCommerceTransactionRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-transaction", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceTransaction])
    ...
    def list(
        self, *,
        request: Union[operations.ListCommerceTransactionsRequest, operations.ListCommerceTransactionsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceTransactions]:
        r"""List transactions
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListCommerceTransactionsRequest)
        request = cast(operations.ListCommerceTransactionsRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-commerce-transactions", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceTransactions])
