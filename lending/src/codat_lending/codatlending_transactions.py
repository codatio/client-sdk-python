...
class CodatLendingTransactions(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetCommerceTransactionRequest,
            operations.GetCommerceTransactionRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.CommerceTransaction, http_res)
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListCommerceTransactionsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.CommerceTransactions, http_res)
        if utils.match_response(
            http_res,
