...
class Orders(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetCommerceOrderRequest, operations.GetCommerceOrderRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceOrder]:
        r"""Get order
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCommerceOrderRequest)
        request = cast(operations.GetCommerceOrderRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-order", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceOrder])
    ...
    def list(
        self, *,
        request: Union[operations.ListCommerceOrdersRequest, operations.ListCommerceOrdersRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceOrders]:
        r"""List orders
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListCommerceOrdersRequest)
        request = cast(operations.ListCommerceOrdersRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-commerce-orders", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceOrders])
