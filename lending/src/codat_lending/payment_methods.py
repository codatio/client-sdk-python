...
class PaymentMethods(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetCommercePaymentMethodRequest,
            operations.GetCommercePaymentMethodRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.CommercePaymentMethod, http_res)
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListCommercePaymentMethodsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.CommercePaymentMethods, http_res)
        if utils.match_response(
            http_res,
