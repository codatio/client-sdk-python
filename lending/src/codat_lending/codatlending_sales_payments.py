...
class CodatLendingSalesPayments(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetCommercePaymentRequest, operations.GetCommercePaymentRequestTypedDict],
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-payment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def list(
        self, *,
        request: Union[operations.ListCommercePaymentsRequest, operations.ListCommercePaymentsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-commerce-payments", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommercePayments])
