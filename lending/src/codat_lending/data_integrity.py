...
class DataIntegrity(BaseSDK):
    ...
    def details(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.DataIntegrityDetails, http_res)
    ...
    def status(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.DataIntegrityStatuses, http_res)
        if utils.match_response(
    ...
    def summaries(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.DataIntegritySummaries, http_res)
        if utils.match_response(
            http_res, ["400", "401", "402", "403", "404", "429"], "application/json"
        ):
            response_data = unmarshal_json_response(errors.ErrorMessageData, http_res)
