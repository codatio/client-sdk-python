...
class CodatLendingAccountingBankData(BaseSDK):
    ...
    def _init_sdks(self):
        self.accounts = Accounts(self.sdk_configuration, parent_ref=self.parent_ref)
    ...
    def list_transactions(
        ...
        *,
        request: Union[
            ...
            operations.ListAccountingBankAccountTransactionsRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingBankTransactions, http_res)
