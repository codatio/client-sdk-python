...
from codat_lending.accounts import Accounts
...
class CodatLendingAccountingBankData(BaseSDK):
    ...
    def list_transactions(
        self, *,
        request: Union[operations.ListAccountingBankAccountTransactionsRequest, operations.ListAccountingBankAccountTransactionsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBankTransactions]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingBankAccountTransactionsRequest)
        request = cast(operations.ListAccountingBankAccountTransactionsRequest, request)
        
        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/connections/{connectionId}/data/bankAccounts/{accountId}/bankTransactions",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-bank-account-transactions", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBankTransactions])
