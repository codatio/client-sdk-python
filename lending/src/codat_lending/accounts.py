...
class Accounts(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingBankAccountRequest, operations.GetAccountingBankAccountRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBankAccount]:
        r"""Get bank account
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingBankAccountRequest)
        request = cast(operations.GetAccountingBankAccountRequest, request)
        
        req = self.build_request(
            method="GET",
            path="/companies/{companyId}/connections/{connectionId}/data/bankAccounts/{accountId}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-bank-account", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBankAccount])
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingBankAccountsRequest, operations.ListAccountingBankAccountsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingBankAccounts]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingBankAccountsRequest)
        request = cast(operations.ListAccountingBankAccountsRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-bank-accounts", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingBankAccounts])
