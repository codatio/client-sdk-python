...
class ManageData(BaseSDK):
    ...
    def get_status(
        self, *,
        request: Union[operations.GetDataStatusRequest, operations.GetDataStatusRequestTypedDict],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[operations.GetDataStatusDataStatuses])
