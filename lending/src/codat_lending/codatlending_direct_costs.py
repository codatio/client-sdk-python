...
class CodatLendingDirectCosts(BaseSDK):
    ...
    def download_attachment(
        self, *,
        request: Union[operations.DownloadAccountingDirectCostAttachmentRequest, operations.DownloadAccountingDirectCostAttachmentRequestTypedDict],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.DownloadAccountingDirectCostAttachmentRequest)
        request = cast(operations.DownloadAccountingDirectCostAttachmentRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="download-accounting-direct-cost-attachment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingDirectCostRequest, operations.GetAccountingDirectCostRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingDirectCostRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-direct-cost", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingDirectCost])
    ...
    def get_attachment(
        self, *,
        request: Union[operations.GetAccountingDirectCostAttachmentRequest, operations.GetAccountingDirectCostAttachmentRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingDirectCostAttachmentRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-direct-cost-attachment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["401","402","403","404","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingDirectCostsRequest, operations.ListAccountingDirectCostsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingDirectCostsRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-direct-costs", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingDirectCosts])
    ...
    def list_attachments(
        self, *,
        request: Union[operations.ListAccountingDirectCostAttachmentsRequest, operations.ListAccountingDirectCostAttachmentsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingDirectCostAttachmentsRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-direct-cost-attachments", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
            error_status_codes=["401","402","403","404","409","429","4XX","500","503","5XX"],
            retry_config=retry_config
        )
