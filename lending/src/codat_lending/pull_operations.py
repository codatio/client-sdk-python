...
class PullOperations(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetPullOperationRequest, operations.GetPullOperationRequestTypedDict],
    ...
    def list(
        self, *,
        request: Union[operations.ListPullOperationsRequest, operations.ListPullOperationsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
