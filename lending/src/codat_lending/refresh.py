...
class Refresh(BaseSDK):
    ...
    def all_data_types(
        self, *,
        request: Union[operations.RefreshAllDataTypesRequest, operations.RefreshAllDataTypesRequestTypedDict],
    ...
    def data_type(
        self, *,
        request: Union[operations.RefreshDataTypeRequest, operations.RefreshDataTypeRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
