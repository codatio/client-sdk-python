...
class Disputes(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetCommerceDisputeRequest, operations.GetCommerceDisputeRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceDispute]:
        r"""Get dispute
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCommerceDisputeRequest)
        request = cast(operations.GetCommerceDisputeRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-dispute", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceDispute])
    ...
    def list(
        self, *,
        request: Union[operations.ListCommerceDisputesRequest, operations.ListCommerceDisputesRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceDisputes]:
        r"""List disputes
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListCommerceDisputesRequest)
        request = cast(operations.ListCommerceDisputesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-commerce-disputes", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceDisputes])
