...
class Disputes(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetCommerceDisputeRequest,
            operations.GetCommerceDisputeRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.CommerceDispute, http_res)
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListCommerceDisputesRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.CommerceDisputes, http_res)
        if utils.match_response(
            http_res,
