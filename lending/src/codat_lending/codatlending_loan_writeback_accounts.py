...
class CodatLendingLoanWritebackAccounts(BaseSDK):
    
    
    def create(
        self, *,
        request: Union[operations.CreateAccountRequest, operations.CreateAccountRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingCreateAccountResponse]:
        r"""Create account
        ...
        **Integration-specific behaviour**
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.account_prototype, False, True, "json", Optional[shared.AccountPrototype]),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreateAccountResponse])
    ...
    def get_create_model(
        self, *,
        request: Union[operations.GetCreateChartOfAccountsModelRequest, operations.GetCreateChartOfAccountsModelRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreateChartOfAccountsModelRequest)
