...
class AccountTransactions(BaseSDK):
    
    
    def get(
        self, *,
        request: Union[operations.GetAccountingAccountTransactionRequest, operations.GetAccountingAccountTransactionRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingAccountTransaction]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingAccountTransactionRequest)
        request = cast(operations.GetAccountingAccountTransactionRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-account-transaction", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingAccountTransaction])
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingAccountTransactionsRequest, operations.ListAccountingAccountTransactionsRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingAccountTransactions]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingAccountTransactionsRequest)
        request = cast(operations.ListAccountingAccountTransactionsRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-account-transactions", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingAccountTransactions])
