...
class AccountTransactions(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetAccountingAccountTransactionRequest,
            operations.GetAccountingAccountTransactionRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[shared.AccountingAccountTransaction]
            )
    ...
    def list(
        ...
        *,
        request: Union[
            operations.ListAccountingAccountTransactionsRequest,
            operations.ListAccountingAccountTransactionsRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, Optional[shared.AccountingAccountTransactions]
            )
        if utils.match_response(
            http_res,
