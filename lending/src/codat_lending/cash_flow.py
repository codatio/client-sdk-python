...
class CashFlow(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingCashFlowStatementRequest, operations.GetAccountingCashFlowStatementRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingCashFlowStatement]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingCashFlowStatementRequest)
        request = cast(operations.GetAccountingCashFlowStatementRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-cash-flow-statement", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCashFlowStatement])
