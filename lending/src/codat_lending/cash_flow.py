...
class CashFlow(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetAccountingCashFlowStatementRequest,
            operations.GetAccountingCashFlowStatementRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingCashFlowStatement, http_res)
