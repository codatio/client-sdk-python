...
class CodatLendingTransfers(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetAccountingTransferRequest,
            operations.GetAccountingTransferRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingTransfer, http_res)
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListAccountingTransfersRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingTransfers, http_res)
        if utils.match_response(
            http_res,
