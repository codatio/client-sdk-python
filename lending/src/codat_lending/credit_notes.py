...
class CreditNotes(BaseSDK):
    def get(
        ...
        *,
        request: Union[
            operations.GetAccountingCreditNoteRequest,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingCreditNote, http_res)
    ...
    def list(
        ...
        *,
        request: Union[
            ...
            operations.ListAccountingCreditNotesRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingCreditNotes, http_res)
        if utils.match_response(
            http_res,
