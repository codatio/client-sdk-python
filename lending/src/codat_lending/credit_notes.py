...
class CreditNotes(BaseSDK):
    ...
    def get(
        self, *,
        request: Union[operations.GetAccountingCreditNoteRequest, operations.GetAccountingCreditNoteRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingCreditNote]:
        r"""Get credit note
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetAccountingCreditNoteRequest)
        request = cast(operations.GetAccountingCreditNoteRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-accounting-credit-note", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreditNote])
    ...
    def list(
        self, *,
        request: Union[operations.ListAccountingCreditNotesRequest, operations.ListAccountingCreditNotesRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingCreditNotes]:
        r"""List credit notes
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListAccountingCreditNotesRequest)
        request = cast(operations.ListAccountingCreditNotesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-accounting-credit-notes", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreditNotes])
