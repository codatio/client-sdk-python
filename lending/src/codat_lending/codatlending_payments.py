...
class CodatLendingPayments(BaseSDK):
    def create(
        ...
        *,
        request: Union[
            operations.CreatePaymentRequest, operations.CreatePaymentRequestTypedDict
        ],
        ...
        **Integration-specific behavior**
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.accounting_payment if request is not None else None,
                True,
                True,
                "json",
                OptionalNullable[shared.AccountingPayment],
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                shared.AccountingCreatePaymentResponse, http_res
            )
    ...
    def get_create_model(
        ...
        *,
        request: Union[
            operations.GetCreatePaymentModelRequest,
            operations.GetCreatePaymentModelRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
