...
class CodatLendingPayments(BaseSDK):
    
    
    def create(
        self, *,
        request: Union[operations.CreatePaymentRequest, operations.CreatePaymentRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingCreatePaymentResponse]:
        r"""Create payment
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.CreatePaymentRequest)
        request = cast(operations.CreatePaymentRequest, request)
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.accounting_payment, True, True, "json", OptionalNullable[shared.AccountingPayment]),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="create-payment", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreatePaymentResponse])
    ...
    def get_create_model(
        self, *,
        request: Union[operations.GetCreatePaymentModelRequest, operations.GetCreatePaymentModelRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreatePaymentModelRequest)
        request = cast(operations.GetCreatePaymentModelRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-create-payment-model", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
