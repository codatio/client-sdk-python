...
class ProductCategories(BaseSDK):
    
    
    def get(
        self, *,
        request: Union[operations.GetCommerceProductCategoryRequest, operations.GetCommerceProductCategoryRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceProductCategory]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCommerceProductCategoryRequest)
        request = cast(operations.GetCommerceProductCategoryRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-commerce-product-category", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceProductCategory])
    ...
    def list(
        self, *,
        request: Union[operations.ListCommerceProductCategoriesRequest, operations.ListCommerceProductCategoriesRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.CommerceProductCategories]:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.ListCommerceProductCategoriesRequest)
        request = cast(operations.ListCommerceProductCategoriesRequest, request)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="list-commerce-product-categories", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.CommerceProductCategories])
