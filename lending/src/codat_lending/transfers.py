...
class Transfers(BaseSDK):
    ...
    def create(
        self, *,
        request: Union[operations.CreateTransferRequest, operations.CreateTransferRequestTypedDict],
        ...
        **Integration-specific behaviour**
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.accounting_transfer, True, True, "json", OptionalNullable[shared.AccountingTransfer]),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="create-transfer", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreateTransferResponse])
    ...
    def get_create_model(
        self, *,
        request: Union[operations.GetCreateTransfersModelRequest, operations.GetCreateTransfersModelRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreateTransfersModelRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-create-transfers-model", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
