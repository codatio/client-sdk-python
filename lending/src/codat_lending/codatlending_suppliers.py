...
class CodatLendingSuppliers(BaseSDK):
    
    
    def create(
        self, *,
        request: Union[operations.CreateSupplierRequest, operations.CreateSupplierRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[shared.AccountingCreateSupplierResponse]:
        r"""Create supplier
        ...
        **Integration-specific behaviour**
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(request.accounting_supplier, True, True, "json", OptionalNullable[shared.AccountingSupplier]),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, Optional[shared.AccountingCreateSupplierResponse])
    ...
    def get_create_update_model(
        self, *,
        request: Union[operations.GetCreateUpdateSuppliersModelRequest, operations.GetCreateUpdateSuppliersModelRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        **Integration-specific behaviour**
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, operations.GetCreateUpdateSuppliersModelRequest)
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(operation_id="get-create-update-suppliers-model", oauth2_scopes=[], security_source=self.sdk_configuration.security),
            request=req,
