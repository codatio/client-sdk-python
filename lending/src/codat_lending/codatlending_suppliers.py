...
class CodatLendingSuppliers(BaseSDK):
    ...
    ) -> shared.AccountingCreateSupplierResponse:
        r"""Create supplier
        ...
        **Integration-specific behavior**
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.accounting_supplier if request is not None else None,
                True,
                True,
                "json",
                OptionalNullable[shared.AccountingSupplier],
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                shared.AccountingCreateSupplierResponse, http_res
            )
