...
class CompanyInfo(BaseSDK):
    ...
    def get_accounting_profile(
        ...
        *,
        request: Union[
            ...
            operations.GetAccountingProfileRequestTypedDict,
        ],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.AccountingCompanyInfo, http_res)
    ...
    def get_commerce_profile(
        ...
        *,
        request: Union[
            operations.GetCommerceProfileRequest,
            operations.GetCommerceProfileRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.CommerceCompanyInfo, http_res)
        if utils.match_response(
            http_res, ["401", "402", "403", "404", "409", "429"], "application/json"
        ):
            response_data = unmarshal_json_response(errors.ErrorMessageData, http_res)
