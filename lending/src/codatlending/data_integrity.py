...
class DataIntegrity:
    ...
    def details(self, request: operations.ListDataIntegrityDetailsRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListDataIntegrityDetailsResponse:
        ...
        def next_func() -> Optional[operations.ListDataIntegrityDetailsResponse]:
        ...
        res = operations.ListDataIntegrityDetailsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
