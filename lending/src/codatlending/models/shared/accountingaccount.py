...
class AccountingAccountValidDataTypeLinks:
    ...
    links: Optional[List[str]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('links'), 'exclude': lambda f: f is AccountingAccountValidDataTypeLinks.UNSET }})
    r"""Supported `dataTypes` that the record can be linked to."""
    property: Optional[str] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('property'), 'exclude': lambda f: f is AccountingAccountValidDataTypeLinks.UNSET }})
...
class AccountingAccount:
    ...
    * Equity.
    ...
    r"""Type of account"""
    valid_datatype_links: Optional[List[AccountingAccountValidDataTypeLinks]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('validDatatypeLinks'), 'exclude': lambda f: f is AccountingAccount.UNSET }})
