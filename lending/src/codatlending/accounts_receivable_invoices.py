...
class AccountsReceivableInvoices:
    ...
    def list_reconciled(self, request: operations.ListReconciledInvoicesRequest, retries: Optional[utils.RetryConfig] = None) -> operations.ListReconciledInvoicesResponse:
        ...
        def next_func() -> Optional[operations.ListReconciledInvoicesResponse]:
            body = utils.unmarshal_json(http_res.text, Dict[Any, Any])
            page = request.page
            new_page = page + 1
        ...
        res = operations.ListReconciledInvoicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res, next=next_func)
