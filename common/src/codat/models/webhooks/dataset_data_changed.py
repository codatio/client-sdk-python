...
class DatasetDataChangedDatasetDataChangedWebhook:
    ...
    data: Optional[DatasetDataChangedDatasetDataChangedWebhookData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data'), 'exclude': lambda f: f is None }})
