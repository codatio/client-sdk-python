...
class DatasetDataChangedResponse:
...
@dataclasses.dataclass
class DatasetDataChangedDatasetDataChangedWebhookData:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class DatasetDataChangedDatasetDataChangedWebhook:
    r"""DatasetDataChangedDatasetDataChangedWebhook
    ...
    data: Optional[DatasetDataChangedDatasetDataChangedWebhookData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class DatasetDataChangedRequest:
    request: Optional[DatasetDataChangedDatasetDataChangedWebhook] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
