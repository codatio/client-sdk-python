...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListCompanyConnectionsConnectionsLinksHypertextReference:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListCompanyConnectionsConnectionsLinks:
    
    current: ListCompanyConnectionsConnectionsLinksHypertextReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('current') }})  
    self_: ListCompanyConnectionsConnectionsLinksHypertextReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('self') }})  
    next: Optional[ListCompanyConnectionsConnectionsLinksHypertextReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('next'), 'exclude': lambda f: f is None }})  
    previous: Optional[ListCompanyConnectionsConnectionsLinksHypertextReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('previous'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListCompanyConnectionsConnectionsConnectionConnectionInfo:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListCompanyConnectionsConnectionsConnectionDataConnectionErrors:
...
class ListCompanyConnectionsConnectionsConnectionSourceTypeEnum(str, Enum):
...
class ListCompanyConnectionsConnectionsConnectionDataConnectionStatusEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListCompanyConnectionsConnectionsConnection:
    ...
    source_type: ListCompanyConnectionsConnectionsConnectionSourceTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceType') }})
    r"""The type of platform of the connection."""  
    status: ListCompanyConnectionsConnectionsConnectionDataConnectionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""The current authorization status of the data connection."""  
    connection_info: Optional[ListCompanyConnectionsConnectionsConnectionConnectionInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connectionInfo'), 'exclude': lambda f: f is None }})  
    data_connection_errors: Optional[list[ListCompanyConnectionsConnectionsConnectionDataConnectionErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataConnectionErrors'), 'exclude': lambda f: f is None }})  
...
class Connections:
    ...
    results: Optional[list[ListCompanyConnectionsConnectionsConnection]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
