...
class GetInvoiceAttachmentsAttachments:
    attachments: Optional[list[GetInvoiceAttachmentsAttachmentsAttachment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attachments') }})
