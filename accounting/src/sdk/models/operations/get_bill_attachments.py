...
class GetBillAttachmentsAttachments:
    attachments: Optional[list[GetBillAttachmentsAttachmentsAttachment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attachments') }})
