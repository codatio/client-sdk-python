...
class GetBankAccountSourceModifiedDate:
    ...
    * The sort code and account number.
    ...
    account_type: Optional[GetBankAccountSourceModifiedDateAccountTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('accountType') }})
    ...
    metadata: Optional[GetBankAccountSourceModifiedDateMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('metadata') }})
