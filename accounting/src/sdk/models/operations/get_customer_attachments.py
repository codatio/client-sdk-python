...
class GetCustomerAttachmentsAttachments:
    attachments: Optional[list[GetCustomerAttachmentsAttachmentsAttachment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attachments') }})
