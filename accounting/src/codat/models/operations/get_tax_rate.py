...
@dataclasses.dataclass
class GetTaxRate200ApplicationJSONTaxRateComponent:
...
class GetTaxRate200ApplicationJSON:
    ...
    components: Optional[list[GetTaxRate200ApplicationJSONTaxRateComponent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('components'), 'exclude': lambda f: f is None }})  
