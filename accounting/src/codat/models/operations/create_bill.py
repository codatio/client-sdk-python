...
class CreateBillPathParams:
    company_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'companyId', 'style': 'simple', 'explode': False }})
    connection_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'connectionId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class CreateBillQueryParams:
...
class CreateBillRequest:
    path_params: CreateBillPathParams = dataclasses.field()
    query_params: CreateBillQueryParams = dataclasses.field()
    request: Optional[CreateBillSourceModifiedDate] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
