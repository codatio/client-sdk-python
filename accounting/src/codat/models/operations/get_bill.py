...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBillSourceModifiedDatePurchaseOrderRef:
...
class GetBillSourceModifiedDate:
    ...
    * What the bill is for — the *line items*.
    ...
    purchase_order_refs: Optional[list[GetBillSourceModifiedDatePurchaseOrderRef]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('purchaseOrderRefs'), 'exclude': lambda f: f is None }})  
    reference: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reference'), 'exclude': lambda f: f is None }})
