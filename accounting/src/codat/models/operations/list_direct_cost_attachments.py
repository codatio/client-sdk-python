...
@dataclasses.dataclass
class ListDirectCostAttachmentsAttachmentsAttachmentModifiedDate:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListDirectCostAttachmentsAttachmentsAttachmentSourceModifiedDate:
...
class ListDirectCostAttachmentsAttachmentsAttachment:
    ...
    modified_date: Optional[ListDirectCostAttachmentsAttachmentsAttachmentModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modifiedDate'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})  
    source_modified_date: Optional[ListDirectCostAttachmentsAttachmentsAttachmentSourceModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceModifiedDate'), 'exclude': lambda f: f is None }})  
