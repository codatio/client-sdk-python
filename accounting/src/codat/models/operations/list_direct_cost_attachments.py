...
@dataclasses.dataclass
class ListDirectCostAttachmentsSecurity:
...
class ListDirectCostAttachmentsRequest:
    ...
    security: ListDirectCostAttachmentsSecurity = dataclasses.field()
...
class ListDirectCostAttachmentsAttachments:
    attachments: Optional[list[ListDirectCostAttachmentsAttachmentsAttachment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attachments'), 'exclude': lambda f: f is None }})
