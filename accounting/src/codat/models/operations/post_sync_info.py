...
class PostSyncInfo200ApplicationJSON:
    ...
    status: PostSyncInfo200ApplicationJSONStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    ...
    validationinformation_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('validationinformationUrl'), 'exclude': lambda f: f is None }})
