...
class CreateJournalEntryPathParams:
    company_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'companyId', 'style': 'simple', 'explode': False }})
    connection_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'connectionId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class CreateJournalEntryQueryParams:
...
class CreateJournalEntryRequest:
    path_params: CreateJournalEntryPathParams = dataclasses.field()
    query_params: CreateJournalEntryQueryParams = dataclasses.field()
    request: Optional[CreateJournalEntrySourceModifiedDate] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
