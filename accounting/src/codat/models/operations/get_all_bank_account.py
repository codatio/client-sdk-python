...
@dataclasses.dataclass
class GetAllBankAccount200ApplicationJSONModifiedDate:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetAllBankAccount200ApplicationJSONSourceModifiedDate:
...
class GetAllBankAccount200ApplicationJSON:
    ...
    modified_date: Optional[GetAllBankAccount200ApplicationJSONModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modifiedDate'), 'exclude': lambda f: f is None }})  
    ...
    source_modified_date: Optional[GetAllBankAccount200ApplicationJSONSourceModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceModifiedDate'), 'exclude': lambda f: f is None }})  
