...
@dataclasses.dataclass
class GetSupplierAttachmentAttachmentModifiedDate:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetSupplierAttachmentAttachmentSourceModifiedDate:
...
class GetSupplierAttachmentAttachment:
    ...
    modified_date: Optional[GetSupplierAttachmentAttachmentModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modifiedDate'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})  
    source_modified_date: Optional[GetSupplierAttachmentAttachmentSourceModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceModifiedDate'), 'exclude': lambda f: f is None }})  
