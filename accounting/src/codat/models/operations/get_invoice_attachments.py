...
@dataclasses.dataclass
class GetInvoiceAttachmentsAttachmentsAttachmentModifiedDate:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetInvoiceAttachmentsAttachmentsAttachmentSourceModifiedDate:
...
class GetInvoiceAttachmentsAttachmentsAttachment:
    ...
    modified_date: Optional[GetInvoiceAttachmentsAttachmentsAttachmentModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modifiedDate'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""Name of the attachment file."""  
    source_modified_date: Optional[GetInvoiceAttachmentsAttachmentsAttachmentSourceModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceModifiedDate'), 'exclude': lambda f: f is None }})  
