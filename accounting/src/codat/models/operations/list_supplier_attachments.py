...
class ListSupplierAttachmentsAttachments:
    attachments: Optional[list[ListSupplierAttachmentsAttachmentsAttachment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attachments'), 'exclude': lambda f: f is None }})
