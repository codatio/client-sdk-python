...
@dataclasses.dataclass
class ListDirectIncomeAttachmentsAttachmentsAttachmentModifiedDate:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListDirectIncomeAttachmentsAttachmentsAttachmentSourceModifiedDate:
...
class ListDirectIncomeAttachmentsAttachmentsAttachment:
    ...
    modified_date: Optional[ListDirectIncomeAttachmentsAttachmentsAttachmentModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modifiedDate'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})  
    source_modified_date: Optional[ListDirectIncomeAttachmentsAttachmentsAttachmentSourceModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceModifiedDate'), 'exclude': lambda f: f is None }})  
