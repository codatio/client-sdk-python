...
class CreatePurchaseOrderPathParams:
    company_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'companyId', 'style': 'simple', 'explode': False }})
    connection_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'connectionId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class CreatePurchaseOrderQueryParams:
...
class CreatePurchaseOrderRequest:
    path_params: CreatePurchaseOrderPathParams = dataclasses.field()
    query_params: CreatePurchaseOrderQueryParams = dataclasses.field()
    request: Optional[CreatePurchaseOrderSourceModifiedDate] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
