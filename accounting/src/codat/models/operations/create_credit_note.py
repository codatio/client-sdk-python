...
class CreateCreditNote200ApplicationJSONDataTypeEnum(str, Enum):
...
class CreateCreditNote200ApplicationJSON:
    ...
    * Which customers the credit notes have been issued to.
    """  
    data_type: Optional[CreateCreditNote200ApplicationJSONDataTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataType'), 'exclude': lambda f: f is None }})
    r"""The type of data being pushed, eg invoices, customers."""  
