...
class GetBillAttachmentsRequest:
    ...
    security: GetBillAttachmentsSecurity = dataclasses.field()
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBillAttachmentsAttachmentsAttachment:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBillAttachmentsAttachments:
    attachments: Optional[list[GetBillAttachmentsAttachmentsAttachment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attachments'), 'exclude': lambda f: f is None }})
    

@dataclasses.dataclass
class GetBillAttachmentsResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    attachments: Optional[GetBillAttachmentsAttachments] = dataclasses.field(default=None)
