...
@dataclasses.dataclass
class GetCustomerAttachmentAttachmentModifiedDate:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetCustomerAttachmentAttachmentSourceModifiedDate:
...
class GetCustomerAttachmentAttachment:
    ...
    modified_date: Optional[GetCustomerAttachmentAttachmentModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modifiedDate'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})  
    source_modified_date: Optional[GetCustomerAttachmentAttachmentSourceModifiedDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceModifiedDate'), 'exclude': lambda f: f is None }})  
