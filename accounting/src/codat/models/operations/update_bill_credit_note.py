...
class UpdateBillCreditNote200ApplicationJSONChangesPushOperationReferenceDataTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateBillCreditNote200ApplicationJSONChangesPushOperationReference:
    
    data_type: Optional[UpdateBillCreditNote200ApplicationJSONChangesPushOperationReferenceDataTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataType'), 'exclude': lambda f: f is None }})
    r"""Available Data types"""  
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})  
    
class UpdateBillCreditNote200ApplicationJSONChangesPushChangeTypeEnum(str, Enum):
    UNKNOWN = "Unknown"
    CREATED = "Created"
    MODIFIED = "Modified"
    DELETED = "Deleted"
...
class UpdateBillCreditNote200ApplicationJSONChanges:
    ...
    record_ref: Optional[UpdateBillCreditNote200ApplicationJSONChangesPushOperationReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recordRef'), 'exclude': lambda f: f is None }})  
    type: Optional[UpdateBillCreditNote200ApplicationJSONChangesPushChangeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class UpdateBillCreditNote200ApplicationJSONDataTypeEnum(str, Enum):
...
class UpdateBillCreditNote200ApplicationJSONPushOperationStatusEnum(str, Enum):
...
class UpdateBillCreditNote200ApplicationJSON:
    ...
    status: UpdateBillCreditNote200ApplicationJSONPushOperationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""The status of the push operation."""  
    ...
    * The supplier that issued the bill credit note.
    """  
    data_type: Optional[UpdateBillCreditNote200ApplicationJSONDataTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataType'), 'exclude': lambda f: f is None }})
    r"""The type of data being pushed, eg invoices, customers."""  
