...
@dataclasses.dataclass
class ListJournals409ApplicationJSON:
...
class ListJournalsResponse:
    ...
    journals: Optional[shared_journals.Journals] = dataclasses.field(default=None)
    r"""Success"""
    list_journals_409_application_json_object: Optional[ListJournals409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
