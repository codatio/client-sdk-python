...
@dataclasses.dataclass
class ListCustomers409ApplicationJSON:
...
class ListCustomersResponse:
    ...
    r"""Success"""
    list_customers_409_application_json_object: Optional[ListCustomers409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
