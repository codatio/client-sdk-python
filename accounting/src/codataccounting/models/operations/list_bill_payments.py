...
from ..shared import billpayments as shared_billpayments
...
@dataclasses.dataclass
class ListBillPayments409ApplicationJSON:
...
class ListBillPaymentsResponse:
    ...
    bill_payments: Optional[shared_billpayments.BillPayments] = dataclasses.field(default=None)
    r"""Success"""
    list_bill_payments_409_application_json_object: Optional[ListBillPayments409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
