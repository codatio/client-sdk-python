...
@dataclasses.dataclass
class ListBillCreditNotes409ApplicationJSON:
...
class ListBillCreditNotesResponse:
    ...
    r"""Success"""
    list_bill_credit_notes_409_application_json_object: Optional[ListBillCreditNotes409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
