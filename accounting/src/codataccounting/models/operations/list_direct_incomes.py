...
class ListDirectIncomesRequest:
...
@dataclasses.dataclass
class ListDirectIncomes409ApplicationJSON:
...
class ListDirectIncomesResponse:
    ...
    r"""Success"""
    list_direct_incomes_409_application_json_object: Optional[ListDirectIncomes409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
