...
@dataclasses.dataclass
class GetBalanceSheet409ApplicationJSON:
...
class GetBalanceSheetResponse:
    ...
    r"""Success"""
    get_balance_sheet_409_application_json_object: Optional[GetBalanceSheet409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
