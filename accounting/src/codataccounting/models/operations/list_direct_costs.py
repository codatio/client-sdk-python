...
@dataclasses.dataclass
class ListDirectCosts409ApplicationJSON:
...
class ListDirectCostsResponse:
    ...
    r"""Success"""
    list_direct_costs_409_application_json_object: Optional[ListDirectCosts409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
