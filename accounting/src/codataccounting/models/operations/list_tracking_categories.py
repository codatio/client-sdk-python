...
@dataclasses.dataclass
class ListTrackingCategories409ApplicationJSON:
...
class ListTrackingCategoriesResponse:
    ...
    list_tracking_categories_409_application_json_object: Optional[ListTrackingCategories409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)
    schema: Optional[shared_schema.Schema] = dataclasses.field(default=None)
    r"""Your `query` parameter was not correctly formed"""
    tracking_categories: Optional[shared_trackingcategories.TrackingCategories] = dataclasses.field(default=None)
    r"""Success"""
