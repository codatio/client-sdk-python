...
from ..shared import bankaccounts as shared_bankaccounts
...
@dataclasses.dataclass
class ListBankAccounts409ApplicationJSON:
...
class ListBankAccountsResponse:
    ...
    r"""Success"""
    list_bank_accounts_409_application_json_object: Optional[ListBankAccounts409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
