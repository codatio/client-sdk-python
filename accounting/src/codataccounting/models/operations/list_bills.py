...
from ..shared import bills as shared_bills
...
@dataclasses.dataclass
class ListBills409ApplicationJSON:
...
class ListBillsResponse:
    ...
    r"""Success"""
    list_bills_409_application_json_object: Optional[ListBills409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
