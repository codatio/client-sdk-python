...
@dataclasses.dataclass
class ListSuppliers409ApplicationJSON:
...
class ListSuppliersResponse:
    ...
    list_suppliers_409_application_json_object: Optional[ListSuppliers409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
