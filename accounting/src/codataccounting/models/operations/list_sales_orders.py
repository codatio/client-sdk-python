...
from ..shared import salesorders as shared_salesorders
...
@dataclasses.dataclass
class ListSalesOrders409ApplicationJSON:
...
class ListSalesOrdersResponse:
    ...
    list_sales_orders_409_application_json_object: Optional[ListSalesOrders409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)
    sales_orders: Optional[shared_salesorders.SalesOrders] = dataclasses.field(default=None)
    r"""Success"""
