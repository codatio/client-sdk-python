...
@dataclasses.dataclass
class ListPayments409ApplicationJSON:
...
class ListPaymentsResponse:
    ...
    list_payments_409_application_json_object: Optional[ListPayments409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
    payments: Optional[shared_payments.Payments] = dataclasses.field(default=None)
    r"""Success"""
