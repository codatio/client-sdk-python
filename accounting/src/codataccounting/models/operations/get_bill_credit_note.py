...
@dataclasses.dataclass
class GetBillCreditNote409ApplicationJSON:
...
class GetBillCreditNoteResponse:
    ...
    r"""Success"""
    get_bill_credit_note_409_application_json_object: Optional[GetBillCreditNote409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
