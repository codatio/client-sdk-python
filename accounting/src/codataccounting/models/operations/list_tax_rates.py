...
from ..shared import taxrates as shared_taxrates
...
@dataclasses.dataclass
class ListTaxRates409ApplicationJSON:
...
class ListTaxRatesResponse:
    ...
    list_tax_rates_409_application_json_object: Optional[ListTaxRates409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)
    schema: Optional[shared_schema.Schema] = dataclasses.field(default=None)
    r"""Your `query` parameter was not correctly formed"""
    tax_rates: Optional[shared_taxrates.TaxRates] = dataclasses.field(default=None)
    r"""Success"""
