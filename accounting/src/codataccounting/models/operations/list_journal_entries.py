...
from ..shared import journalentries as shared_journalentries
...
@dataclasses.dataclass
class ListJournalEntries409ApplicationJSON:
...
class ListJournalEntriesResponse:
    ...
    journal_entries: Optional[shared_journalentries.JournalEntries] = dataclasses.field(default=None)
    r"""Success"""
    list_journal_entries_409_application_json_object: Optional[ListJournalEntries409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
