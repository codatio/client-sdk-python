...
@dataclasses.dataclass
class ListCreditNotes409ApplicationJSON:
...
class ListCreditNotesResponse:
    ...
    r"""Success"""
    list_credit_notes_409_application_json_object: Optional[ListCreditNotes409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
