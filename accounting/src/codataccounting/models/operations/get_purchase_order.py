...
@dataclasses.dataclass
class GetPurchaseOrder409ApplicationJSON:
...
class GetPurchaseOrderResponse:
    ...
    get_purchase_order_409_application_json_object: Optional[GetPurchaseOrder409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
