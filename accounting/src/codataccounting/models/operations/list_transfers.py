...
from ..shared import transfers as shared_transfers
...
@dataclasses.dataclass
class ListTransfers409ApplicationJSON:
...
class ListTransfersResponse:
    ...
    list_transfers_409_application_json_object: Optional[ListTransfers409ApplicationJSON] = dataclasses.field(default=None)
    r"""The data type's dataset has not been requested or is still syncing."""
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)
    schema: Optional[shared_schema.Schema] = dataclasses.field(default=None)
    r"""Your `query` parameter was not correctly formed"""
    transfers: Optional[shared_transfers.Transfers] = dataclasses.field(default=None)
    r"""Success"""
