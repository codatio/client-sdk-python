...
class PurchaseOrders:
    ...
    def get_purchase_order(self, request: operations.GetPurchaseOrderRequest) -> operations.GetPurchaseOrderResponse:
        ...
        res = operations.GetPurchaseOrderResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetPurchaseOrderSourceModifiedDate])
    ...
    def list_purchase_orders(self, request: operations.ListPurchaseOrdersRequest) -> operations.ListPurchaseOrdersResponse:
        ...
        res = operations.ListPurchaseOrdersResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListPurchaseOrdersLinks])
                res.links = out

        return res

    
    def post_purchase_order(self, request: operations.PostPurchaseOrderRequest) -> operations.PostPurchaseOrderResponse:
        ...
        res = operations.PostPurchaseOrderResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.PostPurchaseOrder200ApplicationJSON])
                res.post_purchase_order_200_application_json_object = out
    ...
    def update_purchase_order(self, request: operations.UpdatePurchaseOrderRequest) -> operations.UpdatePurchaseOrderResponse:
        ...
        res = operations.UpdatePurchaseOrderResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.UpdatePurchaseOrder200ApplicationJSON])
