...
* `get_direct_cost` - Get directCost
* `get_direct_cost_attachment` - Get directCost attachment
* `get_direct_costs` - List directCosts
...
* `download_direct_income_attachment` - Download directIncome attachment
