...
class Integrations(BaseSDK):
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.Integration, http_res)
    ...
    def get_branding(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.Branding, http_res)
        if utils.match_response(
            http_res, ["401", "402", "403", "404", "429"], "application/json"
        ):
            response_data = unmarshal_json_response(errors.ErrorMessageData, http_res)
    ...
    def list(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.Integrations, http_res)
        if utils.match_response(
