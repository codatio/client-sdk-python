...
class ConnectionManagement(BaseSDK):
    ...
    @deprecated("""warning: ** DEPRECATED ** - The endpoint for generating company-specific connection management access tokens has been deprecated.
    ...
    def get(
        ...
        *,
        request: Union[
            ...
            operations.GetConnectionManagementAccessTokenRequestTypedDict,
        ],
        ...
        request = cast(operations.GetConnectionManagementAccessTokenRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                shared.ConnectionManagementAccessToken, http_res
            )
