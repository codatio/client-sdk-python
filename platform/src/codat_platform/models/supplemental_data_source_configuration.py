...
class SupplementalDataSourceConfiguration(BaseModel):
    ...
    """ # noqa: E501
    data_source: Optional[str] = Field(default=None, description="The underlying endpoint of the source system which the configuration is targeting. ", alias="dataSource")
    pull_data: Optional[Dict[str, str]] = Field(default=None, description="The additional properties that are required when pulling records.", alias="pullData")
    push_data: Optional[Dict[str, str]] = Field(default=None, description="The additional properties that are required to create and/or update records.", alias="pushData")
    __properties: ClassVar[List[str]] = ["dataSource", "pullData", "pushData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SupplementalDataSourceConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SupplementalDataSourceConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pullData": obj.get("pullData"),
            "pushData": obj.get("pushData")
        })
        return _obj
...
class SupplementalDataSourceConfigurationTypedDict(TypedDict):
    """TypedDict variant of SupplementalDataSourceConfiguration, for dict-literal request/response inputs."""
    data_source: NotRequired[Optional[str]]
    pull_data: NotRequired[Optional[Dict[str, str]]]
    push_data: NotRequired[Optional[Dict[str, str]]]
