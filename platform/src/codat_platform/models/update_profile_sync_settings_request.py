...
class UpdateProfileSyncSettingsRequest(BaseModel):
    ...
    """ # noqa: E501
    client_id: str = Field(description="Unique identifier for your client in Codat.", alias="clientId")
    settings: List[SyncSetting]
    overrides_defaults: Optional[bool] = Field(default=True, description="Set to `True` if you want to override default [sync settings](https://docs.codat.io/knowledge-base/advanced-sync-settings).", alias="overridesDefaults")
    __properties: ClassVar[List[str]] = ["clientId", "settings", "overridesDefaults"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateProfileSyncSettingsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateProfileSyncSettingsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "settings": [SyncSetting.from_dict(_item) for _item in obj["settings"]] if obj.get("settings") is not None else None,
            "overridesDefaults": obj.get("overridesDefaults") if obj.get("overridesDefaults") is not None else True
        })
        return _obj
...
# Speakeasy compat alias — body class name collides with the
# request-wrapper class name; expose under the Speakeasy-style `Body` name.
...
class UpdateProfileSyncSettingsRequestTypedDict(TypedDict):
    """TypedDict variant of UpdateProfileSyncSettingsRequest, for dict-literal request/response inputs."""
