...
class CompanyWebhook(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": CompanyDetails.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
...
class CompanyWebhookTypedDict(TypedDict):
    """TypedDict variant of CompanyWebhook, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    event_type: NotRequired[Optional[str]]
    generated_date: NotRequired[Optional[str]]
    payload: NotRequired[Optional[CompanyDetailsTypedDict]]
