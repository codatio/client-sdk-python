...
class DataTypeWriteWebhook(BaseModel):
    ...
    payload: Optional[DataTypeWriteWebhookPayload] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataTypeWriteWebhook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataTypeWriteWebhook from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "payload": DataTypeWriteWebhookPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
...
class DataTypeWriteWebhookTypedDict(TypedDict):
    """TypedDict variant of DataTypeWriteWebhook, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    event_type: NotRequired[Optional[str]]
    generated_date: NotRequired[Optional[str]]
    payload: NotRequired[Optional[DataTypeWriteWebhookPayloadTypedDict]]
