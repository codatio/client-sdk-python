...
class ValidationResult(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [ValidationItem1.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "warnings": [ValidationItem1.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None
        })
        return _obj
...
class ValidationResultTypedDict(TypedDict):
    """TypedDict variant of ValidationResult, for dict-literal request/response inputs."""
    errors: NotRequired[Optional[List[ValidationItem1TypedDict]]]
    warnings: NotRequired[Optional[List[ValidationItem1TypedDict]]]
