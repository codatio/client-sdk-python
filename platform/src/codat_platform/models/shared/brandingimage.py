...
class BrandingImage(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrandingImage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrandingImage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "image": ImageReference.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
...
class BrandingImageTypedDict(TypedDict):
    """TypedDict variant of BrandingImage, for dict-literal request/response inputs."""
    image: NotRequired[Optional[ImageReferenceTypedDict]]
