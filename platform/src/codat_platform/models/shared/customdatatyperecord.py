...
class CustomDataTypeRecord(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier of the record.")
    content: Optional[Dict[str, Content]] = Field(default=None, description="Values from the source system for the properties defined in the custom data type configuration.")
    modified_date: Optional[ModifiedDate] = Field(default=None, alias="modifiedDate")
    __properties: ClassVar[List[str]] = ["id", "content", "modifiedDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomDataTypeRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomDataTypeRecord from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "modifiedDate": ModifiedDate.from_dict(obj["modifiedDate"]) if obj.get("modifiedDate") is not None else None
        })
        return _obj
...
class CustomDataTypeRecordTypedDict(TypedDict):
    """TypedDict variant of CustomDataTypeRecord, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    content: NotRequired[Optional[Dict[str, ContentTypedDict]]]
    modified_date: NotRequired[Optional[ModifiedDateTypedDict]]
