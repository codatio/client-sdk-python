...
class WebhookConsumerPrototype(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookConsumerPrototype from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookConsumerPrototype from a dict"""
        if obj is None:
            return None
...
class WebhookConsumerPrototypeTypedDict(TypedDict):
    """TypedDict variant of WebhookConsumerPrototype, for dict-literal request/response inputs."""
