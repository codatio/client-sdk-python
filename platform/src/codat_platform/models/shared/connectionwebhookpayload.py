...
class ConnectionWebhookPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["referenceCompany", "connection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectionWebhookPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectionWebhookPayload from a dict"""
        if obj is None:
            return None
...
class ConnectionWebhookPayloadTypedDict(TypedDict):
    """TypedDict variant of ConnectionWebhookPayload, for dict-literal request/response inputs."""
    reference_company: NotRequired[Optional[CompanyReferenceTypedDict]]
    connection: NotRequired[Optional[ConnectionTypedDict]]
