...
class Branding(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["logo", "button", "sourceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logo": BrandingLogo.from_dict(obj["logo"]) if obj.get("logo") is not None else None,
            "button": BrandingButton.from_dict(obj["button"]) if obj.get("button") is not None else None,
...
class BrandingTypedDict(TypedDict):
    """TypedDict variant of Branding, for dict-literal request/response inputs."""
    logo: NotRequired[Optional[BrandingLogoTypedDict]]
    button: NotRequired[Optional[BrandingButtonTypedDict]]
