...
class ConnectionWebhook(BaseModel):
    ...
    payload: Optional[ConnectionWebhookPayload] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": ConnectionWebhookPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
...
class ConnectionWebhookTypedDict(TypedDict):
    """TypedDict variant of ConnectionWebhook, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    event_type: NotRequired[Optional[str]]
    generated_date: NotRequired[Optional[str]]
    payload: NotRequired[Optional[ConnectionWebhookPayloadTypedDict]]
