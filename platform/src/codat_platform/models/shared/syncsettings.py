...
class SyncSettings(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SyncSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SyncSettings from a dict"""
        if obj is None:
            return None
...
class SyncSettingsTypedDict(TypedDict):
    """TypedDict variant of SyncSettings, for dict-literal request/response inputs."""
