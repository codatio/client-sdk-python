...
class Issue(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[str] = Field(default=None, description="The type of issue.")
    message: Optional[str] = Field(default=None, description="A message describing the issue.")
    links: Optional[IssueLinks] = None
    __properties: ClassVar[List[str]] = ["type", "message", "links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": IssueLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
...
class IssueTypedDict(TypedDict):
    """TypedDict variant of Issue, for dict-literal request/response inputs."""
    type: NotRequired[Optional[str]]
    message: NotRequired[Optional[str]]
    links: NotRequired[Optional[IssueLinksTypedDict]]
