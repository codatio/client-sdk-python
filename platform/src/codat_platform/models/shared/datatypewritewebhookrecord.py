...
class DataTypeWriteWebhookRecord(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="The unique identifier of the data type created, updated, deleted, or had an attachment uploaded in the accounting platform.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataTypeWriteWebhookRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataTypeWriteWebhookRecord from a dict"""
        if obj is None:
            return None
...
class DataTypeWriteWebhookRecordTypedDict(TypedDict):
    """TypedDict variant of DataTypeWriteWebhookRecord, for dict-literal request/response inputs."""
