...
class ConnectionManagementAccessToken(BaseModel):
    ...
    """ # noqa: E501
    access_token: Optional[str] = Field(default=None, description="Access token that allows SMBs to manage connections that have access to their data.", alias="accessToken")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectionManagementAccessToken from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectionManagementAccessToken from a dict"""
        if obj is None:
            return None
...
class ConnectionManagementAccessTokenTypedDict(TypedDict):
    """TypedDict variant of ConnectionManagementAccessToken, for dict-literal request/response inputs."""
