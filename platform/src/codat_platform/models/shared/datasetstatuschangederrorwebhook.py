...
class DatasetStatusChangedErrorWebhookTypedDict(TypedDict):
...
class DatasetStatusChangedErrorWebhook(BaseModel):
    r"""Webhook request body to notify that a data synchronization has completed."""
    ...
    data: Annotated[
        Optional[DatasetStatusChangedErrorWebhookData], pydantic.Field(alias="Data")
    ] = None
