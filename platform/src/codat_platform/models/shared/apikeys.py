...
from codat_platform.types import Nullable
class APIKeys(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [APIKeyDetails.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
...
class APIKeysTypedDict(TypedDict):
    """TypedDict variant of APIKeys, for dict-literal request/response inputs."""
    results: NotRequired[Optional[List[Nullable[APIKeyDetailsTypedDict]]]]


# POC spelling of APIKeys, kept as an alias so existing imports keep working.
ApiKeys = APIKeys
ApiKeysTypedDict = APIKeysTypedDict
