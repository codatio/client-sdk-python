...
class PushOperationTimedOutWebhookTypedDict(TypedDict):
    ...
    data: NotRequired[PushOperationTimedOutWebhookDataTypedDict]
...
class PushOperationTimedOutWebhook(BaseModel):
    r"""Webhook request body notifying that a push push operation has timed out."""
    ...
    data: Annotated[
        Optional[PushOperationTimedOutWebhookData], pydantic.Field(alias="Data")
    ] = None
