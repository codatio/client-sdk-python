...
class APIKeyDetails(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier for the API key.")
    name: OptionalNullable[str] = Field(default=UNSET, description="A meaningful name assigned to the API key.")
    api_key: Optional[str] = Field(default=None, description="The API key value used to make authenticated http requests.", alias="apiKey")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "apiKey", "createdDate"]
...
class APIKeyDetailsTypedDict(TypedDict):
    """TypedDict variant of APIKeyDetails, for dict-literal request/response inputs."""
...
# POC spelling of APIKeyDetails, kept as an alias so existing imports keep working.
ApiKeyDetails = APIKeyDetails
ApiKeyDetailsTypedDict = APIKeyDetailsTypedDict
