...
class ConnectionManagementAllowedOrigins(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConnectionManagementAllowedOrigins from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConnectionManagementAllowedOrigins from a dict"""
        if obj is None:
            return None
...
class ConnectionManagementAllowedOriginsTypedDict(TypedDict):
    """TypedDict variant of ConnectionManagementAllowedOrigins, for dict-literal request/response inputs."""
    allowed_origins: NotRequired[Optional[List[str]]]
