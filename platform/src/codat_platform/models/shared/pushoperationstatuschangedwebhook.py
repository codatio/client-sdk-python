...
class PushOperationStatusChangedWebhookTypedDict(TypedDict):
    ...
    data: NotRequired[PushOperationStatusChangedWebhookDataTypedDict]
...
class PushOperationStatusChangedWebhook(BaseModel):
    r"""Webhook request body for a push operation status change."""
    ...
    data: Annotated[
        Optional[PushOperationStatusChangedWebhookData], pydantic.Field(alias="Data")
    ] = None
