...
class CompanySyncSettings(BaseModel):
    ...
    overrides_defaults: Optional[bool] = Field(default=None, description="Set to `True` if you want to override the default [sync settings](https://docs.codat.io/knowledge-base/advanced-sync-settings).", alias="overridesDefaults")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompanySyncSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompanySyncSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "overridesDefaults": obj.get("overridesDefaults")
        })
        return _obj
...
class CompanySyncSettingsTypedDict(TypedDict):
    """TypedDict variant of CompanySyncSettings, for dict-literal request/response inputs."""
    company_id: NotRequired[Optional[str]]
    settings: NotRequired[Optional[List[SyncSettingTypedDict]]]
    overrides_defaults: NotRequired[Optional[bool]]
