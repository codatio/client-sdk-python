...
class ImageReference(BaseModel):
    ...
    Image reference.
    """ # noqa: E501
    src: Optional[str] = Field(default=None, description="Source URL for image.")
    alt: Optional[str] = Field(default=None, description="Alternative text when image is not available.")
    __properties: ClassVar[List[str]] = ["src", "alt"]
...
class ImageReferenceTypedDict(TypedDict):
    """TypedDict variant of ImageReference, for dict-literal request/response inputs."""
