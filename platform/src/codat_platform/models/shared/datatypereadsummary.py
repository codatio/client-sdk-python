...
class DataTypeReadSummary(BaseModel):
    ...
    records_modified: Optional[bool] = Field(default=None, description="`True` if records have been created, updated or deleted in Codat's cache.", alias="recordsModified")
    status: Optional[Status] = Field(default=None, description="The current status of the dataset.")
    issues: OptionalNullable[List[Issue]] = Field(default=UNSET, description="A array of issues encountered during a data read.")
    __properties: ClassVar[List[str]] = ["connectionId", "dataType", "recordsModified", "status", "issues"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataTypeReadSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataTypeReadSummary from a dict"""
        if obj is None:
            return None
...
class DataTypeReadSummaryTypedDict(TypedDict):
    """TypedDict variant of DataTypeReadSummary, for dict-literal request/response inputs."""
    connection_id: NotRequired[Optional[str]]
    data_type: NotRequired[Optional[DataType]]
    records_modified: NotRequired[Optional[bool]]
    status: NotRequired[Optional[Status]]
    issues: NotRequired[Optional[List[IssueTypedDict]]]
