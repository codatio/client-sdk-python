...
class CustomDataTypeRecords(BaseModel):
    ...
    page_number: Optional[int] = Field(default=None, description="Current page number.", alias="pageNumber")
    page_size: Optional[int] = Field(default=None, description="Number of items to return in results array.", alias="pageSize")
    total_results: Optional[int] = Field(default=None, description="Total number of items.", alias="totalResults")
    __properties: ClassVar[List[str]] = ["results", "pageNumber", "pageSize", "totalResults"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomDataTypeRecords from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomDataTypeRecords from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "results": [CustomDataTypeRecord.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
...
class CustomDataTypeRecordsTypedDict(TypedDict):
    """TypedDict variant of CustomDataTypeRecords, for dict-literal request/response inputs."""
    results: NotRequired[Optional[List[CustomDataTypeRecordTypedDict]]]
