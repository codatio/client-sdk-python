...
class SupportedFeature(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["featureType", "featureState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SupportedFeature from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "featureState": obj.get("featureState")
        })
        return _obj
...
class SupportedFeatureTypedDict(TypedDict):
    """TypedDict variant of SupportedFeature, for dict-literal request/response inputs."""
