...
class CreateAPIKeyTypedDict(TypedDict):
    """TypedDict variant of CreateAPIKey, for dict-literal request/response inputs."""
    name: NotRequired[Optional[str]]


# POC spelling of CreateAPIKey, kept as an alias so existing imports keep working.
CreateApiKey = CreateAPIKey
CreateApiKeyTypedDict = CreateAPIKeyTypedDict
