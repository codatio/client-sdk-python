...
class BrandingButton(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["default", "hover"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrandingButton from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of hover
        if self.hover:
            _dict['hover'] = self.hover.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrandingButton from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "default": BrandingImage.from_dict(obj["default"]) if obj.get("default") is not None else None,
            "hover": BrandingImage.from_dict(obj["hover"]) if obj.get("hover") is not None else None
        })
        return _obj
...
class BrandingButtonTypedDict(TypedDict):
    """TypedDict variant of BrandingButton, for dict-literal request/response inputs."""
    default: NotRequired[Optional[BrandingImageTypedDict]]
    hover: NotRequired[Optional[BrandingImageTypedDict]]
