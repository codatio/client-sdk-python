...
class DataSyncCompletedWebhookTypedDict(TypedDict):
...
class DataSyncCompletedWebhook(BaseModel):
    r"""Webhook request body to notify the completion of a data sync."""
    ...
    data: Annotated[
        Optional[DataSyncCompletedWebhookData], pydantic.Field(alias="Data")
    ] = None
