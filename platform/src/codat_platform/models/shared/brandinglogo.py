...
class BrandingLogo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["full", "square"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrandingLogo from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of square
        if self.square:
            _dict['square'] = self.square.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrandingLogo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "full": BrandingImage.from_dict(obj["full"]) if obj.get("full") is not None else None,
            "square": BrandingImage.from_dict(obj["square"]) if obj.get("square") is not None else None
        })
        return _obj
...
class BrandingLogoTypedDict(TypedDict):
    """TypedDict variant of BrandingLogo, for dict-literal request/response inputs."""
    full: NotRequired[Optional[BrandingImageTypedDict]]
    square: NotRequired[Optional[BrandingImageTypedDict]]
