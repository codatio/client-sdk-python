...
class IssueLinks(BaseModel):
    ...
    IssueLinks
    """ # noqa: E501
    logs: Optional[str] = Field(default=None, description="A link to the validation logs, providing details on any errors or warnings encountered.")
    portal: Optional[str] = Field(default=None, description="A link to the company's past data read history in the Codat portal.")
    read_more: Optional[str] = Field(default=None, description="A link to Codat's documentation with additional information on how to troubleshoot this issue.", alias="readMore")
    __properties: ClassVar[List[str]] = ["logs", "portal", "readMore"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueLinks from a dict"""
        if obj is None:
            return None
...
class IssueLinksTypedDict(TypedDict):
    """TypedDict variant of IssueLinks, for dict-literal request/response inputs."""
    logs: NotRequired[Optional[str]]
    portal: NotRequired[Optional[str]]
    read_more: NotRequired[Optional[str]]
