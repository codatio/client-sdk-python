...
class CompanyProductWebhook(BaseModel):
    ...
    payload: Optional[CompanyProductWebhookPayload] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompanyProductWebhook from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompanyProductWebhook from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "payload": CompanyProductWebhookPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
        return _obj
...
class CompanyProductWebhookTypedDict(TypedDict):
    """TypedDict variant of CompanyProductWebhook, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    event_type: NotRequired[Optional[str]]
    generated_date: NotRequired[Optional[str]]
    payload: NotRequired[Optional[CompanyProductWebhookPayloadTypedDict]]
