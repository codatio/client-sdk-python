...
class SetCompanySyncSettingsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["companyId", "settings", "overridesDefaults"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetCompanySyncSettingsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetCompanySyncSettingsRequest from a dict"""
        if obj is None:
            return None
...
class SetCompanySyncSettingsRequestTypedDict(TypedDict):
    """TypedDict variant of SetCompanySyncSettingsRequest, for dict-literal request/response inputs."""
