...
class ValidationItem1(BaseModel):
    ...
    ValidationItem1
    """ # noqa: E501
    rule_id: Optional[str] = Field(default=None, description="The unique identifier of the rule that wasn't met.", alias="ruleId")
    item_id: Optional[str] = Field(default=None, description="The unique identifier of the item that was validated.", alias="itemId")
    message: Optional[str] = Field(default=None, description="The message that describes the validation warning or error.")
    validator_name: Optional[str] = Field(default=None, description="The name of the validator that was used to validate the item.", alias="validatorName")
    __properties: ClassVar[List[str]] = ["ruleId", "itemId", "message", "validatorName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidationItem1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidationItem1 from a dict"""
        if obj is None:
            return None
...
class ValidationItem1TypedDict(TypedDict):
    """TypedDict variant of ValidationItem1, for dict-literal request/response inputs."""
