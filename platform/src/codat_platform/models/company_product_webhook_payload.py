...
class CompanyProductWebhookPayload(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[str] = Field(default=None, description="Unique identifier of the company the product change applies to.")
    ...
    product_id: Optional[str] = Field(default=None, description="Unique identifier of the product that was added to or removed from the company.", alias="productId")
    product_name: Optional[str] = Field(default=None, description="Name of the product that was added to or removed from the company.", alias="productName")
    products: Optional[List[str]] = Field(default=None, description="The full list of products currently enabled for the company.")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "productId", "productName", "products"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompanyProductWebhookPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompanyProductWebhookPayload from a dict"""
        if obj is None:
            return None
...
class CompanyProductWebhookPayloadTypedDict(TypedDict):
    """TypedDict variant of CompanyProductWebhookPayload, for dict-literal request/response inputs."""
    id: NotRequired[Optional[str]]
    name: NotRequired[Optional[str]]
    description: NotRequired[Optional[str]]
    product_id: NotRequired[Optional[str]]
