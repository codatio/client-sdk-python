...
class WebhookZapierKey(BaseModel):
    ...
    WebhookZapierKey
    """ # noqa: E501
    key: Optional[str] = Field(default=None, description="Integration key used to authorize Zapier's HTTP requests with Codat.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookZapierKey from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookZapierKey from a dict"""
        if obj is None:
            return None
...
class WebhookZapierKeyTypedDict(TypedDict):
    """TypedDict variant of WebhookZapierKey, for dict-literal request/response inputs."""
