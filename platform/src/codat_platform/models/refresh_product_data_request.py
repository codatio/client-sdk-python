...
class RefreshProductDataRequest(BaseModel):
    ...
    """ # noqa: E501
    data_types: Optional[List[str]] = Field(default=None, description="One or more data types to refresh for the product.", alias="dataTypes")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["dataTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RefreshProductDataRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RefreshProductDataRequest from a dict"""
        if obj is None:
            return None
...
class RefreshProductDataRequestTypedDict(TypedDict):
    """TypedDict variant of RefreshProductDataRequest, for dict-literal request/response inputs."""
    data_types: NotRequired[Optional[List[str]]]
