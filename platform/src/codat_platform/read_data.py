...
class ReadData(BaseSDK):
    ...
    def get_validation_results(
        ...
        *,
        request: Union[
            operations.GetReadValidationResultsRequest,
            operations.GetReadValidationResultsRequestTypedDict,
        ],
        ...
        request = cast(operations.GetReadValidationResultsRequest, request)

        req = self._build_request(
            method="GET",
            path="/companies/{companyId}/sync/{datasetId}/validation",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(shared.ValidationResult, http_res)
